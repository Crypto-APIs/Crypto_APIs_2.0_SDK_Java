...
public class AutomaticCoinsForwardingApi {
     ...
     * @param createAutomaticCoinsForwardingRequestBody  (optional)
     ...
     */
    public okhttp3.Call createAutomaticCoinsForwardingCall(String blockchain, String network, String context, CreateAutomaticCoinsForwardingRequestBody createAutomaticCoinsForwardingRequestBody, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createAutomaticCoinsForwardingRequestBody;
    ...
    private okhttp3.Call createAutomaticCoinsForwardingValidateBeforeCall(String blockchain, String network, String context, CreateAutomaticCoinsForwardingRequestBody createAutomaticCoinsForwardingRequestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createAutomaticCoinsForwardingCall(blockchain, network, context, createAutomaticCoinsForwardingRequestBody, _callback);
        return localVarCall;
     ...
     */
    public CreateAutomaticCoinsForwardingResponse createAutomaticCoinsForwarding(String blockchain, String network, String context, CreateAutomaticCoinsForwardingRequestBody createAutomaticCoinsForwardingRequestBody) throws ApiException {
        ApiResponse<CreateAutomaticCoinsForwardingResponse> localVarResp = createAutomaticCoinsForwardingWithHttpInfo(blockchain, network, context, createAutomaticCoinsForwardingRequestBody);
     ...
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param createAutomaticCoinsForwardingRequestBody  (optional)
     * @return ApiResponse&lt;CreateAutomaticCoinsForwardingResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateAutomaticCoinsForwardingResponse> createAutomaticCoinsForwardingWithHttpInfo(String blockchain, String network, String context, CreateAutomaticCoinsForwardingRequestBody createAutomaticCoinsForwardingRequestBody) throws ApiException {
        okhttp3.Call localVarCall = createAutomaticCoinsForwardingValidateBeforeCall(blockchain, network, context, createAutomaticCoinsForwardingRequestBody, null);
        Type localVarReturnType = new TypeToken<CreateAutomaticCoinsForwardingResponse>(){}.getType();
     ...
     */
    public okhttp3.Call createAutomaticCoinsForwardingAsync(String blockchain, String network, String context, CreateAutomaticCoinsForwardingRequestBody createAutomaticCoinsForwardingRequestBody, final ApiCallback<CreateAutomaticCoinsForwardingResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAutomaticCoinsForwardingValidateBeforeCall(blockchain, network, context, createAutomaticCoinsForwardingRequestBody, _callback);
        Type localVarReturnType = new TypeToken<CreateAutomaticCoinsForwardingResponse>(){}.getType();
     ...
     */
    public DeleteAutomaticCoinsForwardingResponse deleteAutomaticCoinsForwarding(String blockchain, String network, String referenceId, String context) throws ApiException {
        ApiResponse<DeleteAutomaticCoinsForwardingResponse> localVarResp = deleteAutomaticCoinsForwardingWithHttpInfo(blockchain, network, referenceId, context);
        return localVarResp.getData();
    }
     ...
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;DeleteAutomaticCoinsForwardingResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteAutomaticCoinsForwardingResponse> deleteAutomaticCoinsForwardingWithHttpInfo(String blockchain, String network, String referenceId, String context) throws ApiException {
        okhttp3.Call localVarCall = deleteAutomaticCoinsForwardingValidateBeforeCall(blockchain, network, referenceId, context, null);
        Type localVarReturnType = new TypeToken<DeleteAutomaticCoinsForwardingResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteAutomaticCoinsForwardingAsync(String blockchain, String network, String referenceId, String context, final ApiCallback<DeleteAutomaticCoinsForwardingResponse> _callback) throws ApiException {
     ...
     */
    public ListCoinsForwardingAutomationsResponse listCoinsForwardingAutomations(String blockchain, String network, String context, Integer limit, Integer offset) throws ApiException {
        ApiResponse<ListCoinsForwardingAutomationsResponse> localVarResp = listCoinsForwardingAutomationsWithHttpInfo(blockchain, network, context, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit Defines how many items should be returned in the response per page basis. (optional, default to 50)
     * @param offset The starting index of the response items, i.e. where the response should start listing the returned items. (optional, default to 0)
     * @return ApiResponse&lt;ListCoinsForwardingAutomationsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListCoinsForwardingAutomationsResponse> listCoinsForwardingAutomationsWithHttpInfo(String blockchain, String network, String context, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = listCoinsForwardingAutomationsValidateBeforeCall(blockchain, network, context, limit, offset, null);
        Type localVarReturnType = new TypeToken<ListCoinsForwardingAutomationsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listCoinsForwardingAutomationsAsync(String blockchain, String network, String context, Integer limit, Integer offset, final ApiCallback<ListCoinsForwardingAutomationsResponse> _callback) throws ApiException {
