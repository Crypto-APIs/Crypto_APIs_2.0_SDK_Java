...
public class XrpRippleApi {
     ...
     */
    public GetLatestMinedXRPRippleBlockResponse getLatestMinedXRPRippleBlock(String network, String context) throws ApiException {
        ApiResponse<GetLatestMinedXRPRippleBlockResponse> localVarResp = getLatestMinedXRPRippleBlockWithHttpInfo(network, context);
     ...
     * @param network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;, \&quot;rinkeby\&quot; are test networks. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetLatestMinedXRPRippleBlockResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetLatestMinedXRPRippleBlockResponse> getLatestMinedXRPRippleBlockWithHttpInfo(String network, String context) throws ApiException {
        okhttp3.Call localVarCall = getLatestMinedXRPRippleBlockValidateBeforeCall(network, context, null);
        Type localVarReturnType = new TypeToken<GetLatestMinedXRPRippleBlockResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getLatestMinedXRPRippleBlockAsync(String network, String context, final ApiCallback<GetLatestMinedXRPRippleBlockResponse> _callback) throws ApiException {
     ...
     */
    public GetXRPRippleAddressDetailsResponse getXRPRippleAddressDetails(String network, String address, String context) throws ApiException {
        ApiResponse<GetXRPRippleAddressDetailsResponse> localVarResp = getXRPRippleAddressDetailsWithHttpInfo(network, address, context);
        return localVarResp.getData();
    }
     ...
     * @param address Represents the public address, which is a compressed and shortened form of a public key. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetXRPRippleAddressDetailsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetXRPRippleAddressDetailsResponse> getXRPRippleAddressDetailsWithHttpInfo(String network, String address, String context) throws ApiException {
        okhttp3.Call localVarCall = getXRPRippleAddressDetailsValidateBeforeCall(network, address, context, null);
        Type localVarReturnType = new TypeToken<GetXRPRippleAddressDetailsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getXRPRippleAddressDetailsAsync(String network, String address, String context, final ApiCallback<GetXRPRippleAddressDetailsResponse> _callback) throws ApiException {
     ...
     */
    public GetXRPRippleBlockDetailsByBlockHashResponse getXRPRippleBlockDetailsByBlockHash(String network, String blockHash, String context) throws ApiException {
        ApiResponse<GetXRPRippleBlockDetailsByBlockHashResponse> localVarResp = getXRPRippleBlockDetailsByBlockHashWithHttpInfo(network, blockHash, context);
        return localVarResp.getData();
    }
     ...
     * @param blockHash Represents the hash of the block, which is its unique identifier. It represents a cryptographic digital fingerprint made by hashing the block header twice through the SHA256 algorithm. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetXRPRippleBlockDetailsByBlockHashResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetXRPRippleBlockDetailsByBlockHashResponse> getXRPRippleBlockDetailsByBlockHashWithHttpInfo(String network, String blockHash, String context) throws ApiException {
        okhttp3.Call localVarCall = getXRPRippleBlockDetailsByBlockHashValidateBeforeCall(network, blockHash, context, null);
        Type localVarReturnType = new TypeToken<GetXRPRippleBlockDetailsByBlockHashResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getXRPRippleBlockDetailsByBlockHashAsync(String network, String blockHash, String context, final ApiCallback<GetXRPRippleBlockDetailsByBlockHashResponse> _callback) throws ApiException {
     ...
     */
    public GetXRPRippleBlockDetailsByBlockHeightResponse getXRPRippleBlockDetailsByBlockHeight(String network, String height, String context) throws ApiException {
        ApiResponse<GetXRPRippleBlockDetailsByBlockHeightResponse> localVarResp = getXRPRippleBlockDetailsByBlockHeightWithHttpInfo(network, height, context);
        return localVarResp.getData();
    }
     ...
     * @param height Represents the number of blocks in the blockchain preceding this specific block. Block numbers have no gaps. A blockchain usually starts with block 0 called the \&quot;Genesis block\&quot;. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetXRPRippleBlockDetailsByBlockHeightResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetXRPRippleBlockDetailsByBlockHeightResponse> getXRPRippleBlockDetailsByBlockHeightWithHttpInfo(String network, String height, String context) throws ApiException {
        okhttp3.Call localVarCall = getXRPRippleBlockDetailsByBlockHeightValidateBeforeCall(network, height, context, null);
        Type localVarReturnType = new TypeToken<GetXRPRippleBlockDetailsByBlockHeightResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getXRPRippleBlockDetailsByBlockHeightAsync(String network, String height, String context, final ApiCallback<GetXRPRippleBlockDetailsByBlockHeightResponse> _callback) throws ApiException {
     ...
     */
    public GetXRPRippleTransactionDetailsByTransactionIDResponse getXRPRippleTransactionDetailsByTransactionID(String network, String transactionHash, String context) throws ApiException {
        ApiResponse<GetXRPRippleTransactionDetailsByTransactionIDResponse> localVarResp = getXRPRippleTransactionDetailsByTransactionIDWithHttpInfo(network, transactionHash, context);
        return localVarResp.getData();
    }
     ...
     * @param transactionHash Represents the same as &#x60;transactionId&#x60; for account-based protocols like Ethereum, while it could be different in UTXO-based protocols like Bitcoin. E.g., in UTXO-based protocols &#x60;hash&#x60; is different from &#x60;transactionId&#x60; for SegWit transactions. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetXRPRippleTransactionDetailsByTransactionIDResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetXRPRippleTransactionDetailsByTransactionIDResponse> getXRPRippleTransactionDetailsByTransactionIDWithHttpInfo(String network, String transactionHash, String context) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GetXRPRippleTransactionDetailsByTransactionIDResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getXRPRippleTransactionDetailsByTransactionIDAsync(String network, String transactionHash, String context, final ApiCallback<GetXRPRippleTransactionDetailsByTransactionIDResponse> _callback) throws ApiException {
     ...
     */
    public ListXRPRippleTransactionsByAddressResponse listXRPRippleTransactionsByAddress(String network, String address, String context, Integer limit, Integer offset) throws ApiException {
        ApiResponse<ListXRPRippleTransactionsByAddressResponse> localVarResp = listXRPRippleTransactionsByAddressWithHttpInfo(network, address, context, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit Defines how many items should be returned in the response per page basis. (optional, default to 50)
     * @param offset The starting index of the response items, i.e. where the response should start listing the returned items. (optional, default to 0)
     * @return ApiResponse&lt;ListXRPRippleTransactionsByAddressResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListXRPRippleTransactionsByAddressResponse> listXRPRippleTransactionsByAddressWithHttpInfo(String network, String address, String context, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = listXRPRippleTransactionsByAddressValidateBeforeCall(network, address, context, limit, offset, null);
        Type localVarReturnType = new TypeToken<ListXRPRippleTransactionsByAddressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listXRPRippleTransactionsByAddressAsync(String network, String address, String context, Integer limit, Integer offset, final ApiCallback<ListXRPRippleTransactionsByAddressResponse> _callback) throws ApiException {
     ...
     */
    public ListXRPRippleTransactionsByBlockHashResponse listXRPRippleTransactionsByBlockHash(String network, String blockHash, String context, Integer limit, Integer offset) throws ApiException {
        ApiResponse<ListXRPRippleTransactionsByBlockHashResponse> localVarResp = listXRPRippleTransactionsByBlockHashWithHttpInfo(network, blockHash, context, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit Defines how many items should be returned in the response per page basis. (optional, default to 50)
     * @param offset The starting index of the response items, i.e. where the response should start listing the returned items. (optional, default to 0)
     * @return ApiResponse&lt;ListXRPRippleTransactionsByBlockHashResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListXRPRippleTransactionsByBlockHashResponse> listXRPRippleTransactionsByBlockHashWithHttpInfo(String network, String blockHash, String context, Integer limit, Integer offset) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListXRPRippleTransactionsByBlockHashResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listXRPRippleTransactionsByBlockHashAsync(String network, String blockHash, String context, Integer limit, Integer offset, final ApiCallback<ListXRPRippleTransactionsByBlockHashResponse> _callback) throws ApiException {
