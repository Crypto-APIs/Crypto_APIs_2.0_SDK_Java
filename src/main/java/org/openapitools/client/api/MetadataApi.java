...
public class MetadataApi {
     ...
     */
    public ListSupportedAssetsResponse listSupportedAssets(String context, String assetType, Integer limit, Integer offset) throws ApiException {
        ApiResponse<ListSupportedAssetsResponse> localVarResp = listSupportedAssetsWithHttpInfo(context, assetType, limit, offset);
     ...
     * @param limit Defines how many items should be returned in the response per page basis. (optional, default to 50)
     * @param offset The starting index of the response items, i.e. where the response should start listing the returned items. (optional, default to 0)
     * @return ApiResponse&lt;ListSupportedAssetsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListSupportedAssetsResponse> listSupportedAssetsWithHttpInfo(String context, String assetType, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = listSupportedAssetsValidateBeforeCall(context, assetType, limit, offset, null);
        Type localVarReturnType = new TypeToken<ListSupportedAssetsResponse>(){}.getType();
     ...
     */
    public okhttp3.Call listSupportedAssetsAsync(String context, String assetType, Integer limit, Integer offset, final ApiCallback<ListSupportedAssetsResponse> _callback) throws ApiException {
