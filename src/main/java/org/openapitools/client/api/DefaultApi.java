...
import org.openapitools.client.model.GetContractDetailsByAddressResponse;
...
public class DefaultApi {
     ...
     * @param contractAddress String identifier of the token (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> TBD </td><td>  -  </td></tr>
     ...
     */
    public GetContractDetailsByAddressResponse getContractDetailsByAddress(String blockchain, String network, String contractAddress, String context) throws ApiException {
        ApiResponse<GetContractDetailsByAddressResponse> localVarResp = getContractDetailsByAddressWithHttpInfo(blockchain, network, contractAddress, context);
     ...
     * @param contractAddress String identifier of the token (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetContractDetailsByAddressResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetContractDetailsByAddressResponse> getContractDetailsByAddressWithHttpInfo(String blockchain, String network, String contractAddress, String context) throws ApiException {
        okhttp3.Call localVarCall = getContractDetailsByAddressValidateBeforeCall(blockchain, network, contractAddress, context, null);
        Type localVarReturnType = new TypeToken<GetContractDetailsByAddressResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getContractDetailsByAddressAsync(String blockchain, String network, String contractAddress, String context, final ApiCallback<GetContractDetailsByAddressResponse> _callback) throws ApiException {
