...
import org.openapitools.client.model.GetAddressBalance400Response;
import org.openapitools.client.model.GetAddressBalance401Response;
import org.openapitools.client.model.GetAddressBalance403Response;
import org.openapitools.client.model.GetAddressBalanceR;
...
public class UnifiedEndpointsApi {
     ...
     */
    public okhttp3.Call getAddressBalanceCall(String blockchain, String network, String address, String context, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/blockchain-data/{blockchain}/{network}/addresses/{address}/balance"
            .replaceAll("\\{" + "blockchain" + "\\}", localVarApiClient.escapeString(blockchain.toString()))
            .replaceAll("\\{" + "network" + "\\}", localVarApiClient.escapeString(network.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAddressBalanceValidateBeforeCall(String blockchain, String network, String address, String context, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'blockchain' is set
        if (blockchain == null) {
            throw new ApiException("Missing the required parameter 'blockchain' when calling getAddressBalance(Async)");
        }
        
        // verify the required parameter 'network' is set
        if (network == null) {
            throw new ApiException("Missing the required parameter 'network' when calling getAddressBalance(Async)");
        }
        ...
        okhttp3.Call localVarCall = getAddressBalanceCall(blockchain, network, address, context, _callback);
        return localVarCall;
     ...
     */
    public GetAddressBalanceR getAddressBalance(String blockchain, String network, String address, String context) throws ApiException {
        ApiResponse<GetAddressBalanceR> localVarResp = getAddressBalanceWithHttpInfo(blockchain, network, address, context);
        return localVarResp.getData();
    }
     ...
     * @param address Represents the public address, which is a compressed and shortened form of a public key. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetAddressBalanceR&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAddressBalanceR> getAddressBalanceWithHttpInfo(String blockchain, String network, String address, String context) throws ApiException {
        okhttp3.Call localVarCall = getAddressBalanceValidateBeforeCall(blockchain, network, address, context, null);
        Type localVarReturnType = new TypeToken<GetAddressBalanceR>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Address Balance (asynchronously)
     * Through this endpoint the customer can receive the balance of a given address based on confirmed/synced blocks only. In the case where there are any incoming or outgoing unconfirmed transactions for the specific address, they will not be counted or calculated here. Applies only for coins.
     * @param blockchain Represents the specific blockchain protocol name, e.g. Ethereum, Bitcoin, etc. (required)
     * @param network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot; are test networks. (required)
     * @param address Represents the public address, which is a compressed and shortened form of a public key. (required)
     ...
     */
    public okhttp3.Call getAddressBalanceAsync(String blockchain, String network, String address, String context, final ApiCallback<GetAddressBalanceR> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAddressBalanceValidateBeforeCall(blockchain, network, address, context, _callback);
        Type localVarReturnType = new TypeToken<GetAddressBalanceR>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getBlockDetailsByBlockHeightCall(String blockchain, String network, Long height, String context, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBlockDetailsByBlockHeightValidateBeforeCall(String blockchain, String network, Long height, String context, final ApiCallback _callback) throws ApiException {
     ...
     */
    public GetBlockDetailsByBlockHeightR getBlockDetailsByBlockHeight(String blockchain, String network, Long height, String context) throws ApiException {
     ...
     */
    public ApiResponse<GetBlockDetailsByBlockHeightR> getBlockDetailsByBlockHeightWithHttpInfo(String blockchain, String network, Long height, String context) throws ApiException {
     ...
     */
    public okhttp3.Call getBlockDetailsByBlockHeightAsync(String blockchain, String network, Long height, String context, final ApiCallback<GetBlockDetailsByBlockHeightR> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listConfirmedTokensTransfersByAddressAndTimeRangeCall(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listConfirmedTokensTransfersByAddressAndTimeRangeValidateBeforeCall(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ListConfirmedTokensTransfersByAddressAndTimeRangeR listConfirmedTokensTransfersByAddressAndTimeRange(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public ApiResponse<ListConfirmedTokensTransfersByAddressAndTimeRangeR> listConfirmedTokensTransfersByAddressAndTimeRangeWithHttpInfo(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public okhttp3.Call listInternalTransactionsByAddressAndTimeRangeCall(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listInternalTransactionsByAddressAndTimeRangeValidateBeforeCall(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ListInternalTransactionsByAddressAndTimeRangeR listInternalTransactionsByAddressAndTimeRange(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public ApiResponse<ListInternalTransactionsByAddressAndTimeRangeR> listInternalTransactionsByAddressAndTimeRangeWithHttpInfo(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public okhttp3.Call listInternalTransactionsByAddressAndTimeRangeAsync(String blockchain, String network, String address, Integer fromTimestamp, Integer toTimestamp, String context, Long limit, Long offset, final ApiCallback<ListInternalTransactionsByAddressAndTimeRangeR> _callback) throws ApiException {
