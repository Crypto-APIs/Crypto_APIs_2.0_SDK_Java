...
public class ManageSubscriptionsApi {
    ...
    /**
     * Build call for activateBlockchainEventSubscription
     ...
     * @param activateBlockchainEventSubscriptionRB  (optional)
     ...
     */
    public okhttp3.Call activateBlockchainEventSubscriptionCall(String referenceId, String context, ActivateBlockchainEventSubscriptionRB activateBlockchainEventSubscriptionRB, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = activateBlockchainEventSubscriptionRB;

        // create path and map variables
        String localVarPath = "/blockchain-events/subscriptions/{referenceId}/activate"
    ...
    private okhttp3.Call activateBlockchainEventSubscriptionValidateBeforeCall(String referenceId, String context, ActivateBlockchainEventSubscriptionRB activateBlockchainEventSubscriptionRB, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'referenceId' is set
        if (referenceId == null) {
            throw new ApiException("Missing the required parameter 'referenceId' when calling activateBlockchainEventSubscription(Async)");
        }
        

        okhttp3.Call localVarCall = activateBlockchainEventSubscriptionCall(referenceId, context, activateBlockchainEventSubscriptionRB, _callback);
        return localVarCall;
     ...
     */
    public ActivateBlockchainEventSubscriptionR activateBlockchainEventSubscription(String referenceId, String context, ActivateBlockchainEventSubscriptionRB activateBlockchainEventSubscriptionRB) throws ApiException {
        ApiResponse<ActivateBlockchainEventSubscriptionR> localVarResp = activateBlockchainEventSubscriptionWithHttpInfo(referenceId, context, activateBlockchainEventSubscriptionRB);
     ...
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param activateBlockchainEventSubscriptionRB  (optional)
     * @return ApiResponse&lt;ActivateBlockchainEventSubscriptionR&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ActivateBlockchainEventSubscriptionR> activateBlockchainEventSubscriptionWithHttpInfo(String referenceId, String context, ActivateBlockchainEventSubscriptionRB activateBlockchainEventSubscriptionRB) throws ApiException {
        okhttp3.Call localVarCall = activateBlockchainEventSubscriptionValidateBeforeCall(referenceId, context, activateBlockchainEventSubscriptionRB, null);
        Type localVarReturnType = new TypeToken<ActivateBlockchainEventSubscriptionR>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Activate Blockchain Event Subscription (asynchronously)
     * Through this endpoint customers can reactivate an event subscription (callback) which has been deactivated by the system. Deactivations could happen due to various reasons, most often \&quot;maximum retry attempts reached\&quot;.
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param activateBlockchainEventSubscriptionRB  (optional)
     ...
     */
    public okhttp3.Call activateBlockchainEventSubscriptionAsync(String referenceId, String context, ActivateBlockchainEventSubscriptionRB activateBlockchainEventSubscriptionRB, final ApiCallback<ActivateBlockchainEventSubscriptionR> _callback) throws ApiException {

        okhttp3.Call localVarCall = activateBlockchainEventSubscriptionValidateBeforeCall(referenceId, context, activateBlockchainEventSubscriptionRB, _callback);
        Type localVarReturnType = new TypeToken<ActivateBlockchainEventSubscriptionR>(){}.getType();
    ...
    /**
     * Build call for getBlockchainEventSubscriptionDetailsByReferenceID
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getBlockchainEventSubscriptionDetailsByReferenceIDCall(String referenceId, String context, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/blockchain-events/subscriptions/{referenceId}"
            .replaceAll("\\{" + "referenceId" + "\\}", localVarApiClient.escapeString(referenceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBlockchainEventSubscriptionDetailsByReferenceIDValidateBeforeCall(String referenceId, String context, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'referenceId' is set
        if (referenceId == null) {
            throw new ApiException("Missing the required parameter 'referenceId' when calling getBlockchainEventSubscriptionDetailsByReferenceID(Async)");
        }
        

        okhttp3.Call localVarCall = getBlockchainEventSubscriptionDetailsByReferenceIDCall(referenceId, context, _callback);
        return localVarCall;
     ...
     */
    public GetBlockchainEventSubscriptionDetailsByReferenceIDR getBlockchainEventSubscriptionDetailsByReferenceID(String referenceId, String context) throws ApiException {
        ApiResponse<GetBlockchainEventSubscriptionDetailsByReferenceIDR> localVarResp = getBlockchainEventSubscriptionDetailsByReferenceIDWithHttpInfo(referenceId, context);
        return localVarResp.getData();
    }
     ...
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;GetBlockchainEventSubscriptionDetailsByReferenceIDR&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetBlockchainEventSubscriptionDetailsByReferenceIDR> getBlockchainEventSubscriptionDetailsByReferenceIDWithHttpInfo(String referenceId, String context) throws ApiException {
        okhttp3.Call localVarCall = getBlockchainEventSubscriptionDetailsByReferenceIDValidateBeforeCall(referenceId, context, null);
        Type localVarReturnType = new TypeToken<GetBlockchainEventSubscriptionDetailsByReferenceIDR>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Blockchain Event Subscription Details By Reference ID (asynchronously)
     * Through this endpoint the customer can get detailed information for a callback subscription by providing its reference ID.    Currently Crypto APIs 2.0 offers certain Blockchain event endpoints which allow the user to subscribe for one/a few/all and receive callback notifications when the specific event occurs.
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getBlockchainEventSubscriptionDetailsByReferenceIDAsync(String referenceId, String context, final ApiCallback<GetBlockchainEventSubscriptionDetailsByReferenceIDR> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBlockchainEventSubscriptionDetailsByReferenceIDValidateBeforeCall(referenceId, context, _callback);
        Type localVarReturnType = new TypeToken<GetBlockchainEventSubscriptionDetailsByReferenceIDR>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listBlockchainEventsSubscriptionsCall(String blockchain, String network, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBlockchainEventsSubscriptionsValidateBeforeCall(String blockchain, String network, String context, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ListBlockchainEventsSubscriptionsR listBlockchainEventsSubscriptions(String blockchain, String network, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public ApiResponse<ListBlockchainEventsSubscriptionsR> listBlockchainEventsSubscriptionsWithHttpInfo(String blockchain, String network, String context, Long limit, Long offset) throws ApiException {
     ...
     */
    public okhttp3.Call listBlockchainEventsSubscriptionsAsync(String blockchain, String network, String context, Long limit, Long offset, final ApiCallback<ListBlockchainEventsSubscriptionsR> _callback) throws ApiException {
