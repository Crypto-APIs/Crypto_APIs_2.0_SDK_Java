...
public class ManageSubscriptionsApi {
     ...
     */
    public DeleteBlockchainEventSubscriptionResponse deleteBlockchainEventSubscription(String blockchain, String network, String referenceId, String context) throws ApiException {
        ApiResponse<DeleteBlockchainEventSubscriptionResponse> localVarResp = deleteBlockchainEventSubscriptionWithHttpInfo(blockchain, network, referenceId, context);
     ...
     * @param referenceId Represents a unique ID used to reference the specific callback subscription. (required)
     * @param context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @return ApiResponse&lt;DeleteBlockchainEventSubscriptionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteBlockchainEventSubscriptionResponse> deleteBlockchainEventSubscriptionWithHttpInfo(String blockchain, String network, String referenceId, String context) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<DeleteBlockchainEventSubscriptionResponse>(){}.getType();
     ...
     */
    public okhttp3.Call deleteBlockchainEventSubscriptionAsync(String blockchain, String network, String referenceId, String context, final ApiCallback<DeleteBlockchainEventSubscriptionResponse> _callback) throws ApiException {
     ...
     */
    public ListBlockchainEventsSubscriptionsResponse listBlockchainEventsSubscriptions(String blockchain, String network, String context, Integer limit, Integer offset) throws ApiException {
        ApiResponse<ListBlockchainEventsSubscriptionsResponse> localVarResp = listBlockchainEventsSubscriptionsWithHttpInfo(blockchain, network, context, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit Defines how many items should be returned in the response per page basis. (optional, default to 50)
     * @param offset The starting index of the response items, i.e. where the response should start listing the returned items. (optional, default to 0)
     * @return ApiResponse&lt;ListBlockchainEventsSubscriptionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListBlockchainEventsSubscriptionsResponse> listBlockchainEventsSubscriptionsWithHttpInfo(String blockchain, String network, String context, Integer limit, Integer offset) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListBlockchainEventsSubscriptionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listBlockchainEventsSubscriptionsAsync(String blockchain, String network, String context, Integer limit, Integer offset, final ApiCallback<ListBlockchainEventsSubscriptionsResponse> _callback) throws ApiException {
