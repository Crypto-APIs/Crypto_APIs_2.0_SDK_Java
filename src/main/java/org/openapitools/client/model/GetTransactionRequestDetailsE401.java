...
public class GetTransactionRequestDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTransactionRequestDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionRequestDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionRequestDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionRequestDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetTransactionRequestDetailsE401 value) throws IOException {
                ...
                @Override
                public GetTransactionRequestDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionRequestDetailsE401 ret = new GetTransactionRequestDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTransactionRequestDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTransactionRequestDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionRequestDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionRequestDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionRequestDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTransactionRequestDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTransactionRequestDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionRequestDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetTransactionRequestDetailsE401
  */
  public static GetTransactionRequestDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionRequestDetailsE401.class);
  }

 /**
  * Convert an instance of GetTransactionRequestDetailsE401 to an JSON string
  *
  * @return JSON string
  */
