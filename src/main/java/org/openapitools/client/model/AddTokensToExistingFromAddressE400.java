...
public class AddTokensToExistingFromAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AddTokensToExistingFromAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AddTokensToExistingFromAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AddTokensToExistingFromAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddTokensToExistingFromAddressE400>() {
                @Override
                public void write(JsonWriter out, AddTokensToExistingFromAddressE400 value) throws IOException {
                ...
                @Override
                public AddTokensToExistingFromAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        AddTokensToExistingFromAddressE400 ret = new AddTokensToExistingFromAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AddTokensToExistingFromAddressE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddTokensToExistingFromAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public AddTokensToExistingFromAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return AddTokensToExistingFromAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddTokensToExistingFromAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AddTokensToExistingFromAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of AddTokensToExistingFromAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddTokensToExistingFromAddressE400
  * @throws IOException if the JSON string is invalid with respect to AddTokensToExistingFromAddressE400
  */
  public static AddTokensToExistingFromAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTokensToExistingFromAddressE400.class);
  }

 /**
  * Convert an instance of AddTokensToExistingFromAddressE400 to an JSON string
  *
  * @return JSON string
  */
