...
public class GetAssetDetailsByAssetSymbolE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAssetDetailsByAssetSymbolE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAssetDetailsByAssetSymbolE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAssetDetailsByAssetSymbolE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAssetDetailsByAssetSymbolE403>() {
                @Override
                public void write(JsonWriter out, GetAssetDetailsByAssetSymbolE403 value) throws IOException {
                ...
                @Override
                public GetAssetDetailsByAssetSymbolE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAssetDetailsByAssetSymbolE403 ret = new GetAssetDetailsByAssetSymbolE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAssetDetailsByAssetSymbolE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAssetDetailsByAssetSymbolE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAssetDetailsByAssetSymbolE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAssetDetailsByAssetSymbolE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAssetDetailsByAssetSymbolE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAssetDetailsByAssetSymbolE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAssetDetailsByAssetSymbolE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAssetDetailsByAssetSymbolE403
  * @throws IOException if the JSON string is invalid with respect to GetAssetDetailsByAssetSymbolE403
  */
  public static GetAssetDetailsByAssetSymbolE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetDetailsByAssetSymbolE403.class);
  }

 /**
  * Convert an instance of GetAssetDetailsByAssetSymbolE403 to an JSON string
  *
  * @return JSON string
  */
