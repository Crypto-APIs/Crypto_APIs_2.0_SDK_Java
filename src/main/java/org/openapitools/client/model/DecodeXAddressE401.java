...
public class DecodeXAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DecodeXAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DecodeXAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DecodeXAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DecodeXAddressE401>() {
                @Override
                public void write(JsonWriter out, DecodeXAddressE401 value) throws IOException {
                ...
                @Override
                public DecodeXAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DecodeXAddressE401 ret = new DecodeXAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DecodeXAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DecodeXAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DecodeXAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DecodeXAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecodeXAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DecodeXAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DecodeXAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecodeXAddressE401
  * @throws IOException if the JSON string is invalid with respect to DecodeXAddressE401
  */
  public static DecodeXAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecodeXAddressE401.class);
  }

 /**
  * Convert an instance of DecodeXAddressE401 to an JSON string
  *
  * @return JSON string
  */
