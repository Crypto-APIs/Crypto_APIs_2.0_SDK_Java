...
public class NewConfirmedInternalTransactionsAndEachConfirmationE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsAndEachConfirmationE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsAndEachConfirmationE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsAndEachConfirmationE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsAndEachConfirmationE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsAndEachConfirmationE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsAndEachConfirmationE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsAndEachConfirmationE401 ret = new NewConfirmedInternalTransactionsAndEachConfirmationE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsAndEachConfirmationE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsAndEachConfirmationE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsAndEachConfirmationE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsAndEachConfirmationE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsAndEachConfirmationE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE401
  */
  public static NewConfirmedInternalTransactionsAndEachConfirmationE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsAndEachConfirmationE401.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsAndEachConfirmationE401 to an JSON string
  *
  * @return JSON string
  */
