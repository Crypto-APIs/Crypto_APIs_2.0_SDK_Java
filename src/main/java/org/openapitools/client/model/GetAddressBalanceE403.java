...
public class GetAddressBalanceE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressBalanceE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressBalanceE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressBalanceE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressBalanceE403>() {
                @Override
                public void write(JsonWriter out, GetAddressBalanceE403 value) throws IOException {
                ...
                @Override
                public GetAddressBalanceE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressBalanceE403 ret = new GetAddressBalanceE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressBalanceE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressBalanceE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressBalanceE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressBalanceE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressBalanceE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressBalanceE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressBalanceE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressBalanceE403
  * @throws IOException if the JSON string is invalid with respect to GetAddressBalanceE403
  */
  public static GetAddressBalanceE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressBalanceE403.class);
  }

 /**
  * Convert an instance of GetAddressBalanceE403 to an JSON string
  *
  * @return JSON string
  */
