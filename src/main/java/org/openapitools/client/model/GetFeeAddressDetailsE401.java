...
public class GetFeeAddressDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeAddressDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeAddressDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeAddressDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeAddressDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetFeeAddressDetailsE401 value) throws IOException {
                ...
                @Override
                public GetFeeAddressDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeAddressDetailsE401 ret = new GetFeeAddressDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeAddressDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeAddressDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeAddressDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeAddressDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeAddressDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeAddressDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeAddressDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeAddressDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetFeeAddressDetailsE401
  */
  public static GetFeeAddressDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeAddressDetailsE401.class);
  }

 /**
  * Convert an instance of GetFeeAddressDetailsE401 to an JSON string
  *
  * @return JSON string
  */
