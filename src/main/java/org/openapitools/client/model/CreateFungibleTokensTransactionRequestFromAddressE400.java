...
public class CreateFungibleTokensTransactionRequestFromAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateFungibleTokensTransactionRequestFromAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFungibleTokensTransactionRequestFromAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFungibleTokensTransactionRequestFromAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFungibleTokensTransactionRequestFromAddressE400>() {
                @Override
                public void write(JsonWriter out, CreateFungibleTokensTransactionRequestFromAddressE400 value) throws IOException {
                ...
                @Override
                public CreateFungibleTokensTransactionRequestFromAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateFungibleTokensTransactionRequestFromAddressE400 ret = new CreateFungibleTokensTransactionRequestFromAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateFungibleTokensTransactionRequestFromAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFungibleTokensTransactionRequestFromAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateFungibleTokensTransactionRequestFromAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateFungibleTokensTransactionRequestFromAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateFungibleTokensTransactionRequestFromAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateFungibleTokensTransactionRequestFromAddressE400
  * @throws IOException if the JSON string is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE400
  */
  public static CreateFungibleTokensTransactionRequestFromAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFungibleTokensTransactionRequestFromAddressE400.class);
  }

 /**
  * Convert an instance of CreateFungibleTokensTransactionRequestFromAddressE400 to an JSON string
  *
  * @return JSON string
  */
