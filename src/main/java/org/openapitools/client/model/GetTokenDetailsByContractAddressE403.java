...
public class GetTokenDetailsByContractAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTokenDetailsByContractAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTokenDetailsByContractAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTokenDetailsByContractAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTokenDetailsByContractAddressE403>() {
                @Override
                public void write(JsonWriter out, GetTokenDetailsByContractAddressE403 value) throws IOException {
                ...
                @Override
                public GetTokenDetailsByContractAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTokenDetailsByContractAddressE403 ret = new GetTokenDetailsByContractAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTokenDetailsByContractAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTokenDetailsByContractAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTokenDetailsByContractAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTokenDetailsByContractAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTokenDetailsByContractAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTokenDetailsByContractAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTokenDetailsByContractAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTokenDetailsByContractAddressE403
  * @throws IOException if the JSON string is invalid with respect to GetTokenDetailsByContractAddressE403
  */
  public static GetTokenDetailsByContractAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTokenDetailsByContractAddressE403.class);
  }

 /**
  * Convert an instance of GetTokenDetailsByContractAddressE403 to an JSON string
  *
  * @return JSON string
  */
