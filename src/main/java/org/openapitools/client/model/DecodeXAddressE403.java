...
public class DecodeXAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DecodeXAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DecodeXAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DecodeXAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DecodeXAddressE403>() {
                @Override
                public void write(JsonWriter out, DecodeXAddressE403 value) throws IOException {
                ...
                @Override
                public DecodeXAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DecodeXAddressE403 ret = new DecodeXAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DecodeXAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DecodeXAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DecodeXAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DecodeXAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecodeXAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DecodeXAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DecodeXAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecodeXAddressE403
  * @throws IOException if the JSON string is invalid with respect to DecodeXAddressE403
  */
  public static DecodeXAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecodeXAddressE403.class);
  }

 /**
  * Convert an instance of DecodeXAddressE403 to an JSON string
  *
  * @return JSON string
  */
