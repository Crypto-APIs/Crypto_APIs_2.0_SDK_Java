...
public class GetHDWalletXPubYPubZPubDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetHDWalletXPubYPubZPubDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetHDWalletXPubYPubZPubDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetHDWalletXPubYPubZPubDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetHDWalletXPubYPubZPubDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetHDWalletXPubYPubZPubDetailsE401 value) throws IOException {
                ...
                @Override
                public GetHDWalletXPubYPubZPubDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetHDWalletXPubYPubZPubDetailsE401 ret = new GetHDWalletXPubYPubZPubDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetHDWalletXPubYPubZPubDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetHDWalletXPubYPubZPubDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetHDWalletXPubYPubZPubDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetHDWalletXPubYPubZPubDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetHDWalletXPubYPubZPubDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetHDWalletXPubYPubZPubDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetHDWalletXPubYPubZPubDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetHDWalletXPubYPubZPubDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetHDWalletXPubYPubZPubDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetHDWalletXPubYPubZPubDetailsE401
  */
  public static GetHDWalletXPubYPubZPubDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetHDWalletXPubYPubZPubDetailsE401.class);
  }

 /**
  * Convert an instance of GetHDWalletXPubYPubZPubDetailsE401 to an JSON string
  *
  * @return JSON string
  */
