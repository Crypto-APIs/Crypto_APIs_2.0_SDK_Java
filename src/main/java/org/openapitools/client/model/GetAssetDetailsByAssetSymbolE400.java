...
public class GetAssetDetailsByAssetSymbolE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAssetDetailsByAssetSymbolE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAssetDetailsByAssetSymbolE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAssetDetailsByAssetSymbolE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAssetDetailsByAssetSymbolE400>() {
                @Override
                public void write(JsonWriter out, GetAssetDetailsByAssetSymbolE400 value) throws IOException {
                ...
                @Override
                public GetAssetDetailsByAssetSymbolE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAssetDetailsByAssetSymbolE400 ret = new GetAssetDetailsByAssetSymbolE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAssetDetailsByAssetSymbolE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAssetDetailsByAssetSymbolE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAssetDetailsByAssetSymbolE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAssetDetailsByAssetSymbolE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAssetDetailsByAssetSymbolE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAssetDetailsByAssetSymbolE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAssetDetailsByAssetSymbolE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAssetDetailsByAssetSymbolE400
  * @throws IOException if the JSON string is invalid with respect to GetAssetDetailsByAssetSymbolE400
  */
  public static GetAssetDetailsByAssetSymbolE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetDetailsByAssetSymbolE400.class);
  }

 /**
  * Convert an instance of GetAssetDetailsByAssetSymbolE400 to an JSON string
  *
  * @return JSON string
  */
