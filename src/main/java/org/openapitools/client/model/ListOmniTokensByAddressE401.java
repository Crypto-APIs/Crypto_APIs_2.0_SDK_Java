...
public class ListOmniTokensByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTokensByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTokensByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTokensByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTokensByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListOmniTokensByAddressE401 value) throws IOException {
                ...
                @Override
                public ListOmniTokensByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTokensByAddressE401 ret = new ListOmniTokensByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTokensByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTokensByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTokensByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTokensByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTokensByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTokensByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTokensByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTokensByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListOmniTokensByAddressE401
  */
  public static ListOmniTokensByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTokensByAddressE401.class);
  }

 /**
  * Convert an instance of ListOmniTokensByAddressE401 to an JSON string
  *
  * @return JSON string
  */
