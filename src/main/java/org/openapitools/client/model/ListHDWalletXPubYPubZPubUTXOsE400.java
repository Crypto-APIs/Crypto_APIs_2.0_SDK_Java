...
public class ListHDWalletXPubYPubZPubUTXOsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHDWalletXPubYPubZPubUTXOsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubUTXOsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubUTXOsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubUTXOsE400>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubUTXOsE400 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced");
                }

                @Override
                public ListHDWalletXPubYPubZPubUTXOsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubUTXOsE400 ret = new ListHDWalletXPubYPubZPubUTXOsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubUTXOsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHDWalletXPubYPubZPubUTXOsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubUTXOsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE400(XpubNotSynced o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubUTXOsE400.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced");
    }
     ...
     * InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced
     *
     * @return The actual instance (InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListHDWalletXPubYPubZPubUTXOsE400 with oneOf schemas: InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListHDWalletXPubYPubZPubUTXOsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubUTXOsE400
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE400
  */
  public static ListHDWalletXPubYPubZPubUTXOsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubUTXOsE400.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubUTXOsE400 to an JSON string
  *
  * @return JSON string
  */
