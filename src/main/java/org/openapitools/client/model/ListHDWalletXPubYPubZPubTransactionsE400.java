        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubTransactionsE400>() {
                ...
                public ListHDWalletXPubYPubZPubTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
