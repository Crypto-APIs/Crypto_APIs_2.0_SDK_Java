...
public class EstimateTokenGasLimitE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateTokenGasLimitE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateTokenGasLimitE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateTokenGasLimitE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateTokenGasLimitE403>() {
                @Override
                public void write(JsonWriter out, EstimateTokenGasLimitE403 value) throws IOException {
                ...
                @Override
                public EstimateTokenGasLimitE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateTokenGasLimitE403 ret = new EstimateTokenGasLimitE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateTokenGasLimitE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateTokenGasLimitE403() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateTokenGasLimitE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTokenGasLimitE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTokenGasLimitE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTokenGasLimitE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateTokenGasLimitE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateTokenGasLimitE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateTokenGasLimitE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateTokenGasLimitE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateTokenGasLimitE403
  * @throws IOException if the JSON string is invalid with respect to EstimateTokenGasLimitE403
  */
  public static EstimateTokenGasLimitE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateTokenGasLimitE403.class);
  }

 /**
  * Convert an instance of EstimateTokenGasLimitE403 to an JSON string
  *
  * @return JSON string
  */
