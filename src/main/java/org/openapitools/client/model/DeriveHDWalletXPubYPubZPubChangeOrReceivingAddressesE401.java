...
public class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401>() {
                @Override
                public void write(JsonWriter out, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 value) throws IOException {
                ...
                @Override
                public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 ret = new DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401
  * @throws IOException if the JSON string is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401
  */
  public static DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401.class);
  }

 /**
  * Convert an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 to an JSON string
  *
  * @return JSON string
  */
