...
public class ListCoinsForwardingAutomationsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListCoinsForwardingAutomationsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListCoinsForwardingAutomationsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListCoinsForwardingAutomationsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListCoinsForwardingAutomationsE401>() {
                @Override
                public void write(JsonWriter out, ListCoinsForwardingAutomationsE401 value) throws IOException {
                ...
                @Override
                public ListCoinsForwardingAutomationsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListCoinsForwardingAutomationsE401 ret = new ListCoinsForwardingAutomationsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListCoinsForwardingAutomationsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListCoinsForwardingAutomationsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListCoinsForwardingAutomationsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListCoinsForwardingAutomationsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListCoinsForwardingAutomationsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListCoinsForwardingAutomationsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListCoinsForwardingAutomationsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListCoinsForwardingAutomationsE401
  * @throws IOException if the JSON string is invalid with respect to ListCoinsForwardingAutomationsE401
  */
  public static ListCoinsForwardingAutomationsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCoinsForwardingAutomationsE401.class);
  }

 /**
  * Convert an instance of ListCoinsForwardingAutomationsE401 to an JSON string
  *
  * @return JSON string
  */
