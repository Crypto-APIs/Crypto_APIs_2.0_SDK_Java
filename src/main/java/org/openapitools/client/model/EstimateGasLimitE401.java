...
public class EstimateGasLimitE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateGasLimitE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateGasLimitE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateGasLimitE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateGasLimitE401>() {
                @Override
                public void write(JsonWriter out, EstimateGasLimitE401 value) throws IOException {
                ...
                @Override
                public EstimateGasLimitE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateGasLimitE401 ret = new EstimateGasLimitE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateGasLimitE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateGasLimitE401() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateGasLimitE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateGasLimitE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateGasLimitE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateGasLimitE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateGasLimitE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateGasLimitE401
  * @throws IOException if the JSON string is invalid with respect to EstimateGasLimitE401
  */
  public static EstimateGasLimitE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateGasLimitE401.class);
  }

 /**
  * Convert an instance of EstimateGasLimitE401 to an JSON string
  *
  * @return JSON string
  */
