...
public class GetAssetDetailsByAssetSymbolE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAssetDetailsByAssetSymbolE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAssetDetailsByAssetSymbolE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAssetDetailsByAssetSymbolE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAssetDetailsByAssetSymbolE401>() {
                @Override
                public void write(JsonWriter out, GetAssetDetailsByAssetSymbolE401 value) throws IOException {
                ...
                @Override
                public GetAssetDetailsByAssetSymbolE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAssetDetailsByAssetSymbolE401 ret = new GetAssetDetailsByAssetSymbolE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAssetDetailsByAssetSymbolE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAssetDetailsByAssetSymbolE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAssetDetailsByAssetSymbolE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetSymbolE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAssetDetailsByAssetSymbolE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAssetDetailsByAssetSymbolE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAssetDetailsByAssetSymbolE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAssetDetailsByAssetSymbolE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAssetDetailsByAssetSymbolE401
  * @throws IOException if the JSON string is invalid with respect to GetAssetDetailsByAssetSymbolE401
  */
  public static GetAssetDetailsByAssetSymbolE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetDetailsByAssetSymbolE401.class);
  }

 /**
  * Convert an instance of GetAssetDetailsByAssetSymbolE401 to an JSON string
  *
  * @return JSON string
  */
