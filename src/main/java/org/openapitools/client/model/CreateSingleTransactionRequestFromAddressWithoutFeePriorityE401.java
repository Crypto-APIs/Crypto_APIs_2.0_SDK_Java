...
public class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401>() {
                @Override
                public void write(JsonWriter out, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 value) throws IOException {
                ...
                @Override
                public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 ret = new CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401
  * @throws IOException if the JSON string is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401
  */
  public static CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401.class);
  }

 /**
  * Convert an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 to an JSON string
  *
  * @return JSON string
  */
