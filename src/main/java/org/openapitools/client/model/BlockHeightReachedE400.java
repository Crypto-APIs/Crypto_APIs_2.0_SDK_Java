...
public class BlockHeightReachedE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BlockHeightReachedE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BlockHeightReachedE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BlockHeightReachedE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BlockHeightReachedE400>() {
                @Override
                public void write(JsonWriter out, BlockHeightReachedE400 value) throws IOException {
                ...
                @Override
                public BlockHeightReachedE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BlockHeightReachedE400 ret = new BlockHeightReachedE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BlockHeightReachedE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BlockHeightReachedE400() {
        super("oneOf", Boolean.FALSE);
    }

    public BlockHeightReachedE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BlockHeightReachedE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BlockHeightReachedE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BlockHeightReachedE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BlockHeightReachedE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BlockHeightReachedE400
  * @throws IOException if the JSON string is invalid with respect to BlockHeightReachedE400
  */
  public static BlockHeightReachedE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockHeightReachedE400.class);
  }

 /**
  * Convert an instance of BlockHeightReachedE400 to an JSON string
  *
  * @return JSON string
  */
