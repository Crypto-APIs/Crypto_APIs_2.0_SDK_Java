...
public class ActivateBlockchainEventSubscriptionE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActivateBlockchainEventSubscriptionE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ActivateBlockchainEventSubscriptionE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ActivateBlockchainEventSubscriptionE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ActivateBlockchainEventSubscriptionE401>() {
                @Override
                public void write(JsonWriter out, ActivateBlockchainEventSubscriptionE401 value) throws IOException {
                ...
                @Override
                public ActivateBlockchainEventSubscriptionE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ActivateBlockchainEventSubscriptionE401 ret = new ActivateBlockchainEventSubscriptionE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ActivateBlockchainEventSubscriptionE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ActivateBlockchainEventSubscriptionE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ActivateBlockchainEventSubscriptionE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ActivateBlockchainEventSubscriptionE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActivateBlockchainEventSubscriptionE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ActivateBlockchainEventSubscriptionE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ActivateBlockchainEventSubscriptionE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActivateBlockchainEventSubscriptionE401
  * @throws IOException if the JSON string is invalid with respect to ActivateBlockchainEventSubscriptionE401
  */
  public static ActivateBlockchainEventSubscriptionE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivateBlockchainEventSubscriptionE401.class);
  }

 /**
  * Convert an instance of ActivateBlockchainEventSubscriptionE401 to an JSON string
  *
  * @return JSON string
  */
