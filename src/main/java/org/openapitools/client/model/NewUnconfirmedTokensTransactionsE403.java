...
public class NewUnconfirmedTokensTransactionsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedTokensTransactionsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedTokensTransactionsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedTokensTransactionsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedTokensTransactionsE403>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedTokensTransactionsE403 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedTokensTransactionsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedTokensTransactionsE403 ret = new NewUnconfirmedTokensTransactionsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedTokensTransactionsE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedTokensTransactionsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedTokensTransactionsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedTokensTransactionsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedTokensTransactionsE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedTokensTransactionsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedTokensTransactionsE403
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedTokensTransactionsE403
  */
  public static NewUnconfirmedTokensTransactionsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedTokensTransactionsE403.class);
  }

 /**
  * Convert an instance of NewUnconfirmedTokensTransactionsE403 to an JSON string
  *
  * @return JSON string
  */
