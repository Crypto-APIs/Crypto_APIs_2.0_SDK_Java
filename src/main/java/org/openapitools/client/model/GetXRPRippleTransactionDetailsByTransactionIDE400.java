...
public class GetXRPRippleTransactionDetailsByTransactionIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleTransactionDetailsByTransactionIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleTransactionDetailsByTransactionIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleTransactionDetailsByTransactionIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleTransactionDetailsByTransactionIDE400>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleTransactionDetailsByTransactionIDE400 value) throws IOException {
                ...
                @Override
                public GetXRPRippleTransactionDetailsByTransactionIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleTransactionDetailsByTransactionIDE400 ret = new GetXRPRippleTransactionDetailsByTransactionIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleTransactionDetailsByTransactionIDE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleTransactionDetailsByTransactionIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleTransactionDetailsByTransactionIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleTransactionDetailsByTransactionIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleTransactionDetailsByTransactionIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleTransactionDetailsByTransactionIDE400
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE400
  */
  public static GetXRPRippleTransactionDetailsByTransactionIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleTransactionDetailsByTransactionIDE400.class);
  }

 /**
  * Convert an instance of GetXRPRippleTransactionDetailsByTransactionIDE400 to an JSON string
  *
  * @return JSON string
  */
