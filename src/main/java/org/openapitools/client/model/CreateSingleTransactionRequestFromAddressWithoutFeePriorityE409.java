...
public class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409>() {
                @Override
                public void write(JsonWriter out, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 value) throws IOException {
                ...
                @Override
                public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 ret = new CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409(WalletAsAServiceAddressBalanceNotEnough o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409(WalletAsAServiceWalletBalanceNotEnough o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 with oneOf schemas: InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409
  * @throws IOException if the JSON string is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409
  */
  public static CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.class);
  }

 /**
  * Convert an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 to an JSON string
  *
  * @return JSON string
  */
