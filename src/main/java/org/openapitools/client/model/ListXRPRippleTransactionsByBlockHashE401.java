...
public class ListXRPRippleTransactionsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByBlockHashE401 ret = new ListXRPRippleTransactionsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByBlockHashE401
  */
  public static ListXRPRippleTransactionsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByBlockHashE401.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
