...
public class GetExchangeRateByAssetsIDsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetsIDsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetsIDsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetsIDsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetsIDsE403>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetsIDsE403 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetsIDsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetsIDsE403 ret = new GetExchangeRateByAssetsIDsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetsIDsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetsIDsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetsIDsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetsIDsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetsIDsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetsIDsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetsIDsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetsIDsE403
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetsIDsE403
  */
  public static GetExchangeRateByAssetsIDsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetsIDsE403.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetsIDsE403 to an JSON string
  *
  * @return JSON string
  */
