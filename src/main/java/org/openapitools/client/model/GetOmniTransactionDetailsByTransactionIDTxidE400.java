...
public class GetOmniTransactionDetailsByTransactionIDTxidE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetOmniTransactionDetailsByTransactionIDTxidE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetOmniTransactionDetailsByTransactionIDTxidE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetOmniTransactionDetailsByTransactionIDTxidE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetOmniTransactionDetailsByTransactionIDTxidE400>() {
                @Override
                public void write(JsonWriter out, GetOmniTransactionDetailsByTransactionIDTxidE400 value) throws IOException {
                ...
                @Override
                public GetOmniTransactionDetailsByTransactionIDTxidE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetOmniTransactionDetailsByTransactionIDTxidE400 ret = new GetOmniTransactionDetailsByTransactionIDTxidE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetOmniTransactionDetailsByTransactionIDTxidE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetOmniTransactionDetailsByTransactionIDTxidE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetOmniTransactionDetailsByTransactionIDTxidE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetOmniTransactionDetailsByTransactionIDTxidE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetOmniTransactionDetailsByTransactionIDTxidE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOmniTransactionDetailsByTransactionIDTxidE400
  * @throws IOException if the JSON string is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE400
  */
  public static GetOmniTransactionDetailsByTransactionIDTxidE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOmniTransactionDetailsByTransactionIDTxidE400.class);
  }

 /**
  * Convert an instance of GetOmniTransactionDetailsByTransactionIDTxidE400 to an JSON string
  *
  * @return JSON string
  */
