...
public class EncodeXAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EncodeXAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EncodeXAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EncodeXAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EncodeXAddressE401>() {
                @Override
                public void write(JsonWriter out, EncodeXAddressE401 value) throws IOException {
                ...
                @Override
                public EncodeXAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EncodeXAddressE401 ret = new EncodeXAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EncodeXAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EncodeXAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public EncodeXAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EncodeXAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EncodeXAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EncodeXAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EncodeXAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncodeXAddressE401
  * @throws IOException if the JSON string is invalid with respect to EncodeXAddressE401
  */
  public static EncodeXAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncodeXAddressE401.class);
  }

 /**
  * Convert an instance of EncodeXAddressE401 to an JSON string
  *
  * @return JSON string
  */
