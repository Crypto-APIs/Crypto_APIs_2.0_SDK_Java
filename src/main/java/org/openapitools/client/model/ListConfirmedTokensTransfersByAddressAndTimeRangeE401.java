...
public class ListConfirmedTokensTransfersByAddressAndTimeRangeE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTokensTransfersByAddressAndTimeRangeE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTokensTransfersByAddressAndTimeRangeE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTokensTransfersByAddressAndTimeRangeE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTokensTransfersByAddressAndTimeRangeE401>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTokensTransfersByAddressAndTimeRangeE401 value) throws IOException {
                ...
                @Override
                public ListConfirmedTokensTransfersByAddressAndTimeRangeE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTokensTransfersByAddressAndTimeRangeE401 ret = new ListConfirmedTokensTransfersByAddressAndTimeRangeE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTokensTransfersByAddressAndTimeRangeE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTokensTransfersByAddressAndTimeRangeE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTokensTransfersByAddressAndTimeRangeE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTokensTransfersByAddressAndTimeRangeE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTokensTransfersByAddressAndTimeRangeE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE401
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTokensTransfersByAddressAndTimeRangeE401
  */
  public static ListConfirmedTokensTransfersByAddressAndTimeRangeE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTokensTransfersByAddressAndTimeRangeE401.class);
  }

 /**
  * Convert an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE401 to an JSON string
  *
  * @return JSON string
  */
