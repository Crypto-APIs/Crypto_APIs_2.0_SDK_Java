...
public class ListTokensForwardingAutomationsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensForwardingAutomationsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensForwardingAutomationsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensForwardingAutomationsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensForwardingAutomationsE403>() {
                @Override
                public void write(JsonWriter out, ListTokensForwardingAutomationsE403 value) throws IOException {
                ...
                @Override
                public ListTokensForwardingAutomationsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensForwardingAutomationsE403 ret = new ListTokensForwardingAutomationsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensForwardingAutomationsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensForwardingAutomationsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensForwardingAutomationsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensForwardingAutomationsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensForwardingAutomationsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensForwardingAutomationsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensForwardingAutomationsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensForwardingAutomationsE403
  * @throws IOException if the JSON string is invalid with respect to ListTokensForwardingAutomationsE403
  */
  public static ListTokensForwardingAutomationsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensForwardingAutomationsE403.class);
  }

 /**
  * Convert an instance of ListTokensForwardingAutomationsE403 to an JSON string
  *
  * @return JSON string
  */
