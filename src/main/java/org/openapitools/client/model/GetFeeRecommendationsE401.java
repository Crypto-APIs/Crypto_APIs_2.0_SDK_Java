...
public class GetFeeRecommendationsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeRecommendationsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeRecommendationsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeRecommendationsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeRecommendationsE401>() {
                @Override
                public void write(JsonWriter out, GetFeeRecommendationsE401 value) throws IOException {
                ...
                @Override
                public GetFeeRecommendationsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeRecommendationsE401 ret = new GetFeeRecommendationsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeRecommendationsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeRecommendationsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeRecommendationsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeRecommendationsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeRecommendationsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeRecommendationsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeRecommendationsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeRecommendationsE401
  * @throws IOException if the JSON string is invalid with respect to GetFeeRecommendationsE401
  */
  public static GetFeeRecommendationsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeRecommendationsE401.class);
  }

 /**
  * Convert an instance of GetFeeRecommendationsE401 to an JSON string
  *
  * @return JSON string
  */
