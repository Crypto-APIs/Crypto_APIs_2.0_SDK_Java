...
public class NewConfirmedTokensTransactionsAndEachConfirmationE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokensTransactionsAndEachConfirmationE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokensTransactionsAndEachConfirmationE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokensTransactionsAndEachConfirmationE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokensTransactionsAndEachConfirmationE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokensTransactionsAndEachConfirmationE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokensTransactionsAndEachConfirmationE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokensTransactionsAndEachConfirmationE401 ret = new NewConfirmedTokensTransactionsAndEachConfirmationE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokensTransactionsAndEachConfirmationE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokensTransactionsAndEachConfirmationE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokensTransactionsAndEachConfirmationE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokensTransactionsAndEachConfirmationE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokensTransactionsAndEachConfirmationE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokensTransactionsAndEachConfirmationE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokensTransactionsAndEachConfirmationE401
  */
  public static NewConfirmedTokensTransactionsAndEachConfirmationE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokensTransactionsAndEachConfirmationE401.class);
  }

 /**
  * Convert an instance of NewConfirmedTokensTransactionsAndEachConfirmationE401 to an JSON string
  *
  * @return JSON string
  */
