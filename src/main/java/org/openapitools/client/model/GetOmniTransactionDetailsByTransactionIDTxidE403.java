...
public class GetOmniTransactionDetailsByTransactionIDTxidE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetOmniTransactionDetailsByTransactionIDTxidE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetOmniTransactionDetailsByTransactionIDTxidE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetOmniTransactionDetailsByTransactionIDTxidE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetOmniTransactionDetailsByTransactionIDTxidE403>() {
                @Override
                public void write(JsonWriter out, GetOmniTransactionDetailsByTransactionIDTxidE403 value) throws IOException {
                ...
                @Override
                public GetOmniTransactionDetailsByTransactionIDTxidE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetOmniTransactionDetailsByTransactionIDTxidE403 ret = new GetOmniTransactionDetailsByTransactionIDTxidE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetOmniTransactionDetailsByTransactionIDTxidE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetOmniTransactionDetailsByTransactionIDTxidE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetOmniTransactionDetailsByTransactionIDTxidE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetOmniTransactionDetailsByTransactionIDTxidE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetOmniTransactionDetailsByTransactionIDTxidE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOmniTransactionDetailsByTransactionIDTxidE403
  * @throws IOException if the JSON string is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE403
  */
  public static GetOmniTransactionDetailsByTransactionIDTxidE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOmniTransactionDetailsByTransactionIDTxidE403.class);
  }

 /**
  * Convert an instance of GetOmniTransactionDetailsByTransactionIDTxidE403 to an JSON string
  *
  * @return JSON string
  */
