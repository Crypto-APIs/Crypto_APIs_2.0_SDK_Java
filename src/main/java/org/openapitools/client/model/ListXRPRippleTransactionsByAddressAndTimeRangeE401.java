...
public class ListXRPRippleTransactionsByAddressAndTimeRangeE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByAddressAndTimeRangeE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByAddressAndTimeRangeE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByAddressAndTimeRangeE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByAddressAndTimeRangeE401>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByAddressAndTimeRangeE401 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByAddressAndTimeRangeE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByAddressAndTimeRangeE401 ret = new ListXRPRippleTransactionsByAddressAndTimeRangeE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByAddressAndTimeRangeE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByAddressAndTimeRangeE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByAddressAndTimeRangeE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByAddressAndTimeRangeE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByAddressAndTimeRangeE401
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE401
  */
  public static ListXRPRippleTransactionsByAddressAndTimeRangeE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByAddressAndTimeRangeE401.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE401 to an JSON string
  *
  * @return JSON string
  */
