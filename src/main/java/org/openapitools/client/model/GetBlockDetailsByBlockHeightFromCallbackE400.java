...
public class GetBlockDetailsByBlockHeightFromCallbackE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHeightFromCallbackE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHeightFromCallbackE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHeightFromCallbackE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHeightFromCallbackE400>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHeightFromCallbackE400 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHeightFromCallbackE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHeightFromCallbackE400 ret = new GetBlockDetailsByBlockHeightFromCallbackE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHeightFromCallbackE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHeightFromCallbackE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHeightFromCallbackE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHeightFromCallbackE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHeightFromCallbackE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHeightFromCallbackE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHeightFromCallbackE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHeightFromCallbackE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHeightFromCallbackE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHeightFromCallbackE400
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHeightFromCallbackE400
  */
  public static GetBlockDetailsByBlockHeightFromCallbackE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHeightFromCallbackE400.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHeightFromCallbackE400 to an JSON string
  *
  * @return JSON string
  */
