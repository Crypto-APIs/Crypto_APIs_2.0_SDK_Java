...
public class GetExchangeRateByAssetsIDsE422 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetsIDsE422.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetsIDsE422.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetsIDsE422' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetsIDsE422>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetsIDsE422 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetsIDsE422 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format("Deserialization for CouldNotCalculateRateForPair failed with `%s`.", e.getMessage()));
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetsIDsE422 ret = new GetExchangeRateByAssetsIDsE422();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetsIDsE422: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetsIDsE422() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetsIDsE422(CouldNotCalculateRateForPair o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE422(InvalidRequestBodyStructure o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetsIDsE422.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetsIDsE422
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetsIDsE422 with oneOf schemas: CouldNotCalculateRateForPair, InvalidRequestBodyStructure. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetsIDsE422 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetsIDsE422
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetsIDsE422
  */
  public static GetExchangeRateByAssetsIDsE422 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetsIDsE422.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetsIDsE422 to an JSON string
  *
  * @return JSON string
  */
