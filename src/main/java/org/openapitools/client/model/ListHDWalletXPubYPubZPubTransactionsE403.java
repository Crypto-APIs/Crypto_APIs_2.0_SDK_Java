...
public class ListHDWalletXPubYPubZPubTransactionsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHDWalletXPubYPubZPubTransactionsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubTransactionsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubTransactionsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubTransactionsE403>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubTransactionsE403 value) throws IOException {
                ...
                @Override
                public ListHDWalletXPubYPubZPubTransactionsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubTransactionsE403 ret = new ListHDWalletXPubYPubZPubTransactionsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubTransactionsE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHDWalletXPubYPubZPubTransactionsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubTransactionsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubTransactionsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubTransactionsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubTransactionsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubTransactionsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListHDWalletXPubYPubZPubTransactionsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListHDWalletXPubYPubZPubTransactionsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubTransactionsE403
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE403
  */
  public static ListHDWalletXPubYPubZPubTransactionsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubTransactionsE403.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubTransactionsE403 to an JSON string
  *
  * @return JSON string
  */
