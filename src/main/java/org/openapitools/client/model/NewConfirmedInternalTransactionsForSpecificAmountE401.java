...
public class NewConfirmedInternalTransactionsForSpecificAmountE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsForSpecificAmountE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsForSpecificAmountE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsForSpecificAmountE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsForSpecificAmountE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsForSpecificAmountE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsForSpecificAmountE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsForSpecificAmountE401 ret = new NewConfirmedInternalTransactionsForSpecificAmountE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsForSpecificAmountE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsForSpecificAmountE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsForSpecificAmountE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsForSpecificAmountE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsForSpecificAmountE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE401
  */
  public static NewConfirmedInternalTransactionsForSpecificAmountE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsForSpecificAmountE401.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsForSpecificAmountE401 to an JSON string
  *
  * @return JSON string
  */
