...
public class ListTokensByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListTokensByAddressE401 value) throws IOException {
                ...
                @Override
                public ListTokensByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensByAddressE401 ret = new ListTokensByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListTokensByAddressE401
  */
  public static ListTokensByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensByAddressE401.class);
  }

 /**
  * Convert an instance of ListTokensByAddressE401 to an JSON string
  *
  * @return JSON string
  */
