...
public class GetTransactionDetailsByTransactionIDFromCallbackE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTransactionDetailsByTransactionIDFromCallbackE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionDetailsByTransactionIDFromCallbackE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionDetailsByTransactionIDFromCallbackE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionDetailsByTransactionIDFromCallbackE403>() {
                @Override
                public void write(JsonWriter out, GetTransactionDetailsByTransactionIDFromCallbackE403 value) throws IOException {
                ...
                @Override
                public GetTransactionDetailsByTransactionIDFromCallbackE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionDetailsByTransactionIDFromCallbackE403 ret = new GetTransactionDetailsByTransactionIDFromCallbackE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTransactionDetailsByTransactionIDFromCallbackE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTransactionDetailsByTransactionIDFromCallbackE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionDetailsByTransactionIDFromCallbackE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionDetailsByTransactionIDFromCallbackE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTransactionDetailsByTransactionIDFromCallbackE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTransactionDetailsByTransactionIDFromCallbackE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionDetailsByTransactionIDFromCallbackE403
  * @throws IOException if the JSON string is invalid with respect to GetTransactionDetailsByTransactionIDFromCallbackE403
  */
  public static GetTransactionDetailsByTransactionIDFromCallbackE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionDetailsByTransactionIDFromCallbackE403.class);
  }

 /**
  * Convert an instance of GetTransactionDetailsByTransactionIDFromCallbackE403 to an JSON string
  *
  * @return JSON string
  */
