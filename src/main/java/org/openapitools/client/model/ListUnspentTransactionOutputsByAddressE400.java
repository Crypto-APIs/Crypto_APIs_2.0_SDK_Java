...
public class ListUnspentTransactionOutputsByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnspentTransactionOutputsByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnspentTransactionOutputsByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnspentTransactionOutputsByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnspentTransactionOutputsByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListUnspentTransactionOutputsByAddressE400 value) throws IOException {
                ...
                @Override
                public ListUnspentTransactionOutputsByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnspentTransactionOutputsByAddressE400 ret = new ListUnspentTransactionOutputsByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnspentTransactionOutputsByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnspentTransactionOutputsByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnspentTransactionOutputsByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnspentTransactionOutputsByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnspentTransactionOutputsByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnspentTransactionOutputsByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnspentTransactionOutputsByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnspentTransactionOutputsByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListUnspentTransactionOutputsByAddressE400
  */
  public static ListUnspentTransactionOutputsByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnspentTransactionOutputsByAddressE400.class);
  }

 /**
  * Convert an instance of ListUnspentTransactionOutputsByAddressE400 to an JSON string
  *
  * @return JSON string
  */
