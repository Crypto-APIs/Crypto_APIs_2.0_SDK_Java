...
public class GetBlockDetailsByBlockHeightE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHeightE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHeightE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHeightE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHeightE403>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHeightE403 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHeightE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHeightE403 ret = new GetBlockDetailsByBlockHeightE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHeightE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHeightE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHeightE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHeightE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHeightE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHeightE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHeightE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHeightE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHeightE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHeightE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHeightE403
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHeightE403
  */
  public static GetBlockDetailsByBlockHeightE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHeightE403.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHeightE403 to an JSON string
  *
  * @return JSON string
  */
