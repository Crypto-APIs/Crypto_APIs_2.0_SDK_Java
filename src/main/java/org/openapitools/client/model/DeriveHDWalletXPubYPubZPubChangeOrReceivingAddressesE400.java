...
public class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400>() {
                @Override
                public void write(JsonWriter out, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound");
                }

                @Override
                public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 ret = new DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound");
    }
     ...
     * InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound
     *
     * @return The actual instance (InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400
  * @throws IOException if the JSON string is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400
  */
  public static DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.class);
  }

 /**
  * Convert an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 to an JSON string
  *
  * @return JSON string
  */
