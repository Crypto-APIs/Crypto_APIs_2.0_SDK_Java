...
public class GetLatestMinedZilliqaBlockE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedZilliqaBlockE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedZilliqaBlockE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedZilliqaBlockE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedZilliqaBlockE400>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedZilliqaBlockE400 value) throws IOException {
                ...
                @Override
                public GetLatestMinedZilliqaBlockE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedZilliqaBlockE400 ret = new GetLatestMinedZilliqaBlockE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedZilliqaBlockE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedZilliqaBlockE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedZilliqaBlockE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedZilliqaBlockE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedZilliqaBlockE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedZilliqaBlockE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedZilliqaBlockE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedZilliqaBlockE400
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedZilliqaBlockE400
  */
  public static GetLatestMinedZilliqaBlockE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedZilliqaBlockE400.class);
  }

 /**
  * Convert an instance of GetLatestMinedZilliqaBlockE400 to an JSON string
  *
  * @return JSON string
  */
