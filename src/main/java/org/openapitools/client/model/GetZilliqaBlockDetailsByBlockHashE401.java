...
public class GetZilliqaBlockDetailsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaBlockDetailsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaBlockDetailsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaBlockDetailsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaBlockDetailsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, GetZilliqaBlockDetailsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public GetZilliqaBlockDetailsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaBlockDetailsByBlockHashE401 ret = new GetZilliqaBlockDetailsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaBlockDetailsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaBlockDetailsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaBlockDetailsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaBlockDetailsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaBlockDetailsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaBlockDetailsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaBlockDetailsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaBlockDetailsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaBlockDetailsByBlockHashE401
  */
  public static GetZilliqaBlockDetailsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaBlockDetailsByBlockHashE401.class);
  }

 /**
  * Convert an instance of GetZilliqaBlockDetailsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
