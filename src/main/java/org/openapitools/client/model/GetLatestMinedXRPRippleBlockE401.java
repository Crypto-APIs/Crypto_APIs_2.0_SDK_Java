...
public class GetLatestMinedXRPRippleBlockE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedXRPRippleBlockE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedXRPRippleBlockE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedXRPRippleBlockE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedXRPRippleBlockE401>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedXRPRippleBlockE401 value) throws IOException {
                ...
                @Override
                public GetLatestMinedXRPRippleBlockE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedXRPRippleBlockE401 ret = new GetLatestMinedXRPRippleBlockE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedXRPRippleBlockE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedXRPRippleBlockE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedXRPRippleBlockE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedXRPRippleBlockE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedXRPRippleBlockE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedXRPRippleBlockE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedXRPRippleBlockE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedXRPRippleBlockE401
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedXRPRippleBlockE401
  */
  public static GetLatestMinedXRPRippleBlockE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedXRPRippleBlockE401.class);
  }

 /**
  * Convert an instance of GetLatestMinedXRPRippleBlockE401 to an JSON string
  *
  * @return JSON string
  */
