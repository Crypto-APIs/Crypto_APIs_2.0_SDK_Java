...
public class ListOmniTransactionsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTransactionsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTransactionsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTransactionsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTransactionsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, ListOmniTransactionsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public ListOmniTransactionsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTransactionsByBlockHashE401 ret = new ListOmniTransactionsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTransactionsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTransactionsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTransactionsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTransactionsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTransactionsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTransactionsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTransactionsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTransactionsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to ListOmniTransactionsByBlockHashE401
  */
  public static ListOmniTransactionsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTransactionsByBlockHashE401.class);
  }

 /**
  * Convert an instance of ListOmniTransactionsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
