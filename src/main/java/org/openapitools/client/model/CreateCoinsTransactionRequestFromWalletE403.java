...
public class CreateCoinsTransactionRequestFromWalletE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCoinsTransactionRequestFromWalletE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCoinsTransactionRequestFromWalletE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCoinsTransactionRequestFromWalletE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCoinsTransactionRequestFromWalletE403>() {
                @Override
                public void write(JsonWriter out, CreateCoinsTransactionRequestFromWalletE403 value) throws IOException {
                ...
                @Override
                public CreateCoinsTransactionRequestFromWalletE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCoinsTransactionRequestFromWalletE403 ret = new CreateCoinsTransactionRequestFromWalletE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCoinsTransactionRequestFromWalletE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCoinsTransactionRequestFromWalletE403() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCoinsTransactionRequestFromWalletE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCoinsTransactionRequestFromWalletE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCoinsTransactionRequestFromWalletE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCoinsTransactionRequestFromWalletE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCoinsTransactionRequestFromWalletE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCoinsTransactionRequestFromWalletE403
  * @throws IOException if the JSON string is invalid with respect to CreateCoinsTransactionRequestFromWalletE403
  */
  public static CreateCoinsTransactionRequestFromWalletE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCoinsTransactionRequestFromWalletE403.class);
  }

 /**
  * Convert an instance of CreateCoinsTransactionRequestFromWalletE403 to an JSON string
  *
  * @return JSON string
  */
