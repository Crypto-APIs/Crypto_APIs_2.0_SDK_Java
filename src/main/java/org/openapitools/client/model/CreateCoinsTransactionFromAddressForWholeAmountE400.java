...
public class CreateCoinsTransactionFromAddressForWholeAmountE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCoinsTransactionFromAddressForWholeAmountE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCoinsTransactionFromAddressForWholeAmountE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCoinsTransactionFromAddressForWholeAmountE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCoinsTransactionFromAddressForWholeAmountE400>() {
                @Override
                public void write(JsonWriter out, CreateCoinsTransactionFromAddressForWholeAmountE400 value) throws IOException {
                ...
                @Override
                public CreateCoinsTransactionFromAddressForWholeAmountE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCoinsTransactionFromAddressForWholeAmountE400 ret = new CreateCoinsTransactionFromAddressForWholeAmountE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCoinsTransactionFromAddressForWholeAmountE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCoinsTransactionFromAddressForWholeAmountE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCoinsTransactionFromAddressForWholeAmountE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionFromAddressForWholeAmountE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionFromAddressForWholeAmountE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCoinsTransactionFromAddressForWholeAmountE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCoinsTransactionFromAddressForWholeAmountE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCoinsTransactionFromAddressForWholeAmountE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCoinsTransactionFromAddressForWholeAmountE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCoinsTransactionFromAddressForWholeAmountE400
  * @throws IOException if the JSON string is invalid with respect to CreateCoinsTransactionFromAddressForWholeAmountE400
  */
  public static CreateCoinsTransactionFromAddressForWholeAmountE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCoinsTransactionFromAddressForWholeAmountE400.class);
  }

 /**
  * Convert an instance of CreateCoinsTransactionFromAddressForWholeAmountE400 to an JSON string
  *
  * @return JSON string
  */
