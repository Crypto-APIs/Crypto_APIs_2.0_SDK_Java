...
public class ListTransactionsByBlockHeightE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTransactionsByBlockHeightE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTransactionsByBlockHeightE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTransactionsByBlockHeightE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTransactionsByBlockHeightE403>() {
                @Override
                public void write(JsonWriter out, ListTransactionsByBlockHeightE403 value) throws IOException {
                ...
                @Override
                public ListTransactionsByBlockHeightE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTransactionsByBlockHeightE403 ret = new ListTransactionsByBlockHeightE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTransactionsByBlockHeightE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTransactionsByBlockHeightE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTransactionsByBlockHeightE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTransactionsByBlockHeightE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTransactionsByBlockHeightE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTransactionsByBlockHeightE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTransactionsByBlockHeightE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTransactionsByBlockHeightE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTransactionsByBlockHeightE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTransactionsByBlockHeightE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTransactionsByBlockHeightE403
  * @throws IOException if the JSON string is invalid with respect to ListTransactionsByBlockHeightE403
  */
  public static ListTransactionsByBlockHeightE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTransactionsByBlockHeightE403.class);
  }

 /**
  * Convert an instance of ListTransactionsByBlockHeightE403 to an JSON string
  *
  * @return JSON string
  */
