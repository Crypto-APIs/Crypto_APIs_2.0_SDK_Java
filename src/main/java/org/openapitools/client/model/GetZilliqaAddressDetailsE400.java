...
public class GetZilliqaAddressDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaAddressDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaAddressDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaAddressDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaAddressDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetZilliqaAddressDetailsE400 value) throws IOException {
                ...
                @Override
                public GetZilliqaAddressDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaAddressDetailsE400 ret = new GetZilliqaAddressDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaAddressDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaAddressDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaAddressDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaAddressDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaAddressDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaAddressDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaAddressDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaAddressDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaAddressDetailsE400
  */
  public static GetZilliqaAddressDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaAddressDetailsE400.class);
  }

 /**
  * Convert an instance of GetZilliqaAddressDetailsE400 to an JSON string
  *
  * @return JSON string
  */
