...
public class ListTransactionsByBlockHeightE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTransactionsByBlockHeightE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTransactionsByBlockHeightE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTransactionsByBlockHeightE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTransactionsByBlockHeightE401>() {
                @Override
                public void write(JsonWriter out, ListTransactionsByBlockHeightE401 value) throws IOException {
                ...
                @Override
                public ListTransactionsByBlockHeightE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTransactionsByBlockHeightE401 ret = new ListTransactionsByBlockHeightE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTransactionsByBlockHeightE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTransactionsByBlockHeightE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTransactionsByBlockHeightE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTransactionsByBlockHeightE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTransactionsByBlockHeightE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTransactionsByBlockHeightE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTransactionsByBlockHeightE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTransactionsByBlockHeightE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTransactionsByBlockHeightE401
  * @throws IOException if the JSON string is invalid with respect to ListTransactionsByBlockHeightE401
  */
  public static ListTransactionsByBlockHeightE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTransactionsByBlockHeightE401.class);
  }

 /**
  * Convert an instance of ListTransactionsByBlockHeightE401 to an JSON string
  *
  * @return JSON string
  */
