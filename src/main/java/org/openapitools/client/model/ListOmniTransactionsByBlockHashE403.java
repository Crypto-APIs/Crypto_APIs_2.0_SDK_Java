...
public class ListOmniTransactionsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTransactionsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTransactionsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTransactionsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTransactionsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, ListOmniTransactionsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public ListOmniTransactionsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTransactionsByBlockHashE403 ret = new ListOmniTransactionsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTransactionsByBlockHashE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTransactionsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTransactionsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTransactionsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTransactionsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTransactionsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTransactionsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTransactionsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to ListOmniTransactionsByBlockHashE403
  */
  public static ListOmniTransactionsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTransactionsByBlockHashE403.class);
  }

 /**
  * Convert an instance of ListOmniTransactionsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
