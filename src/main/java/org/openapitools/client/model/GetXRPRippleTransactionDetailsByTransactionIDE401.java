...
public class GetXRPRippleTransactionDetailsByTransactionIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleTransactionDetailsByTransactionIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleTransactionDetailsByTransactionIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleTransactionDetailsByTransactionIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleTransactionDetailsByTransactionIDE401>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleTransactionDetailsByTransactionIDE401 value) throws IOException {
                ...
                @Override
                public GetXRPRippleTransactionDetailsByTransactionIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleTransactionDetailsByTransactionIDE401 ret = new GetXRPRippleTransactionDetailsByTransactionIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleTransactionDetailsByTransactionIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleTransactionDetailsByTransactionIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleTransactionDetailsByTransactionIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleTransactionDetailsByTransactionIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleTransactionDetailsByTransactionIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleTransactionDetailsByTransactionIDE401
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE401
  */
  public static GetXRPRippleTransactionDetailsByTransactionIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleTransactionDetailsByTransactionIDE401.class);
  }

 /**
  * Convert an instance of GetXRPRippleTransactionDetailsByTransactionIDE401 to an JSON string
  *
  * @return JSON string
  */
