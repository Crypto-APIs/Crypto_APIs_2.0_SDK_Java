...
public class ListAssetsDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAssetsDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAssetsDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAssetsDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAssetsDetailsE403>() {
                @Override
                public void write(JsonWriter out, ListAssetsDetailsE403 value) throws IOException {
                ...
                @Override
                public ListAssetsDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAssetsDetailsE403 ret = new ListAssetsDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAssetsDetailsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAssetsDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAssetsDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAssetsDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAssetsDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAssetsDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAssetsDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAssetsDetailsE403
  * @throws IOException if the JSON string is invalid with respect to ListAssetsDetailsE403
  */
  public static ListAssetsDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssetsDetailsE403.class);
  }

 /**
  * Convert an instance of ListAssetsDetailsE403 to an JSON string
  *
  * @return JSON string
  */
