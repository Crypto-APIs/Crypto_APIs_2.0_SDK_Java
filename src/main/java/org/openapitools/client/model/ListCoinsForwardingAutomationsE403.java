...
public class ListCoinsForwardingAutomationsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListCoinsForwardingAutomationsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListCoinsForwardingAutomationsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListCoinsForwardingAutomationsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListCoinsForwardingAutomationsE403>() {
                @Override
                public void write(JsonWriter out, ListCoinsForwardingAutomationsE403 value) throws IOException {
                ...
                @Override
                public ListCoinsForwardingAutomationsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListCoinsForwardingAutomationsE403 ret = new ListCoinsForwardingAutomationsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListCoinsForwardingAutomationsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListCoinsForwardingAutomationsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListCoinsForwardingAutomationsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListCoinsForwardingAutomationsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListCoinsForwardingAutomationsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListCoinsForwardingAutomationsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListCoinsForwardingAutomationsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListCoinsForwardingAutomationsE403
  * @throws IOException if the JSON string is invalid with respect to ListCoinsForwardingAutomationsE403
  */
  public static ListCoinsForwardingAutomationsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCoinsForwardingAutomationsE403.class);
  }

 /**
  * Convert an instance of ListCoinsForwardingAutomationsE403 to an JSON string
  *
  * @return JSON string
  */
