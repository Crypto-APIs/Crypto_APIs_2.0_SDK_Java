...
public class DeleteBlockchainEventSubscriptionE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteBlockchainEventSubscriptionE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteBlockchainEventSubscriptionE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteBlockchainEventSubscriptionE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteBlockchainEventSubscriptionE400>() {
                @Override
                public void write(JsonWriter out, DeleteBlockchainEventSubscriptionE400 value) throws IOException {
                ...
                @Override
                public DeleteBlockchainEventSubscriptionE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteBlockchainEventSubscriptionE400 ret = new DeleteBlockchainEventSubscriptionE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteBlockchainEventSubscriptionE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteBlockchainEventSubscriptionE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteBlockchainEventSubscriptionE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteBlockchainEventSubscriptionE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteBlockchainEventSubscriptionE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteBlockchainEventSubscriptionE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteBlockchainEventSubscriptionE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteBlockchainEventSubscriptionE400
  * @throws IOException if the JSON string is invalid with respect to DeleteBlockchainEventSubscriptionE400
  */
  public static DeleteBlockchainEventSubscriptionE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBlockchainEventSubscriptionE400.class);
  }

 /**
  * Convert an instance of DeleteBlockchainEventSubscriptionE400 to an JSON string
  *
  * @return JSON string
  */
