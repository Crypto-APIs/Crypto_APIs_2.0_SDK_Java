...
public class ListUnspentTransactionOutputsByAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnspentTransactionOutputsByAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnspentTransactionOutputsByAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnspentTransactionOutputsByAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnspentTransactionOutputsByAddressE403>() {
                @Override
                public void write(JsonWriter out, ListUnspentTransactionOutputsByAddressE403 value) throws IOException {
                ...
                @Override
                public ListUnspentTransactionOutputsByAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnspentTransactionOutputsByAddressE403 ret = new ListUnspentTransactionOutputsByAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnspentTransactionOutputsByAddressE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnspentTransactionOutputsByAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnspentTransactionOutputsByAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnspentTransactionOutputsByAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnspentTransactionOutputsByAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnspentTransactionOutputsByAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnspentTransactionOutputsByAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnspentTransactionOutputsByAddressE403
  * @throws IOException if the JSON string is invalid with respect to ListUnspentTransactionOutputsByAddressE403
  */
  public static ListUnspentTransactionOutputsByAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnspentTransactionOutputsByAddressE403.class);
  }

 /**
  * Convert an instance of ListUnspentTransactionOutputsByAddressE403 to an JSON string
  *
  * @return JSON string
  */
