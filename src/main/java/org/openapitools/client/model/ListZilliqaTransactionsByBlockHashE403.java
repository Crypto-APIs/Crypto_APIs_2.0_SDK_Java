...
public class ListZilliqaTransactionsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListZilliqaTransactionsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListZilliqaTransactionsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListZilliqaTransactionsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListZilliqaTransactionsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, ListZilliqaTransactionsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public ListZilliqaTransactionsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListZilliqaTransactionsByBlockHashE403 ret = new ListZilliqaTransactionsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListZilliqaTransactionsByBlockHashE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListZilliqaTransactionsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListZilliqaTransactionsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListZilliqaTransactionsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListZilliqaTransactionsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListZilliqaTransactionsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListZilliqaTransactionsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListZilliqaTransactionsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to ListZilliqaTransactionsByBlockHashE403
  */
  public static ListZilliqaTransactionsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListZilliqaTransactionsByBlockHashE403.class);
  }

 /**
  * Convert an instance of ListZilliqaTransactionsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
