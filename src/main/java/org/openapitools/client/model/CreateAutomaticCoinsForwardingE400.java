...
public class CreateAutomaticCoinsForwardingE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateAutomaticCoinsForwardingE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAutomaticCoinsForwardingE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAutomaticCoinsForwardingE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateAutomaticCoinsForwardingE400>() {
                @Override
                public void write(JsonWriter out, CreateAutomaticCoinsForwardingE400 value) throws IOException {
                ...
                @Override
                public CreateAutomaticCoinsForwardingE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateAutomaticCoinsForwardingE400 ret = new CreateAutomaticCoinsForwardingE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateAutomaticCoinsForwardingE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateAutomaticCoinsForwardingE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAutomaticCoinsForwardingE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticCoinsForwardingE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticCoinsForwardingE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateAutomaticCoinsForwardingE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAutomaticCoinsForwardingE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateAutomaticCoinsForwardingE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateAutomaticCoinsForwardingE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAutomaticCoinsForwardingE400
  * @throws IOException if the JSON string is invalid with respect to CreateAutomaticCoinsForwardingE400
  */
  public static CreateAutomaticCoinsForwardingE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAutomaticCoinsForwardingE400.class);
  }

 /**
  * Convert an instance of CreateAutomaticCoinsForwardingE400 to an JSON string
  *
  * @return JSON string
  */
