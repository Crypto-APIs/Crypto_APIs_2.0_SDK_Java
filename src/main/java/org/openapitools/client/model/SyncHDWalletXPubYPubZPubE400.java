...
public class SyncHDWalletXPubYPubZPubE400 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncHDWalletXPubYPubZPubE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncHDWalletXPubYPubZPubE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncHDWalletXPubYPubZPubE400>() {
                @Override
                public void write(JsonWriter out, SyncHDWalletXPubYPubZPubE400 value) throws IOException {
                ...
                @Override
                public SyncHDWalletXPubYPubZPubE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncHDWalletXPubYPubZPubE400 ret = new SyncHDWalletXPubYPubZPubE400();
    ...
    public SyncHDWalletXPubYPubZPubE400() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncHDWalletXPubYPubZPubE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE400(XpubNotSynced o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncHDWalletXPubYPubZPubE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncHDWalletXPubYPubZPubE400
  */
 ...
 /**
  * Create an instance of SyncHDWalletXPubYPubZPubE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncHDWalletXPubYPubZPubE400
  * @throws IOException if the JSON string is invalid with respect to SyncHDWalletXPubYPubZPubE400
  */
  public static SyncHDWalletXPubYPubZPubE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncHDWalletXPubYPubZPubE400.class);
  }

 /**
  * Convert an instance of SyncHDWalletXPubYPubZPubE400 to an JSON string
  *
  * @return JSON string
  */
