...
public class ListUnconfirmedTokensTransfersByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedTokensTransfersByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedTokensTransfersByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedTokensTransfersByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedTokensTransfersByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedTokensTransfersByAddressE400 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedTokensTransfersByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedTokensTransfersByAddressE400 ret = new ListUnconfirmedTokensTransfersByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedTokensTransfersByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedTokensTransfersByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedTokensTransfersByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTokensTransfersByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTokensTransfersByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedTokensTransfersByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedTokensTransfersByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedTokensTransfersByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedTokensTransfersByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedTokensTransfersByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedTokensTransfersByAddressE400
  */
  public static ListUnconfirmedTokensTransfersByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedTokensTransfersByAddressE400.class);
  }

 /**
  * Convert an instance of ListUnconfirmedTokensTransfersByAddressE400 to an JSON string
  *
  * @return JSON string
  */
