...
public class NewBlockE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewBlockE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewBlockE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewBlockE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewBlockE403>() {
                @Override
                public void write(JsonWriter out, NewBlockE403 value) throws IOException {
                ...
                @Override
                public NewBlockE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewBlockE403 ret = new NewBlockE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewBlockE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewBlockE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewBlockE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewBlockE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewBlockE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewBlockE403
  * @throws IOException if the JSON string is invalid with respect to NewBlockE403
  */
  public static NewBlockE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewBlockE403.class);
  }

 /**
  * Convert an instance of NewBlockE403 to an JSON string
  *
  * @return JSON string
  */
