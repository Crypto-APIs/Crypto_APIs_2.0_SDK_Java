...
public class DeleteBlockchainEventSubscriptionE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteBlockchainEventSubscriptionE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteBlockchainEventSubscriptionE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteBlockchainEventSubscriptionE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteBlockchainEventSubscriptionE403>() {
                @Override
                public void write(JsonWriter out, DeleteBlockchainEventSubscriptionE403 value) throws IOException {
                ...
                @Override
                public DeleteBlockchainEventSubscriptionE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteBlockchainEventSubscriptionE403 ret = new DeleteBlockchainEventSubscriptionE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteBlockchainEventSubscriptionE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteBlockchainEventSubscriptionE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteBlockchainEventSubscriptionE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteBlockchainEventSubscriptionE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteBlockchainEventSubscriptionE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteBlockchainEventSubscriptionE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteBlockchainEventSubscriptionE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteBlockchainEventSubscriptionE403
  * @throws IOException if the JSON string is invalid with respect to DeleteBlockchainEventSubscriptionE403
  */
  public static DeleteBlockchainEventSubscriptionE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBlockchainEventSubscriptionE403.class);
  }

 /**
  * Convert an instance of DeleteBlockchainEventSubscriptionE403 to an JSON string
  *
  * @return JSON string
  */
