...
public class NewConfirmedCoinsTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsE400 ret = new NewConfirmedCoinsTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsE400
  */
  public static NewConfirmedCoinsTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsE400.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
