...
public class GetUnconfirmedOmniTransactionByTransactionIDTxidE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetUnconfirmedOmniTransactionByTransactionIDTxidE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUnconfirmedOmniTransactionByTransactionIDTxidE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUnconfirmedOmniTransactionByTransactionIDTxidE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetUnconfirmedOmniTransactionByTransactionIDTxidE403>() {
                @Override
                public void write(JsonWriter out, GetUnconfirmedOmniTransactionByTransactionIDTxidE403 value) throws IOException {
                ...
                @Override
                public GetUnconfirmedOmniTransactionByTransactionIDTxidE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetUnconfirmedOmniTransactionByTransactionIDTxidE403 ret = new GetUnconfirmedOmniTransactionByTransactionIDTxidE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetUnconfirmedOmniTransactionByTransactionIDTxidE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetUnconfirmedOmniTransactionByTransactionIDTxidE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetUnconfirmedOmniTransactionByTransactionIDTxidE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetUnconfirmedOmniTransactionByTransactionIDTxidE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE403
  * @throws IOException if the JSON string is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE403
  */
  public static GetUnconfirmedOmniTransactionByTransactionIDTxidE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUnconfirmedOmniTransactionByTransactionIDTxidE403.class);
  }

 /**
  * Convert an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE403 to an JSON string
  *
  * @return JSON string
  */
