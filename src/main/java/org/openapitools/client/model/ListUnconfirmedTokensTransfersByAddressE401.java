...
public class ListUnconfirmedTokensTransfersByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedTokensTransfersByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedTokensTransfersByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedTokensTransfersByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedTokensTransfersByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedTokensTransfersByAddressE401 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedTokensTransfersByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedTokensTransfersByAddressE401 ret = new ListUnconfirmedTokensTransfersByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedTokensTransfersByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedTokensTransfersByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedTokensTransfersByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTokensTransfersByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedTokensTransfersByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedTokensTransfersByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedTokensTransfersByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedTokensTransfersByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedTokensTransfersByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedTokensTransfersByAddressE401
  */
  public static ListUnconfirmedTokensTransfersByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedTokensTransfersByAddressE401.class);
  }

 /**
  * Convert an instance of ListUnconfirmedTokensTransfersByAddressE401 to an JSON string
  *
  * @return JSON string
  */
