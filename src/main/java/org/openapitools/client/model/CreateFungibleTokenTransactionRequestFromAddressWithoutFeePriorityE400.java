...
public class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400>() {
                @Override
                public void write(JsonWriter out, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 value) throws IOException {
                ...
                @Override
                public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 ret = new CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400
  * @throws IOException if the JSON string is invalid with respect to CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400
  */
  public static CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400.class);
  }

 /**
  * Convert an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 to an JSON string
  *
  * @return JSON string
  */
