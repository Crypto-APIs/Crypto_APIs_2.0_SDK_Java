...
public class DeriveAndSyncNewReceivingAddressesE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewReceivingAddressesE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewReceivingAddressesE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewReceivingAddressesE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewReceivingAddressesE403>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewReceivingAddressesE403 value) throws IOException {
                ...
                @Override
                public DeriveAndSyncNewReceivingAddressesE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewReceivingAddressesE403 ret = new DeriveAndSyncNewReceivingAddressesE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewReceivingAddressesE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewReceivingAddressesE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewReceivingAddressesE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewReceivingAddressesE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewReceivingAddressesE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewReceivingAddressesE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewReceivingAddressesE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewReceivingAddressesE403
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewReceivingAddressesE403
  */
  public static DeriveAndSyncNewReceivingAddressesE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewReceivingAddressesE403.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewReceivingAddressesE403 to an JSON string
  *
  * @return JSON string
  */
