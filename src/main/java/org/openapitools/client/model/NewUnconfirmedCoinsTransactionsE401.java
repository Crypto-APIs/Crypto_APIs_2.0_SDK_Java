...
public class NewUnconfirmedCoinsTransactionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedCoinsTransactionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedCoinsTransactionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedCoinsTransactionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedCoinsTransactionsE401>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedCoinsTransactionsE401 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedCoinsTransactionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedCoinsTransactionsE401 ret = new NewUnconfirmedCoinsTransactionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedCoinsTransactionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedCoinsTransactionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewUnconfirmedCoinsTransactionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedCoinsTransactionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedCoinsTransactionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedCoinsTransactionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedCoinsTransactionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedCoinsTransactionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedCoinsTransactionsE401
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedCoinsTransactionsE401
  */
  public static NewUnconfirmedCoinsTransactionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedCoinsTransactionsE401.class);
  }

 /**
  * Convert an instance of NewUnconfirmedCoinsTransactionsE401 to an JSON string
  *
  * @return JSON string
  */
