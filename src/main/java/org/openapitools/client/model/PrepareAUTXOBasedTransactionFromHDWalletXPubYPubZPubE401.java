...
public class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401>() {
                @Override
                public void write(JsonWriter out, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 value) throws IOException {
                ...
                @Override
                public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 ret = new PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401
  * @throws IOException if the JSON string is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401
  */
  public static PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.class);
  }

 /**
  * Convert an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 to an JSON string
  *
  * @return JSON string
  */
