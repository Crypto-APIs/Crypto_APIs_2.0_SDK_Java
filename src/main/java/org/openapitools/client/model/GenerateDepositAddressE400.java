...
public class GenerateDepositAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GenerateDepositAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GenerateDepositAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GenerateDepositAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GenerateDepositAddressE400>() {
                @Override
                public void write(JsonWriter out, GenerateDepositAddressE400 value) throws IOException {
                ...
                @Override
                public GenerateDepositAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GenerateDepositAddressE400 ret = new GenerateDepositAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GenerateDepositAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GenerateDepositAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GenerateDepositAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GenerateDepositAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GenerateDepositAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GenerateDepositAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateDepositAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GenerateDepositAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GenerateDepositAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateDepositAddressE400
  * @throws IOException if the JSON string is invalid with respect to GenerateDepositAddressE400
  */
  public static GenerateDepositAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDepositAddressE400.class);
  }

 /**
  * Convert an instance of GenerateDepositAddressE400 to an JSON string
  *
  * @return JSON string
  */
