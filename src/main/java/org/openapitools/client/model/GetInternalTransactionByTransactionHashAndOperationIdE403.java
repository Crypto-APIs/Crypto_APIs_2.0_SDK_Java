...
public class GetInternalTransactionByTransactionHashAndOperationIdE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetInternalTransactionByTransactionHashAndOperationIdE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetInternalTransactionByTransactionHashAndOperationIdE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetInternalTransactionByTransactionHashAndOperationIdE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetInternalTransactionByTransactionHashAndOperationIdE403>() {
                @Override
                public void write(JsonWriter out, GetInternalTransactionByTransactionHashAndOperationIdE403 value) throws IOException {
                ...
                @Override
                public GetInternalTransactionByTransactionHashAndOperationIdE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetInternalTransactionByTransactionHashAndOperationIdE403 ret = new GetInternalTransactionByTransactionHashAndOperationIdE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetInternalTransactionByTransactionHashAndOperationIdE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetInternalTransactionByTransactionHashAndOperationIdE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetInternalTransactionByTransactionHashAndOperationIdE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetInternalTransactionByTransactionHashAndOperationIdE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetInternalTransactionByTransactionHashAndOperationIdE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetInternalTransactionByTransactionHashAndOperationIdE403
  * @throws IOException if the JSON string is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE403
  */
  public static GetInternalTransactionByTransactionHashAndOperationIdE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInternalTransactionByTransactionHashAndOperationIdE403.class);
  }

 /**
  * Convert an instance of GetInternalTransactionByTransactionHashAndOperationIdE403 to an JSON string
  *
  * @return JSON string
  */
