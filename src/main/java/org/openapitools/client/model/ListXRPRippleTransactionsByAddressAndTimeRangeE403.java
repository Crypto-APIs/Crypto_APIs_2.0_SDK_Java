...
public class ListXRPRippleTransactionsByAddressAndTimeRangeE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByAddressAndTimeRangeE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByAddressAndTimeRangeE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByAddressAndTimeRangeE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByAddressAndTimeRangeE403>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByAddressAndTimeRangeE403 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByAddressAndTimeRangeE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByAddressAndTimeRangeE403 ret = new ListXRPRippleTransactionsByAddressAndTimeRangeE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByAddressAndTimeRangeE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByAddressAndTimeRangeE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByAddressAndTimeRangeE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByAddressAndTimeRangeE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByAddressAndTimeRangeE403
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE403
  */
  public static ListXRPRippleTransactionsByAddressAndTimeRangeE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByAddressAndTimeRangeE403.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE403 to an JSON string
  *
  * @return JSON string
  */
