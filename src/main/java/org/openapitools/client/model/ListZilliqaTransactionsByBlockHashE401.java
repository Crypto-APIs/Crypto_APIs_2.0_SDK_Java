...
public class ListZilliqaTransactionsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListZilliqaTransactionsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListZilliqaTransactionsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListZilliqaTransactionsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListZilliqaTransactionsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, ListZilliqaTransactionsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public ListZilliqaTransactionsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListZilliqaTransactionsByBlockHashE401 ret = new ListZilliqaTransactionsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListZilliqaTransactionsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListZilliqaTransactionsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListZilliqaTransactionsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListZilliqaTransactionsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListZilliqaTransactionsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListZilliqaTransactionsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListZilliqaTransactionsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListZilliqaTransactionsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to ListZilliqaTransactionsByBlockHashE401
  */
  public static ListZilliqaTransactionsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListZilliqaTransactionsByBlockHashE401.class);
  }

 /**
  * Convert an instance of ListZilliqaTransactionsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
