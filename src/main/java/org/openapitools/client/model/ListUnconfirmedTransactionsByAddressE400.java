...
public class ListUnconfirmedTransactionsByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedTransactionsByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedTransactionsByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedTransactionsByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedTransactionsByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedTransactionsByAddressE400 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedTransactionsByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedTransactionsByAddressE400 ret = new ListUnconfirmedTransactionsByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedTransactionsByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedTransactionsByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedTransactionsByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTransactionsByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTransactionsByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedTransactionsByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedTransactionsByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedTransactionsByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedTransactionsByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedTransactionsByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedTransactionsByAddressE400
  */
  public static ListUnconfirmedTransactionsByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedTransactionsByAddressE400.class);
  }

 /**
  * Convert an instance of ListUnconfirmedTransactionsByAddressE400 to an JSON string
  *
  * @return JSON string
  */
