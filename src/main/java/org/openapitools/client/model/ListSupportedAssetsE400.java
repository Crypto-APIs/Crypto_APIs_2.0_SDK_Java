...
public class ListSupportedAssetsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSupportedAssetsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSupportedAssetsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSupportedAssetsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSupportedAssetsE400>() {
                @Override
                public void write(JsonWriter out, ListSupportedAssetsE400 value) throws IOException {
                ...
                @Override
                public ListSupportedAssetsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSupportedAssetsE400 ret = new ListSupportedAssetsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSupportedAssetsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSupportedAssetsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSupportedAssetsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSupportedAssetsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSupportedAssetsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSupportedAssetsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSupportedAssetsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSupportedAssetsE400
  * @throws IOException if the JSON string is invalid with respect to ListSupportedAssetsE400
  */
  public static ListSupportedAssetsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedAssetsE400.class);
  }

 /**
  * Convert an instance of ListSupportedAssetsE400 to an JSON string
  *
  * @return JSON string
  */
