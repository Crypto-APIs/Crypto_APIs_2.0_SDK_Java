...
public class ListZilliqaTransactionsByBlockHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListZilliqaTransactionsByBlockHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListZilliqaTransactionsByBlockHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListZilliqaTransactionsByBlockHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListZilliqaTransactionsByBlockHashE400>() {
                @Override
                public void write(JsonWriter out, ListZilliqaTransactionsByBlockHashE400 value) throws IOException {
                ...
                @Override
                public ListZilliqaTransactionsByBlockHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListZilliqaTransactionsByBlockHashE400 ret = new ListZilliqaTransactionsByBlockHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListZilliqaTransactionsByBlockHashE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListZilliqaTransactionsByBlockHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListZilliqaTransactionsByBlockHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListZilliqaTransactionsByBlockHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListZilliqaTransactionsByBlockHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListZilliqaTransactionsByBlockHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListZilliqaTransactionsByBlockHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListZilliqaTransactionsByBlockHashE400
  * @throws IOException if the JSON string is invalid with respect to ListZilliqaTransactionsByBlockHashE400
  */
  public static ListZilliqaTransactionsByBlockHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListZilliqaTransactionsByBlockHashE400.class);
  }

 /**
  * Convert an instance of ListZilliqaTransactionsByBlockHashE400 to an JSON string
  *
  * @return JSON string
  */
