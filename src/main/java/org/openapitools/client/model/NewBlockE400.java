...
public class NewBlockE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewBlockE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewBlockE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewBlockE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewBlockE400>() {
                @Override
                public void write(JsonWriter out, NewBlockE400 value) throws IOException {
                ...
                @Override
                public NewBlockE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewBlockE400 ret = new NewBlockE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewBlockE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewBlockE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewBlockE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewBlockE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewBlockE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewBlockE400
  * @throws IOException if the JSON string is invalid with respect to NewBlockE400
  */
  public static NewBlockE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewBlockE400.class);
  }

 /**
  * Convert an instance of NewBlockE400 to an JSON string
  *
  * @return JSON string
  */
