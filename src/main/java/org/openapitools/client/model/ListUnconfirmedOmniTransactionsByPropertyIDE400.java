...
public class ListUnconfirmedOmniTransactionsByPropertyIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedOmniTransactionsByPropertyIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedOmniTransactionsByPropertyIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedOmniTransactionsByPropertyIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedOmniTransactionsByPropertyIDE400>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedOmniTransactionsByPropertyIDE400 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedOmniTransactionsByPropertyIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedOmniTransactionsByPropertyIDE400 ret = new ListUnconfirmedOmniTransactionsByPropertyIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedOmniTransactionsByPropertyIDE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedOmniTransactionsByPropertyIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedOmniTransactionsByPropertyIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedOmniTransactionsByPropertyIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedOmniTransactionsByPropertyIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedOmniTransactionsByPropertyIDE400
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE400
  */
  public static ListUnconfirmedOmniTransactionsByPropertyIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedOmniTransactionsByPropertyIDE400.class);
  }

 /**
  * Convert an instance of ListUnconfirmedOmniTransactionsByPropertyIDE400 to an JSON string
  *
  * @return JSON string
  */
