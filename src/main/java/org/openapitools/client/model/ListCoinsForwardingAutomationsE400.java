...
public class ListCoinsForwardingAutomationsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListCoinsForwardingAutomationsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListCoinsForwardingAutomationsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListCoinsForwardingAutomationsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListCoinsForwardingAutomationsE400>() {
                @Override
                public void write(JsonWriter out, ListCoinsForwardingAutomationsE400 value) throws IOException {
                ...
                @Override
                public ListCoinsForwardingAutomationsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListCoinsForwardingAutomationsE400 ret = new ListCoinsForwardingAutomationsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListCoinsForwardingAutomationsE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListCoinsForwardingAutomationsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListCoinsForwardingAutomationsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListCoinsForwardingAutomationsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListCoinsForwardingAutomationsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListCoinsForwardingAutomationsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListCoinsForwardingAutomationsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListCoinsForwardingAutomationsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListCoinsForwardingAutomationsE400
  * @throws IOException if the JSON string is invalid with respect to ListCoinsForwardingAutomationsE400
  */
  public static ListCoinsForwardingAutomationsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCoinsForwardingAutomationsE400.class);
  }

 /**
  * Convert an instance of ListCoinsForwardingAutomationsE400 to an JSON string
  *
  * @return JSON string
  */
