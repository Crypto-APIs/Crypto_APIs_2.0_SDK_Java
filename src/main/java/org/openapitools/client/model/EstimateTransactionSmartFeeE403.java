...
public class EstimateTransactionSmartFeeE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateTransactionSmartFeeE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateTransactionSmartFeeE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateTransactionSmartFeeE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateTransactionSmartFeeE403>() {
                @Override
                public void write(JsonWriter out, EstimateTransactionSmartFeeE403 value) throws IOException {
                ...
                @Override
                public EstimateTransactionSmartFeeE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateTransactionSmartFeeE403 ret = new EstimateTransactionSmartFeeE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateTransactionSmartFeeE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateTransactionSmartFeeE403() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateTransactionSmartFeeE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateTransactionSmartFeeE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateTransactionSmartFeeE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateTransactionSmartFeeE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateTransactionSmartFeeE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateTransactionSmartFeeE403
  * @throws IOException if the JSON string is invalid with respect to EstimateTransactionSmartFeeE403
  */
  public static EstimateTransactionSmartFeeE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateTransactionSmartFeeE403.class);
  }

 /**
  * Convert an instance of EstimateTransactionSmartFeeE403 to an JSON string
  *
  * @return JSON string
  */
