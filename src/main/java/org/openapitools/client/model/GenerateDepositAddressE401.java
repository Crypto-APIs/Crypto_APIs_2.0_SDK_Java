...
public class GenerateDepositAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GenerateDepositAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GenerateDepositAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GenerateDepositAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GenerateDepositAddressE401>() {
                @Override
                public void write(JsonWriter out, GenerateDepositAddressE401 value) throws IOException {
                ...
                @Override
                public GenerateDepositAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GenerateDepositAddressE401 ret = new GenerateDepositAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GenerateDepositAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GenerateDepositAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GenerateDepositAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GenerateDepositAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GenerateDepositAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateDepositAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GenerateDepositAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GenerateDepositAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateDepositAddressE401
  * @throws IOException if the JSON string is invalid with respect to GenerateDepositAddressE401
  */
  public static GenerateDepositAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDepositAddressE401.class);
  }

 /**
  * Convert an instance of GenerateDepositAddressE401 to an JSON string
  *
  * @return JSON string
  */
