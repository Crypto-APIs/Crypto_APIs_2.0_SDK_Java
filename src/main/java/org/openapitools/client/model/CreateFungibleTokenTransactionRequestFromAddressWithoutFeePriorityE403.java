...
public class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403>() {
                @Override
                public void write(JsonWriter out, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType");
                }

                @Override
                public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 ret = new CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType");
    }
     ...
     * BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType
     *
     * @return The actual instance (BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403
  * @throws IOException if the JSON string is invalid with respect to CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403
  */
  public static CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403.class);
  }

 /**
  * Convert an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403 to an JSON string
  *
  * @return JSON string
  */
