...
public class GetLatestMinedXRPRippleBlockE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedXRPRippleBlockE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedXRPRippleBlockE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedXRPRippleBlockE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedXRPRippleBlockE403>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedXRPRippleBlockE403 value) throws IOException {
                ...
                @Override
                public GetLatestMinedXRPRippleBlockE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedXRPRippleBlockE403 ret = new GetLatestMinedXRPRippleBlockE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedXRPRippleBlockE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedXRPRippleBlockE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedXRPRippleBlockE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedXRPRippleBlockE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedXRPRippleBlockE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedXRPRippleBlockE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedXRPRippleBlockE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedXRPRippleBlockE403
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedXRPRippleBlockE403
  */
  public static GetLatestMinedXRPRippleBlockE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedXRPRippleBlockE403.class);
  }

 /**
  * Convert an instance of GetLatestMinedXRPRippleBlockE403 to an JSON string
  *
  * @return JSON string
  */
