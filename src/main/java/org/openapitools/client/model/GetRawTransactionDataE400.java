...
public class GetRawTransactionDataE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetRawTransactionDataE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRawTransactionDataE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRawTransactionDataE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetRawTransactionDataE400>() {
                @Override
                public void write(JsonWriter out, GetRawTransactionDataE400 value) throws IOException {
                ...
                @Override
                public GetRawTransactionDataE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetRawTransactionDataE400 ret = new GetRawTransactionDataE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetRawTransactionDataE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetRawTransactionDataE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetRawTransactionDataE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetRawTransactionDataE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetRawTransactionDataE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetRawTransactionDataE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetRawTransactionDataE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetRawTransactionDataE400
  * @throws IOException if the JSON string is invalid with respect to GetRawTransactionDataE400
  */
  public static GetRawTransactionDataE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRawTransactionDataE400.class);
  }

 /**
  * Convert an instance of GetRawTransactionDataE400 to an JSON string
  *
  * @return JSON string
  */
