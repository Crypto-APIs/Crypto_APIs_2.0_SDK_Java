...
public class SyncHDWalletXPubYPubZPubE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncHDWalletXPubYPubZPubE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncHDWalletXPubYPubZPubE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncHDWalletXPubYPubZPubE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncHDWalletXPubYPubZPubE409>() {
                @Override
                public void write(JsonWriter out, SyncHDWalletXPubYPubZPubE409 value) throws IOException {
                ...
                @Override
                public SyncHDWalletXPubYPubZPubE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncHDWalletXPubYPubZPubE409 ret = new SyncHDWalletXPubYPubZPubE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncHDWalletXPubYPubZPubE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncHDWalletXPubYPubZPubE409() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncHDWalletXPubYPubZPubE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncHDWalletXPubYPubZPubE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncHDWalletXPubYPubZPubE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncHDWalletXPubYPubZPubE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncHDWalletXPubYPubZPubE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncHDWalletXPubYPubZPubE409
  * @throws IOException if the JSON string is invalid with respect to SyncHDWalletXPubYPubZPubE409
  */
  public static SyncHDWalletXPubYPubZPubE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncHDWalletXPubYPubZPubE409.class);
  }

 /**
  * Convert an instance of SyncHDWalletXPubYPubZPubE409 to an JSON string
  *
  * @return JSON string
  */
