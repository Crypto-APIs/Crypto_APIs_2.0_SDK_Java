...
public class GetExchangeRateByAssetsIDsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetsIDsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetsIDsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetsIDsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetsIDsE400>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetsIDsE400 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetsIDsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetsIDsE400 ret = new GetExchangeRateByAssetsIDsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetsIDsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetsIDsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetsIDsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetsIDsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetsIDsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetsIDsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetsIDsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetsIDsE400
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetsIDsE400
  */
  public static GetExchangeRateByAssetsIDsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetsIDsE400.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetsIDsE400 to an JSON string
  *
  * @return JSON string
  */
