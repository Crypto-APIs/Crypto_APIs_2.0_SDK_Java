...
public class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400>() {
                @Override
                public void write(JsonWriter out, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 value) throws IOException {
                ...
                @Override
                public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 ret = new CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400
  * @throws IOException if the JSON string is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400
  */
  public static CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.class);
  }

 /**
  * Convert an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 to an JSON string
  *
  * @return JSON string
  */
