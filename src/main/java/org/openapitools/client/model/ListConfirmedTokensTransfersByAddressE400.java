...
public class ListConfirmedTokensTransfersByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTokensTransfersByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTokensTransfersByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTokensTransfersByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTokensTransfersByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTokensTransfersByAddressE400 value) throws IOException {
                ...
                @Override
                public ListConfirmedTokensTransfersByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTokensTransfersByAddressE400 ret = new ListConfirmedTokensTransfersByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTokensTransfersByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTokensTransfersByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTokensTransfersByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTokensTransfersByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTokensTransfersByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTokensTransfersByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTokensTransfersByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTokensTransfersByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTokensTransfersByAddressE400
  */
  public static ListConfirmedTokensTransfersByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTokensTransfersByAddressE400.class);
  }

 /**
  * Convert an instance of ListConfirmedTokensTransfersByAddressE400 to an JSON string
  *
  * @return JSON string
  */
