...
public class ListConfirmedTokensTransfersByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTokensTransfersByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTokensTransfersByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTokensTransfersByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTokensTransfersByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTokensTransfersByAddressE401 value) throws IOException {
                ...
                @Override
                public ListConfirmedTokensTransfersByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTokensTransfersByAddressE401 ret = new ListConfirmedTokensTransfersByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTokensTransfersByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTokensTransfersByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTokensTransfersByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTokensTransfersByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTokensTransfersByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTokensTransfersByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTokensTransfersByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTokensTransfersByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTokensTransfersByAddressE401
  */
  public static ListConfirmedTokensTransfersByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTokensTransfersByAddressE401.class);
  }

 /**
  * Convert an instance of ListConfirmedTokensTransfersByAddressE401 to an JSON string
  *
  * @return JSON string
  */
