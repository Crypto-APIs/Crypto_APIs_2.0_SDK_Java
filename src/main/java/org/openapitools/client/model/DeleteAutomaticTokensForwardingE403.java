...
public class DeleteAutomaticTokensForwardingE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticTokensForwardingE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticTokensForwardingE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticTokensForwardingE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticTokensForwardingE403>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticTokensForwardingE403 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticTokensForwardingE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticTokensForwardingE403 ret = new DeleteAutomaticTokensForwardingE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticTokensForwardingE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticTokensForwardingE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticTokensForwardingE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticTokensForwardingE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticTokensForwardingE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticTokensForwardingE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticTokensForwardingE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticTokensForwardingE403
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticTokensForwardingE403
  */
  public static DeleteAutomaticTokensForwardingE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticTokensForwardingE403.class);
  }

 /**
  * Convert an instance of DeleteAutomaticTokensForwardingE403 to an JSON string
  *
  * @return JSON string
  */
