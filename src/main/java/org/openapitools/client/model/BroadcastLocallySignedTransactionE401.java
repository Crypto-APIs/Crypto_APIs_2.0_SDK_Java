...
public class BroadcastLocallySignedTransactionE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BroadcastLocallySignedTransactionE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BroadcastLocallySignedTransactionE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BroadcastLocallySignedTransactionE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BroadcastLocallySignedTransactionE401>() {
                @Override
                public void write(JsonWriter out, BroadcastLocallySignedTransactionE401 value) throws IOException {
                ...
                @Override
                public BroadcastLocallySignedTransactionE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BroadcastLocallySignedTransactionE401 ret = new BroadcastLocallySignedTransactionE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BroadcastLocallySignedTransactionE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BroadcastLocallySignedTransactionE401() {
        super("oneOf", Boolean.FALSE);
    }

    public BroadcastLocallySignedTransactionE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BroadcastLocallySignedTransactionE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BroadcastLocallySignedTransactionE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BroadcastLocallySignedTransactionE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BroadcastLocallySignedTransactionE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BroadcastLocallySignedTransactionE401
  * @throws IOException if the JSON string is invalid with respect to BroadcastLocallySignedTransactionE401
  */
  public static BroadcastLocallySignedTransactionE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BroadcastLocallySignedTransactionE401.class);
  }

 /**
  * Convert an instance of BroadcastLocallySignedTransactionE401 to an JSON string
  *
  * @return JSON string
  */
