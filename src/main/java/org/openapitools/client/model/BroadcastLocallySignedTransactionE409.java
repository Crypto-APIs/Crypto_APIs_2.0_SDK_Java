...
public class BroadcastLocallySignedTransactionE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BroadcastLocallySignedTransactionE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BroadcastLocallySignedTransactionE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BroadcastLocallySignedTransactionE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BroadcastLocallySignedTransactionE409>() {
                @Override
                public void write(JsonWriter out, BroadcastLocallySignedTransactionE409 value) throws IOException {
                ...
                @Override
                public BroadcastLocallySignedTransactionE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BroadcastLocallySignedTransactionE409 ret = new BroadcastLocallySignedTransactionE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BroadcastLocallySignedTransactionE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BroadcastLocallySignedTransactionE409() {
        super("oneOf", Boolean.FALSE);
    }

    public BroadcastLocallySignedTransactionE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BroadcastLocallySignedTransactionE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BroadcastLocallySignedTransactionE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BroadcastLocallySignedTransactionE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BroadcastLocallySignedTransactionE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BroadcastLocallySignedTransactionE409
  * @throws IOException if the JSON string is invalid with respect to BroadcastLocallySignedTransactionE409
  */
  public static BroadcastLocallySignedTransactionE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BroadcastLocallySignedTransactionE409.class);
  }

 /**
  * Convert an instance of BroadcastLocallySignedTransactionE409 to an JSON string
  *
  * @return JSON string
  */
