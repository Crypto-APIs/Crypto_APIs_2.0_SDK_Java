...
public class ListUnspentTransactionOutputsByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnspentTransactionOutputsByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnspentTransactionOutputsByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnspentTransactionOutputsByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnspentTransactionOutputsByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListUnspentTransactionOutputsByAddressE401 value) throws IOException {
                ...
                @Override
                public ListUnspentTransactionOutputsByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnspentTransactionOutputsByAddressE401 ret = new ListUnspentTransactionOutputsByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnspentTransactionOutputsByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnspentTransactionOutputsByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnspentTransactionOutputsByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnspentTransactionOutputsByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnspentTransactionOutputsByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnspentTransactionOutputsByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnspentTransactionOutputsByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnspentTransactionOutputsByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnspentTransactionOutputsByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListUnspentTransactionOutputsByAddressE401
  */
  public static ListUnspentTransactionOutputsByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnspentTransactionOutputsByAddressE401.class);
  }

 /**
  * Convert an instance of ListUnspentTransactionOutputsByAddressE401 to an JSON string
  *
  * @return JSON string
  */
