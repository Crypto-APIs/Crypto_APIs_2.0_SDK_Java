...
public class ListOmniTokensByAddressE400 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTokensByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTokensByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTokensByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListOmniTokensByAddressE400 value) throws IOException {
                ...
                @Override
                public ListOmniTokensByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTokensByAddressE400 ret = new ListOmniTokensByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTokensByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTokensByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTokensByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTokensByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTokensByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTokensByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTokensByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListOmniTokensByAddressE400
  */
  public static ListOmniTokensByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTokensByAddressE400.class);
  }

 /**
  * Convert an instance of ListOmniTokensByAddressE400 to an JSON string
  *
  * @return JSON string
  */
