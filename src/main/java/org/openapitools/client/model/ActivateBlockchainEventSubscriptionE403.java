...
public class ActivateBlockchainEventSubscriptionE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActivateBlockchainEventSubscriptionE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ActivateBlockchainEventSubscriptionE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ActivateBlockchainEventSubscriptionE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ActivateBlockchainEventSubscriptionE403>() {
                @Override
                public void write(JsonWriter out, ActivateBlockchainEventSubscriptionE403 value) throws IOException {
                ...
                @Override
                public ActivateBlockchainEventSubscriptionE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ActivateBlockchainEventSubscriptionE403 ret = new ActivateBlockchainEventSubscriptionE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ActivateBlockchainEventSubscriptionE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ActivateBlockchainEventSubscriptionE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ActivateBlockchainEventSubscriptionE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ActivateBlockchainEventSubscriptionE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActivateBlockchainEventSubscriptionE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ActivateBlockchainEventSubscriptionE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ActivateBlockchainEventSubscriptionE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActivateBlockchainEventSubscriptionE403
  * @throws IOException if the JSON string is invalid with respect to ActivateBlockchainEventSubscriptionE403
  */
  public static ActivateBlockchainEventSubscriptionE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivateBlockchainEventSubscriptionE403.class);
  }

 /**
  * Convert an instance of ActivateBlockchainEventSubscriptionE403 to an JSON string
  *
  * @return JSON string
  */
