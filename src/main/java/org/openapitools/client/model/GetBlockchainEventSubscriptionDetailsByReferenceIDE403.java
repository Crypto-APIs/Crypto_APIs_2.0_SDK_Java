...
public class GetBlockchainEventSubscriptionDetailsByReferenceIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockchainEventSubscriptionDetailsByReferenceIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockchainEventSubscriptionDetailsByReferenceIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockchainEventSubscriptionDetailsByReferenceIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockchainEventSubscriptionDetailsByReferenceIDE403>() {
                @Override
                public void write(JsonWriter out, GetBlockchainEventSubscriptionDetailsByReferenceIDE403 value) throws IOException {
                ...
                @Override
                public GetBlockchainEventSubscriptionDetailsByReferenceIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockchainEventSubscriptionDetailsByReferenceIDE403 ret = new GetBlockchainEventSubscriptionDetailsByReferenceIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockchainEventSubscriptionDetailsByReferenceIDE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockchainEventSubscriptionDetailsByReferenceIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockchainEventSubscriptionDetailsByReferenceIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockchainEventSubscriptionDetailsByReferenceIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE403
  * @throws IOException if the JSON string is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE403
  */
  public static GetBlockchainEventSubscriptionDetailsByReferenceIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockchainEventSubscriptionDetailsByReferenceIDE403.class);
  }

 /**
  * Convert an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE403 to an JSON string
  *
  * @return JSON string
  */
