...
public class ListHDWalletXPubYPubZPubUTXOsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHDWalletXPubYPubZPubUTXOsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubUTXOsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubUTXOsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubUTXOsE403>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubUTXOsE403 value) throws IOException {
                ...
                @Override
                public ListHDWalletXPubYPubZPubUTXOsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubUTXOsE403 ret = new ListHDWalletXPubYPubZPubUTXOsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubUTXOsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHDWalletXPubYPubZPubUTXOsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubUTXOsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubUTXOsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListHDWalletXPubYPubZPubUTXOsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListHDWalletXPubYPubZPubUTXOsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubUTXOsE403
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE403
  */
  public static ListHDWalletXPubYPubZPubUTXOsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubUTXOsE403.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubUTXOsE403 to an JSON string
  *
  * @return JSON string
  */
