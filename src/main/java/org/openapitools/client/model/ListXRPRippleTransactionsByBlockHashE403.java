...
public class ListXRPRippleTransactionsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByBlockHashE403 ret = new ListXRPRippleTransactionsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByBlockHashE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByBlockHashE403
  */
  public static ListXRPRippleTransactionsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByBlockHashE403.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
