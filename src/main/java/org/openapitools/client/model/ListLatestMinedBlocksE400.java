...
public class ListLatestMinedBlocksE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListLatestMinedBlocksE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListLatestMinedBlocksE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListLatestMinedBlocksE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListLatestMinedBlocksE400>() {
                @Override
                public void write(JsonWriter out, ListLatestMinedBlocksE400 value) throws IOException {
                ...
                @Override
                public ListLatestMinedBlocksE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListLatestMinedBlocksE400 ret = new ListLatestMinedBlocksE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListLatestMinedBlocksE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListLatestMinedBlocksE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListLatestMinedBlocksE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListLatestMinedBlocksE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListLatestMinedBlocksE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListLatestMinedBlocksE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListLatestMinedBlocksE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListLatestMinedBlocksE400
  * @throws IOException if the JSON string is invalid with respect to ListLatestMinedBlocksE400
  */
  public static ListLatestMinedBlocksE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLatestMinedBlocksE400.class);
  }

 /**
  * Convert an instance of ListLatestMinedBlocksE400 to an JSON string
  *
  * @return JSON string
  */
