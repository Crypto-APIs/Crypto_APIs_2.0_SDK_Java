...
public class GetTokenDetailsByContractAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTokenDetailsByContractAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTokenDetailsByContractAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTokenDetailsByContractAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTokenDetailsByContractAddressE400>() {
                @Override
                public void write(JsonWriter out, GetTokenDetailsByContractAddressE400 value) throws IOException {
                ...
                @Override
                public GetTokenDetailsByContractAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTokenDetailsByContractAddressE400 ret = new GetTokenDetailsByContractAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTokenDetailsByContractAddressE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTokenDetailsByContractAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTokenDetailsByContractAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTokenDetailsByContractAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTokenDetailsByContractAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTokenDetailsByContractAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTokenDetailsByContractAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTokenDetailsByContractAddressE400
  * @throws IOException if the JSON string is invalid with respect to GetTokenDetailsByContractAddressE400
  */
  public static GetTokenDetailsByContractAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTokenDetailsByContractAddressE400.class);
  }

 /**
  * Convert an instance of GetTokenDetailsByContractAddressE400 to an JSON string
  *
  * @return JSON string
  */
