...
public class MinedTransactionE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MinedTransactionE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MinedTransactionE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MinedTransactionE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MinedTransactionE401>() {
                @Override
                public void write(JsonWriter out, MinedTransactionE401 value) throws IOException {
                ...
                @Override
                public MinedTransactionE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        MinedTransactionE401 ret = new MinedTransactionE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for MinedTransactionE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MinedTransactionE401() {
        super("oneOf", Boolean.FALSE);
    }

    public MinedTransactionE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return MinedTransactionE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MinedTransactionE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for MinedTransactionE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of MinedTransactionE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MinedTransactionE401
  * @throws IOException if the JSON string is invalid with respect to MinedTransactionE401
  */
  public static MinedTransactionE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MinedTransactionE401.class);
  }

 /**
  * Convert an instance of MinedTransactionE401 to an JSON string
  *
  * @return JSON string
  */
