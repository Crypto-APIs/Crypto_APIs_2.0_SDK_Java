...
public class GetXRPRippleBlockDetailsByBlockHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleBlockDetailsByBlockHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleBlockDetailsByBlockHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleBlockDetailsByBlockHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleBlockDetailsByBlockHashE400>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleBlockDetailsByBlockHashE400 value) throws IOException {
                ...
                @Override
                public GetXRPRippleBlockDetailsByBlockHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleBlockDetailsByBlockHashE400 ret = new GetXRPRippleBlockDetailsByBlockHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleBlockDetailsByBlockHashE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleBlockDetailsByBlockHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleBlockDetailsByBlockHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleBlockDetailsByBlockHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleBlockDetailsByBlockHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleBlockDetailsByBlockHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleBlockDetailsByBlockHashE400
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE400
  */
  public static GetXRPRippleBlockDetailsByBlockHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleBlockDetailsByBlockHashE400.class);
  }

 /**
  * Convert an instance of GetXRPRippleBlockDetailsByBlockHashE400 to an JSON string
  *
  * @return JSON string
  */
