...
public class ListUnconfirmedOmniTransactionsByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedOmniTransactionsByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedOmniTransactionsByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedOmniTransactionsByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedOmniTransactionsByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedOmniTransactionsByAddressE401 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedOmniTransactionsByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedOmniTransactionsByAddressE401 ret = new ListUnconfirmedOmniTransactionsByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedOmniTransactionsByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedOmniTransactionsByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedOmniTransactionsByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedOmniTransactionsByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedOmniTransactionsByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedOmniTransactionsByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedOmniTransactionsByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedOmniTransactionsByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedOmniTransactionsByAddressE401
  */
  public static ListUnconfirmedOmniTransactionsByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedOmniTransactionsByAddressE401.class);
  }

 /**
  * Convert an instance of ListUnconfirmedOmniTransactionsByAddressE401 to an JSON string
  *
  * @return JSON string
  */
