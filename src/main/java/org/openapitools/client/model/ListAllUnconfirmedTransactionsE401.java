...
public class ListAllUnconfirmedTransactionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllUnconfirmedTransactionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllUnconfirmedTransactionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllUnconfirmedTransactionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllUnconfirmedTransactionsE401>() {
                @Override
                public void write(JsonWriter out, ListAllUnconfirmedTransactionsE401 value) throws IOException {
                ...
                @Override
                public ListAllUnconfirmedTransactionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllUnconfirmedTransactionsE401 ret = new ListAllUnconfirmedTransactionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllUnconfirmedTransactionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllUnconfirmedTransactionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllUnconfirmedTransactionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllUnconfirmedTransactionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllUnconfirmedTransactionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllUnconfirmedTransactionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllUnconfirmedTransactionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllUnconfirmedTransactionsE401
  * @throws IOException if the JSON string is invalid with respect to ListAllUnconfirmedTransactionsE401
  */
  public static ListAllUnconfirmedTransactionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllUnconfirmedTransactionsE401.class);
  }

 /**
  * Convert an instance of ListAllUnconfirmedTransactionsE401 to an JSON string
  *
  * @return JSON string
  */
