...
public class GetBlockDetailsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHashE403 ret = new GetBlockDetailsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHashE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHashE403
  */
  public static GetBlockDetailsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHashE403.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
