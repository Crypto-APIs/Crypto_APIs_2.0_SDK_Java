...
public class NewConfirmedCoinsTransactionsForSpecificAmountE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsForSpecificAmountE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsForSpecificAmountE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsForSpecificAmountE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsForSpecificAmountE409>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsForSpecificAmountE409 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsForSpecificAmountE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsForSpecificAmountE409 ret = new NewConfirmedCoinsTransactionsForSpecificAmountE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsForSpecificAmountE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsForSpecificAmountE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsForSpecificAmountE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsForSpecificAmountE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsForSpecificAmountE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsForSpecificAmountE409
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE409
  */
  public static NewConfirmedCoinsTransactionsForSpecificAmountE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsForSpecificAmountE409.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsForSpecificAmountE409 to an JSON string
  *
  * @return JSON string
  */
