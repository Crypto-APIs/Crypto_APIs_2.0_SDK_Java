...
public class EstimateTokenGasLimitE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateTokenGasLimitE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateTokenGasLimitE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateTokenGasLimitE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateTokenGasLimitE401>() {
                @Override
                public void write(JsonWriter out, EstimateTokenGasLimitE401 value) throws IOException {
                ...
                @Override
                public EstimateTokenGasLimitE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateTokenGasLimitE401 ret = new EstimateTokenGasLimitE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateTokenGasLimitE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateTokenGasLimitE401() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateTokenGasLimitE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTokenGasLimitE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateTokenGasLimitE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateTokenGasLimitE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateTokenGasLimitE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateTokenGasLimitE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateTokenGasLimitE401
  * @throws IOException if the JSON string is invalid with respect to EstimateTokenGasLimitE401
  */
  public static EstimateTokenGasLimitE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateTokenGasLimitE401.class);
  }

 /**
  * Convert an instance of EstimateTokenGasLimitE401 to an JSON string
  *
  * @return JSON string
  */
