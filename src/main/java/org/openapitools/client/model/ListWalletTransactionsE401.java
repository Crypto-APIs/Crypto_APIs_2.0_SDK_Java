...
public class ListWalletTransactionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListWalletTransactionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListWalletTransactionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListWalletTransactionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListWalletTransactionsE401>() {
                @Override
                public void write(JsonWriter out, ListWalletTransactionsE401 value) throws IOException {
                ...
                @Override
                public ListWalletTransactionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListWalletTransactionsE401 ret = new ListWalletTransactionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListWalletTransactionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListWalletTransactionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListWalletTransactionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListWalletTransactionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListWalletTransactionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListWalletTransactionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListWalletTransactionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListWalletTransactionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListWalletTransactionsE401
  * @throws IOException if the JSON string is invalid with respect to ListWalletTransactionsE401
  */
  public static ListWalletTransactionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWalletTransactionsE401.class);
  }

 /**
  * Convert an instance of ListWalletTransactionsE401 to an JSON string
  *
  * @return JSON string
  */
