...
public class GetAssetDetailsByAssetIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAssetDetailsByAssetIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAssetDetailsByAssetIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAssetDetailsByAssetIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAssetDetailsByAssetIDE400>() {
                @Override
                public void write(JsonWriter out, GetAssetDetailsByAssetIDE400 value) throws IOException {
                ...
                @Override
                public GetAssetDetailsByAssetIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAssetDetailsByAssetIDE400 ret = new GetAssetDetailsByAssetIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAssetDetailsByAssetIDE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAssetDetailsByAssetIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAssetDetailsByAssetIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAssetDetailsByAssetIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAssetDetailsByAssetIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAssetDetailsByAssetIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAssetDetailsByAssetIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAssetDetailsByAssetIDE400
  * @throws IOException if the JSON string is invalid with respect to GetAssetDetailsByAssetIDE400
  */
  public static GetAssetDetailsByAssetIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetDetailsByAssetIDE400.class);
  }

 /**
  * Convert an instance of GetAssetDetailsByAssetIDE400 to an JSON string
  *
  * @return JSON string
  */
