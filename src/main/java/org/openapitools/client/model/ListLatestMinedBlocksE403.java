...
public class ListLatestMinedBlocksE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListLatestMinedBlocksE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListLatestMinedBlocksE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListLatestMinedBlocksE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListLatestMinedBlocksE403>() {
                @Override
                public void write(JsonWriter out, ListLatestMinedBlocksE403 value) throws IOException {
                ...
                @Override
                public ListLatestMinedBlocksE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListLatestMinedBlocksE403 ret = new ListLatestMinedBlocksE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListLatestMinedBlocksE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListLatestMinedBlocksE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListLatestMinedBlocksE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListLatestMinedBlocksE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListLatestMinedBlocksE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListLatestMinedBlocksE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListLatestMinedBlocksE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListLatestMinedBlocksE403
  * @throws IOException if the JSON string is invalid with respect to ListLatestMinedBlocksE403
  */
  public static ListLatestMinedBlocksE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLatestMinedBlocksE403.class);
  }

 /**
  * Convert an instance of ListLatestMinedBlocksE403 to an JSON string
  *
  * @return JSON string
  */
