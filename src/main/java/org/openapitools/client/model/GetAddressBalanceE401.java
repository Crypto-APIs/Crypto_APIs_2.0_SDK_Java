...
public class GetAddressBalanceE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressBalanceE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressBalanceE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressBalanceE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressBalanceE401>() {
                @Override
                public void write(JsonWriter out, GetAddressBalanceE401 value) throws IOException {
                ...
                @Override
                public GetAddressBalanceE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressBalanceE401 ret = new GetAddressBalanceE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressBalanceE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressBalanceE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressBalanceE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressBalanceE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressBalanceE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressBalanceE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressBalanceE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressBalanceE401
  * @throws IOException if the JSON string is invalid with respect to GetAddressBalanceE401
  */
  public static GetAddressBalanceE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressBalanceE401.class);
  }

 /**
  * Convert an instance of GetAddressBalanceE401 to an JSON string
  *
  * @return JSON string
  */
