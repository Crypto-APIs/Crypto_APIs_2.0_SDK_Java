...
public class ListConfirmedTransactionsByAddressAndTimeRangeE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTransactionsByAddressAndTimeRangeE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTransactionsByAddressAndTimeRangeE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTransactionsByAddressAndTimeRangeE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTransactionsByAddressAndTimeRangeE400>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTransactionsByAddressAndTimeRangeE400 value) throws IOException {
                ...
                @Override
                public ListConfirmedTransactionsByAddressAndTimeRangeE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTransactionsByAddressAndTimeRangeE400 ret = new ListConfirmedTransactionsByAddressAndTimeRangeE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTransactionsByAddressAndTimeRangeE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTransactionsByAddressAndTimeRangeE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTransactionsByAddressAndTimeRangeE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressAndTimeRangeE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressAndTimeRangeE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTransactionsByAddressAndTimeRangeE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTransactionsByAddressAndTimeRangeE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTransactionsByAddressAndTimeRangeE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTransactionsByAddressAndTimeRangeE400
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTransactionsByAddressAndTimeRangeE400
  */
  public static ListConfirmedTransactionsByAddressAndTimeRangeE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTransactionsByAddressAndTimeRangeE400.class);
  }

 /**
  * Convert an instance of ListConfirmedTransactionsByAddressAndTimeRangeE400 to an JSON string
  *
  * @return JSON string
  */
