...
public class GetWalletAssetDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetWalletAssetDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetWalletAssetDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetWalletAssetDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetWalletAssetDetailsE403>() {
                @Override
                public void write(JsonWriter out, GetWalletAssetDetailsE403 value) throws IOException {
                ...
                @Override
                public GetWalletAssetDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetWalletAssetDetailsE403 ret = new GetWalletAssetDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetWalletAssetDetailsE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetWalletAssetDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetWalletAssetDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetWalletAssetDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWalletAssetDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetWalletAssetDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetWalletAssetDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetWalletAssetDetailsE403
  * @throws IOException if the JSON string is invalid with respect to GetWalletAssetDetailsE403
  */
  public static GetWalletAssetDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWalletAssetDetailsE403.class);
  }

 /**
  * Convert an instance of GetWalletAssetDetailsE403 to an JSON string
  *
  * @return JSON string
  */
