...
public class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403>() {
                @Override
                public void write(JsonWriter out, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 value) throws IOException {
                ...
                @Override
                public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 ret = new CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403
  * @throws IOException if the JSON string is invalid with respect to CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403
  */
  public static CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403.class);
  }

 /**
  * Convert an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 to an JSON string
  *
  * @return JSON string
  */
