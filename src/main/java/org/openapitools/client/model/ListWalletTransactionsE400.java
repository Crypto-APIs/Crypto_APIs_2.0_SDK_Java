...
public class ListWalletTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListWalletTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListWalletTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListWalletTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListWalletTransactionsE400>() {
                @Override
                public void write(JsonWriter out, ListWalletTransactionsE400 value) throws IOException {
                ...
                @Override
                public ListWalletTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListWalletTransactionsE400 ret = new ListWalletTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListWalletTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListWalletTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListWalletTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListWalletTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListWalletTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListWalletTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListWalletTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListWalletTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListWalletTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListWalletTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to ListWalletTransactionsE400
  */
  public static ListWalletTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWalletTransactionsE400.class);
  }

 /**
  * Convert an instance of ListWalletTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
