...
public class NewConfirmedTokenTransactionsForSpecificAmountE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokenTransactionsForSpecificAmountE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokenTransactionsForSpecificAmountE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokenTransactionsForSpecificAmountE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokenTransactionsForSpecificAmountE409>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokenTransactionsForSpecificAmountE409 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokenTransactionsForSpecificAmountE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokenTransactionsForSpecificAmountE409 ret = new NewConfirmedTokenTransactionsForSpecificAmountE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokenTransactionsForSpecificAmountE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokenTransactionsForSpecificAmountE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokenTransactionsForSpecificAmountE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokenTransactionsForSpecificAmountE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokenTransactionsForSpecificAmountE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokenTransactionsForSpecificAmountE409
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE409
  */
  public static NewConfirmedTokenTransactionsForSpecificAmountE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokenTransactionsForSpecificAmountE409.class);
  }

 /**
  * Convert an instance of NewConfirmedTokenTransactionsForSpecificAmountE409 to an JSON string
  *
  * @return JSON string
  */
