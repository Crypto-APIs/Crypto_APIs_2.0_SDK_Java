...
public class CreateAutomaticTokensForwardingE403 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAutomaticTokensForwardingE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAutomaticTokensForwardingE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateAutomaticTokensForwardingE403>() {
                @Override
                public void write(JsonWriter out, CreateAutomaticTokensForwardingE403 value) throws IOException {
                ...
                @Override
                public CreateAutomaticTokensForwardingE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateAutomaticTokensForwardingE403 ret = new CreateAutomaticTokensForwardingE403();
    ...
    public CreateAutomaticTokensForwardingE403() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAutomaticTokensForwardingE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE403(TokensForwardingAutomationsLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateAutomaticTokensForwardingE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAutomaticTokensForwardingE403
  */
 ...
 /**
  * Create an instance of CreateAutomaticTokensForwardingE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAutomaticTokensForwardingE403
  * @throws IOException if the JSON string is invalid with respect to CreateAutomaticTokensForwardingE403
  */
  public static CreateAutomaticTokensForwardingE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAutomaticTokensForwardingE403.class);
  }

 /**
  * Convert an instance of CreateAutomaticTokensForwardingE403 to an JSON string
  *
  * @return JSON string
  */
