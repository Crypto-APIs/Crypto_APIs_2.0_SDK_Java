...
public class NewConfirmedTokenTransactionsForSpecificAmountE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokenTransactionsForSpecificAmountE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokenTransactionsForSpecificAmountE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokenTransactionsForSpecificAmountE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokenTransactionsForSpecificAmountE403>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokenTransactionsForSpecificAmountE403 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokenTransactionsForSpecificAmountE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokenTransactionsForSpecificAmountE403 ret = new NewConfirmedTokenTransactionsForSpecificAmountE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokenTransactionsForSpecificAmountE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokenTransactionsForSpecificAmountE403() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokenTransactionsForSpecificAmountE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokenTransactionsForSpecificAmountE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokenTransactionsForSpecificAmountE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokenTransactionsForSpecificAmountE403
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE403
  */
  public static NewConfirmedTokenTransactionsForSpecificAmountE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokenTransactionsForSpecificAmountE403.class);
  }

 /**
  * Convert an instance of NewConfirmedTokenTransactionsForSpecificAmountE403 to an JSON string
  *
  * @return JSON string
  */
