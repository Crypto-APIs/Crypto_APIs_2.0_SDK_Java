...
public class ListInternalTransactionsByAddressAndTimeRangeE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionsByAddressAndTimeRangeE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionsByAddressAndTimeRangeE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionsByAddressAndTimeRangeE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionsByAddressAndTimeRangeE401>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionsByAddressAndTimeRangeE401 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionsByAddressAndTimeRangeE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionsByAddressAndTimeRangeE401 ret = new ListInternalTransactionsByAddressAndTimeRangeE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionsByAddressAndTimeRangeE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionsByAddressAndTimeRangeE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionsByAddressAndTimeRangeE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionsByAddressAndTimeRangeE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionsByAddressAndTimeRangeE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionsByAddressAndTimeRangeE401
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE401
  */
  public static ListInternalTransactionsByAddressAndTimeRangeE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionsByAddressAndTimeRangeE401.class);
  }

 /**
  * Convert an instance of ListInternalTransactionsByAddressAndTimeRangeE401 to an JSON string
  *
  * @return JSON string
  */
