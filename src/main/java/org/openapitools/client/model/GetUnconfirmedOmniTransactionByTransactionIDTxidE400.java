...
public class GetUnconfirmedOmniTransactionByTransactionIDTxidE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetUnconfirmedOmniTransactionByTransactionIDTxidE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUnconfirmedOmniTransactionByTransactionIDTxidE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUnconfirmedOmniTransactionByTransactionIDTxidE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetUnconfirmedOmniTransactionByTransactionIDTxidE400>() {
                @Override
                public void write(JsonWriter out, GetUnconfirmedOmniTransactionByTransactionIDTxidE400 value) throws IOException {
                ...
                @Override
                public GetUnconfirmedOmniTransactionByTransactionIDTxidE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetUnconfirmedOmniTransactionByTransactionIDTxidE400 ret = new GetUnconfirmedOmniTransactionByTransactionIDTxidE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetUnconfirmedOmniTransactionByTransactionIDTxidE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetUnconfirmedOmniTransactionByTransactionIDTxidE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetUnconfirmedOmniTransactionByTransactionIDTxidE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetUnconfirmedOmniTransactionByTransactionIDTxidE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE400
  * @throws IOException if the JSON string is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE400
  */
  public static GetUnconfirmedOmniTransactionByTransactionIDTxidE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUnconfirmedOmniTransactionByTransactionIDTxidE400.class);
  }

 /**
  * Convert an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE400 to an JSON string
  *
  * @return JSON string
  */
