...
public class ListDepositAddressesE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListDepositAddressesE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListDepositAddressesE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListDepositAddressesE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListDepositAddressesE401>() {
                @Override
                public void write(JsonWriter out, ListDepositAddressesE401 value) throws IOException {
                ...
                @Override
                public ListDepositAddressesE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListDepositAddressesE401 ret = new ListDepositAddressesE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListDepositAddressesE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListDepositAddressesE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListDepositAddressesE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListDepositAddressesE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListDepositAddressesE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListDepositAddressesE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListDepositAddressesE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListDepositAddressesE401
  * @throws IOException if the JSON string is invalid with respect to ListDepositAddressesE401
  */
  public static ListDepositAddressesE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDepositAddressesE401.class);
  }

 /**
  * Convert an instance of ListDepositAddressesE401 to an JSON string
  *
  * @return JSON string
  */
