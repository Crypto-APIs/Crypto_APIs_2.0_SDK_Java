...
public class NewConfirmedTokensTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokensTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokensTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokensTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokensTransactionsE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokensTransactionsE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokensTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokensTransactionsE400 ret = new NewConfirmedTokensTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokensTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokensTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokensTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokensTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokensTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokensTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokensTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokensTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokensTransactionsE400
  */
  public static NewConfirmedTokensTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokensTransactionsE400.class);
  }

 /**
  * Convert an instance of NewConfirmedTokensTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
