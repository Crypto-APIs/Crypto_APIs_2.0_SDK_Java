...
public class ListAllUnconfirmedTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllUnconfirmedTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllUnconfirmedTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllUnconfirmedTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllUnconfirmedTransactionsE400>() {
                @Override
                public void write(JsonWriter out, ListAllUnconfirmedTransactionsE400 value) throws IOException {
                ...
                @Override
                public ListAllUnconfirmedTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllUnconfirmedTransactionsE400 ret = new ListAllUnconfirmedTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllUnconfirmedTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllUnconfirmedTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllUnconfirmedTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllUnconfirmedTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllUnconfirmedTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllUnconfirmedTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllUnconfirmedTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllUnconfirmedTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to ListAllUnconfirmedTransactionsE400
  */
  public static ListAllUnconfirmedTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllUnconfirmedTransactionsE400.class);
  }

 /**
  * Convert an instance of ListAllUnconfirmedTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
