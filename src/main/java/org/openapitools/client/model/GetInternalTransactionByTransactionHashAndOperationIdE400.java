...
public class GetInternalTransactionByTransactionHashAndOperationIdE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetInternalTransactionByTransactionHashAndOperationIdE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetInternalTransactionByTransactionHashAndOperationIdE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetInternalTransactionByTransactionHashAndOperationIdE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetInternalTransactionByTransactionHashAndOperationIdE400>() {
                @Override
                public void write(JsonWriter out, GetInternalTransactionByTransactionHashAndOperationIdE400 value) throws IOException {
                ...
                @Override
                public GetInternalTransactionByTransactionHashAndOperationIdE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetInternalTransactionByTransactionHashAndOperationIdE400 ret = new GetInternalTransactionByTransactionHashAndOperationIdE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetInternalTransactionByTransactionHashAndOperationIdE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetInternalTransactionByTransactionHashAndOperationIdE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetInternalTransactionByTransactionHashAndOperationIdE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetInternalTransactionByTransactionHashAndOperationIdE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetInternalTransactionByTransactionHashAndOperationIdE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetInternalTransactionByTransactionHashAndOperationIdE400
  * @throws IOException if the JSON string is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE400
  */
  public static GetInternalTransactionByTransactionHashAndOperationIdE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInternalTransactionByTransactionHashAndOperationIdE400.class);
  }

 /**
  * Convert an instance of GetInternalTransactionByTransactionHashAndOperationIdE400 to an JSON string
  *
  * @return JSON string
  */
