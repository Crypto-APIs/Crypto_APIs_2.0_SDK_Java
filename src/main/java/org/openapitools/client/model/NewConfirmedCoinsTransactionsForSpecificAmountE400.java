...
public class NewConfirmedCoinsTransactionsForSpecificAmountE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsForSpecificAmountE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsForSpecificAmountE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsForSpecificAmountE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsForSpecificAmountE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsForSpecificAmountE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsForSpecificAmountE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsForSpecificAmountE400 ret = new NewConfirmedCoinsTransactionsForSpecificAmountE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsForSpecificAmountE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsForSpecificAmountE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsForSpecificAmountE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsForSpecificAmountE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsForSpecificAmountE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsForSpecificAmountE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE400
  */
  public static NewConfirmedCoinsTransactionsForSpecificAmountE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsForSpecificAmountE400.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsForSpecificAmountE400 to an JSON string
  *
  * @return JSON string
  */
