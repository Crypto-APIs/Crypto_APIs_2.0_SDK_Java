...
public class BlockHeightReachedE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BlockHeightReachedE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BlockHeightReachedE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BlockHeightReachedE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BlockHeightReachedE401>() {
                @Override
                public void write(JsonWriter out, BlockHeightReachedE401 value) throws IOException {
                ...
                @Override
                public BlockHeightReachedE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BlockHeightReachedE401 ret = new BlockHeightReachedE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BlockHeightReachedE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BlockHeightReachedE401() {
        super("oneOf", Boolean.FALSE);
    }

    public BlockHeightReachedE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BlockHeightReachedE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BlockHeightReachedE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BlockHeightReachedE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BlockHeightReachedE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BlockHeightReachedE401
  * @throws IOException if the JSON string is invalid with respect to BlockHeightReachedE401
  */
  public static BlockHeightReachedE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockHeightReachedE401.class);
  }

 /**
  * Convert an instance of BlockHeightReachedE401 to an JSON string
  *
  * @return JSON string
  */
