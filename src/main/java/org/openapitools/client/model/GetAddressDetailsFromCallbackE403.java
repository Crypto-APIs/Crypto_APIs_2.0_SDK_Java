...
public class GetAddressDetailsFromCallbackE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressDetailsFromCallbackE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressDetailsFromCallbackE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressDetailsFromCallbackE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressDetailsFromCallbackE403>() {
                @Override
                public void write(JsonWriter out, GetAddressDetailsFromCallbackE403 value) throws IOException {
                ...
                @Override
                public GetAddressDetailsFromCallbackE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressDetailsFromCallbackE403 ret = new GetAddressDetailsFromCallbackE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressDetailsFromCallbackE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressDetailsFromCallbackE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressDetailsFromCallbackE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressDetailsFromCallbackE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressDetailsFromCallbackE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressDetailsFromCallbackE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressDetailsFromCallbackE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressDetailsFromCallbackE403
  * @throws IOException if the JSON string is invalid with respect to GetAddressDetailsFromCallbackE403
  */
  public static GetAddressDetailsFromCallbackE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressDetailsFromCallbackE403.class);
  }

 /**
  * Convert an instance of GetAddressDetailsFromCallbackE403 to an JSON string
  *
  * @return JSON string
  */
