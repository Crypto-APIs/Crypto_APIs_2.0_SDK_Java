...
public class NewConfirmedInternalTransactionsAndEachConfirmationE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsAndEachConfirmationE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsAndEachConfirmationE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsAndEachConfirmationE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsAndEachConfirmationE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsAndEachConfirmationE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsAndEachConfirmationE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsAndEachConfirmationE400 ret = new NewConfirmedInternalTransactionsAndEachConfirmationE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsAndEachConfirmationE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsAndEachConfirmationE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsAndEachConfirmationE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsAndEachConfirmationE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsAndEachConfirmationE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE400
  */
  public static NewConfirmedInternalTransactionsAndEachConfirmationE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsAndEachConfirmationE400.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsAndEachConfirmationE400 to an JSON string
  *
  * @return JSON string
  */
