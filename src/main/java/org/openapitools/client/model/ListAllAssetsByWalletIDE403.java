...
public class ListAllAssetsByWalletIDE403 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsByWalletIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsByWalletIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsByWalletIDE403>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsByWalletIDE403 value) throws IOException {
                ...
                @Override
                public ListAllAssetsByWalletIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsByWalletIDE403 ret = new ListAllAssetsByWalletIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsByWalletIDE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsByWalletIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsByWalletIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsByWalletIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsByWalletIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsByWalletIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsByWalletIDE403
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsByWalletIDE403
  */
  public static ListAllAssetsByWalletIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsByWalletIDE403.class);
  }

 /**
  * Convert an instance of ListAllAssetsByWalletIDE403 to an JSON string
  *
  * @return JSON string
  */
