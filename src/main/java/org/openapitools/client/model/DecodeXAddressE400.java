...
public class DecodeXAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DecodeXAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DecodeXAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DecodeXAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DecodeXAddressE400>() {
                @Override
                public void write(JsonWriter out, DecodeXAddressE400 value) throws IOException {
                ...
                @Override
                public DecodeXAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DecodeXAddressE400 ret = new DecodeXAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DecodeXAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DecodeXAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DecodeXAddressE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeXAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DecodeXAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecodeXAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DecodeXAddressE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DecodeXAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecodeXAddressE400
  * @throws IOException if the JSON string is invalid with respect to DecodeXAddressE400
  */
  public static DecodeXAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecodeXAddressE400.class);
  }

 /**
  * Convert an instance of DecodeXAddressE400 to an JSON string
  *
  * @return JSON string
  */
