...
public class ListOmniTransactionsByBlockHeightRData {
  ...
  **/
  ...
  public ListOmniTransactionsByBlockHeightRData total(Integer total) {
  ...
  **/
  ...
  public ListOmniTransactionsByBlockHeightRData items(List<ListOmniTransactionsByBlockHeightRI> items) {
    
    this.items = items;
    return this;
  }

  public ListOmniTransactionsByBlockHeightRData addItemsItem(ListOmniTransactionsByBlockHeightRI itemsItem) {
  ...
  **/
  ...
  public List<ListOmniTransactionsByBlockHeightRI> getItems() {
    return items;
  }


  public void setItems(List<ListOmniTransactionsByBlockHeightRI> items) {
    this.items = items;
  }
