...
public class ListLatestMinedBlocksE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListLatestMinedBlocksE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListLatestMinedBlocksE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListLatestMinedBlocksE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListLatestMinedBlocksE401>() {
                @Override
                public void write(JsonWriter out, ListLatestMinedBlocksE401 value) throws IOException {
                ...
                @Override
                public ListLatestMinedBlocksE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListLatestMinedBlocksE401 ret = new ListLatestMinedBlocksE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListLatestMinedBlocksE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListLatestMinedBlocksE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListLatestMinedBlocksE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListLatestMinedBlocksE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListLatestMinedBlocksE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListLatestMinedBlocksE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListLatestMinedBlocksE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListLatestMinedBlocksE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListLatestMinedBlocksE401
  * @throws IOException if the JSON string is invalid with respect to ListLatestMinedBlocksE401
  */
  public static ListLatestMinedBlocksE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLatestMinedBlocksE401.class);
  }

 /**
  * Convert an instance of ListLatestMinedBlocksE401 to an JSON string
  *
  * @return JSON string
  */
