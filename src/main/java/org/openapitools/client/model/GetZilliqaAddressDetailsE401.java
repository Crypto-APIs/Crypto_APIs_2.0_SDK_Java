...
public class GetZilliqaAddressDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaAddressDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaAddressDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaAddressDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaAddressDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetZilliqaAddressDetailsE401 value) throws IOException {
                ...
                @Override
                public GetZilliqaAddressDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaAddressDetailsE401 ret = new GetZilliqaAddressDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaAddressDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaAddressDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaAddressDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaAddressDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaAddressDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaAddressDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaAddressDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaAddressDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaAddressDetailsE401
  */
  public static GetZilliqaAddressDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaAddressDetailsE401.class);
  }

 /**
  * Convert an instance of GetZilliqaAddressDetailsE401 to an JSON string
  *
  * @return JSON string
  */
