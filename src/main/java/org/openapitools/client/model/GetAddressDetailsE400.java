...
public class GetAddressDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetAddressDetailsE400 value) throws IOException {
                ...
                @Override
                public GetAddressDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressDetailsE400 ret = new GetAddressDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetAddressDetailsE400
  */
  public static GetAddressDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressDetailsE400.class);
  }

 /**
  * Convert an instance of GetAddressDetailsE400 to an JSON string
  *
  * @return JSON string
  */
