...
public class ListOmniTransactionsByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTransactionsByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTransactionsByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTransactionsByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTransactionsByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListOmniTransactionsByAddressE401 value) throws IOException {
                ...
                @Override
                public ListOmniTransactionsByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTransactionsByAddressE401 ret = new ListOmniTransactionsByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTransactionsByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTransactionsByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTransactionsByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTransactionsByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTransactionsByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTransactionsByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTransactionsByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTransactionsByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListOmniTransactionsByAddressE401
  */
  public static ListOmniTransactionsByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTransactionsByAddressE401.class);
  }

 /**
  * Convert an instance of ListOmniTransactionsByAddressE401 to an JSON string
  *
  * @return JSON string
  */
