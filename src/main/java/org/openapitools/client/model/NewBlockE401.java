...
public class NewBlockE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewBlockE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewBlockE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewBlockE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewBlockE401>() {
                @Override
                public void write(JsonWriter out, NewBlockE401 value) throws IOException {
                ...
                @Override
                public NewBlockE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewBlockE401 ret = new NewBlockE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewBlockE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewBlockE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewBlockE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewBlockE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewBlockE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewBlockE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewBlockE401
  * @throws IOException if the JSON string is invalid with respect to NewBlockE401
  */
  public static NewBlockE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewBlockE401.class);
  }

 /**
  * Convert an instance of NewBlockE401 to an JSON string
  *
  * @return JSON string
  */
