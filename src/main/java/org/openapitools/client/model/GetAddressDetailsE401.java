...
public class GetAddressDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetAddressDetailsE401 value) throws IOException {
                ...
                @Override
                public GetAddressDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressDetailsE401 ret = new GetAddressDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetAddressDetailsE401
  */
  public static GetAddressDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressDetailsE401.class);
  }

 /**
  * Convert an instance of GetAddressDetailsE401 to an JSON string
  *
  * @return JSON string
  */
