...
public class CreateAutomaticCoinsForwardingE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateAutomaticCoinsForwardingE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAutomaticCoinsForwardingE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAutomaticCoinsForwardingE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateAutomaticCoinsForwardingE401>() {
                @Override
                public void write(JsonWriter out, CreateAutomaticCoinsForwardingE401 value) throws IOException {
                ...
                @Override
                public CreateAutomaticCoinsForwardingE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateAutomaticCoinsForwardingE401 ret = new CreateAutomaticCoinsForwardingE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateAutomaticCoinsForwardingE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateAutomaticCoinsForwardingE401() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAutomaticCoinsForwardingE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticCoinsForwardingE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateAutomaticCoinsForwardingE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAutomaticCoinsForwardingE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateAutomaticCoinsForwardingE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateAutomaticCoinsForwardingE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAutomaticCoinsForwardingE401
  * @throws IOException if the JSON string is invalid with respect to CreateAutomaticCoinsForwardingE401
  */
  public static CreateAutomaticCoinsForwardingE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAutomaticCoinsForwardingE401.class);
  }

 /**
  * Convert an instance of CreateAutomaticCoinsForwardingE401 to an JSON string
  *
  * @return JSON string
  */
