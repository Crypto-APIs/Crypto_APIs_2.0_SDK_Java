...
public class GetXRPRippleAddressDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleAddressDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleAddressDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleAddressDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleAddressDetailsE403>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleAddressDetailsE403 value) throws IOException {
                ...
                @Override
                public GetXRPRippleAddressDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleAddressDetailsE403 ret = new GetXRPRippleAddressDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleAddressDetailsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleAddressDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleAddressDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleAddressDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleAddressDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleAddressDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleAddressDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleAddressDetailsE403
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleAddressDetailsE403
  */
  public static GetXRPRippleAddressDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleAddressDetailsE403.class);
  }

 /**
  * Convert an instance of GetXRPRippleAddressDetailsE403 to an JSON string
  *
  * @return JSON string
  */
