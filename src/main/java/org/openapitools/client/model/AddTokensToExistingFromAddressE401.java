...
public class AddTokensToExistingFromAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AddTokensToExistingFromAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AddTokensToExistingFromAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AddTokensToExistingFromAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddTokensToExistingFromAddressE401>() {
                @Override
                public void write(JsonWriter out, AddTokensToExistingFromAddressE401 value) throws IOException {
                ...
                @Override
                public AddTokensToExistingFromAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        AddTokensToExistingFromAddressE401 ret = new AddTokensToExistingFromAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AddTokensToExistingFromAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddTokensToExistingFromAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public AddTokensToExistingFromAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return AddTokensToExistingFromAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddTokensToExistingFromAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AddTokensToExistingFromAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of AddTokensToExistingFromAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddTokensToExistingFromAddressE401
  * @throws IOException if the JSON string is invalid with respect to AddTokensToExistingFromAddressE401
  */
  public static AddTokensToExistingFromAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTokensToExistingFromAddressE401.class);
  }

 /**
  * Convert an instance of AddTokensToExistingFromAddressE401 to an JSON string
  *
  * @return JSON string
  */
