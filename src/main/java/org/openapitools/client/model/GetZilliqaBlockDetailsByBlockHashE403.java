...
public class GetZilliqaBlockDetailsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaBlockDetailsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaBlockDetailsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaBlockDetailsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaBlockDetailsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, GetZilliqaBlockDetailsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public GetZilliqaBlockDetailsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaBlockDetailsByBlockHashE403 ret = new GetZilliqaBlockDetailsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaBlockDetailsByBlockHashE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaBlockDetailsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaBlockDetailsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaBlockDetailsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaBlockDetailsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaBlockDetailsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaBlockDetailsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaBlockDetailsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaBlockDetailsByBlockHashE403
  */
  public static GetZilliqaBlockDetailsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaBlockDetailsByBlockHashE403.class);
  }

 /**
  * Convert an instance of GetZilliqaBlockDetailsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
