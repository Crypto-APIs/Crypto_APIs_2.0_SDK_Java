...
public class ListTransactionsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTransactionsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTransactionsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTransactionsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTransactionsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, ListTransactionsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public ListTransactionsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTransactionsByBlockHashE401 ret = new ListTransactionsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTransactionsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTransactionsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTransactionsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTransactionsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTransactionsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTransactionsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTransactionsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTransactionsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTransactionsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to ListTransactionsByBlockHashE401
  */
  public static ListTransactionsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTransactionsByBlockHashE401.class);
  }

 /**
  * Convert an instance of ListTransactionsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
