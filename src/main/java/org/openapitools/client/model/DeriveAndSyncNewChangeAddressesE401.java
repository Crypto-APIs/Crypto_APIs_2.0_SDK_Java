...
public class DeriveAndSyncNewChangeAddressesE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewChangeAddressesE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewChangeAddressesE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewChangeAddressesE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewChangeAddressesE401>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewChangeAddressesE401 value) throws IOException {
                ...
                @Override
                public DeriveAndSyncNewChangeAddressesE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewChangeAddressesE401 ret = new DeriveAndSyncNewChangeAddressesE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewChangeAddressesE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewChangeAddressesE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewChangeAddressesE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewChangeAddressesE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewChangeAddressesE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewChangeAddressesE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewChangeAddressesE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewChangeAddressesE401
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewChangeAddressesE401
  */
  public static DeriveAndSyncNewChangeAddressesE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewChangeAddressesE401.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewChangeAddressesE401 to an JSON string
  *
  * @return JSON string
  */
