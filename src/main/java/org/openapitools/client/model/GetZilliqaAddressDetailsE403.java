...
public class GetZilliqaAddressDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaAddressDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaAddressDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaAddressDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaAddressDetailsE403>() {
                @Override
                public void write(JsonWriter out, GetZilliqaAddressDetailsE403 value) throws IOException {
                ...
                @Override
                public GetZilliqaAddressDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaAddressDetailsE403 ret = new GetZilliqaAddressDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaAddressDetailsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaAddressDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaAddressDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaAddressDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaAddressDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaAddressDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaAddressDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaAddressDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaAddressDetailsE403
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaAddressDetailsE403
  */
  public static GetZilliqaAddressDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaAddressDetailsE403.class);
  }

 /**
  * Convert an instance of GetZilliqaAddressDetailsE403 to an JSON string
  *
  * @return JSON string
  */
