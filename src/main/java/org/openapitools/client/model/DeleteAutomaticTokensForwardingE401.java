...
public class DeleteAutomaticTokensForwardingE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticTokensForwardingE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticTokensForwardingE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticTokensForwardingE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticTokensForwardingE401>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticTokensForwardingE401 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticTokensForwardingE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticTokensForwardingE401 ret = new DeleteAutomaticTokensForwardingE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticTokensForwardingE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticTokensForwardingE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticTokensForwardingE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticTokensForwardingE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticTokensForwardingE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticTokensForwardingE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticTokensForwardingE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticTokensForwardingE401
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticTokensForwardingE401
  */
  public static DeleteAutomaticTokensForwardingE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticTokensForwardingE401.class);
  }

 /**
  * Convert an instance of DeleteAutomaticTokensForwardingE401 to an JSON string
  *
  * @return JSON string
  */
