...
public class GetNextAvailableNonceE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetNextAvailableNonceE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetNextAvailableNonceE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetNextAvailableNonceE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetNextAvailableNonceE400>() {
                @Override
                public void write(JsonWriter out, GetNextAvailableNonceE400 value) throws IOException {
                ...
                @Override
                public GetNextAvailableNonceE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetNextAvailableNonceE400 ret = new GetNextAvailableNonceE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetNextAvailableNonceE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetNextAvailableNonceE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetNextAvailableNonceE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetNextAvailableNonceE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetNextAvailableNonceE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetNextAvailableNonceE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetNextAvailableNonceE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetNextAvailableNonceE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetNextAvailableNonceE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetNextAvailableNonceE400
  * @throws IOException if the JSON string is invalid with respect to GetNextAvailableNonceE400
  */
  public static GetNextAvailableNonceE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNextAvailableNonceE400.class);
  }

 /**
  * Convert an instance of GetNextAvailableNonceE400 to an JSON string
  *
  * @return JSON string
  */
