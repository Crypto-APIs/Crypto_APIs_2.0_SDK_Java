...
public class GetLastMinedBlockE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLastMinedBlockE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLastMinedBlockE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLastMinedBlockE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLastMinedBlockE400>() {
                @Override
                public void write(JsonWriter out, GetLastMinedBlockE400 value) throws IOException {
                ...
                @Override
                public GetLastMinedBlockE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLastMinedBlockE400 ret = new GetLastMinedBlockE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLastMinedBlockE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLastMinedBlockE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLastMinedBlockE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLastMinedBlockE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLastMinedBlockE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLastMinedBlockE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLastMinedBlockE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLastMinedBlockE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLastMinedBlockE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLastMinedBlockE400
  * @throws IOException if the JSON string is invalid with respect to GetLastMinedBlockE400
  */
  public static GetLastMinedBlockE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLastMinedBlockE400.class);
  }

 /**
  * Convert an instance of GetLastMinedBlockE400 to an JSON string
  *
  * @return JSON string
  */
