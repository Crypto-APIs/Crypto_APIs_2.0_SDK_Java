...
public class ListOmniTransactionsByBlockHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTransactionsByBlockHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTransactionsByBlockHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTransactionsByBlockHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTransactionsByBlockHashE400>() {
                @Override
                public void write(JsonWriter out, ListOmniTransactionsByBlockHashE400 value) throws IOException {
                ...
                @Override
                public ListOmniTransactionsByBlockHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTransactionsByBlockHashE400 ret = new ListOmniTransactionsByBlockHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTransactionsByBlockHashE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTransactionsByBlockHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTransactionsByBlockHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByBlockHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTransactionsByBlockHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTransactionsByBlockHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTransactionsByBlockHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTransactionsByBlockHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTransactionsByBlockHashE400
  * @throws IOException if the JSON string is invalid with respect to ListOmniTransactionsByBlockHashE400
  */
  public static ListOmniTransactionsByBlockHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTransactionsByBlockHashE400.class);
  }

 /**
  * Convert an instance of ListOmniTransactionsByBlockHashE400 to an JSON string
  *
  * @return JSON string
  */
