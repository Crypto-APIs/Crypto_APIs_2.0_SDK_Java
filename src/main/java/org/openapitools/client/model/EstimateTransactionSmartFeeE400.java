...
public class EstimateTransactionSmartFeeE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateTransactionSmartFeeE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateTransactionSmartFeeE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateTransactionSmartFeeE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateTransactionSmartFeeE400>() {
                @Override
                public void write(JsonWriter out, EstimateTransactionSmartFeeE400 value) throws IOException {
                ...
                @Override
                public EstimateTransactionSmartFeeE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateTransactionSmartFeeE400 ret = new EstimateTransactionSmartFeeE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateTransactionSmartFeeE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateTransactionSmartFeeE400() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateTransactionSmartFeeE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateTransactionSmartFeeE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateTransactionSmartFeeE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateTransactionSmartFeeE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateTransactionSmartFeeE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateTransactionSmartFeeE400
  * @throws IOException if the JSON string is invalid with respect to EstimateTransactionSmartFeeE400
  */
  public static EstimateTransactionSmartFeeE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateTransactionSmartFeeE400.class);
  }

 /**
  * Convert an instance of EstimateTransactionSmartFeeE400 to an JSON string
  *
  * @return JSON string
  */
