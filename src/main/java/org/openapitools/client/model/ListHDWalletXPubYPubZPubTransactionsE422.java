...
public class ListHDWalletXPubYPubZPubTransactionsE422 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubTransactionsE422.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubTransactionsE422' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubTransactionsE422>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubTransactionsE422 value) throws IOException {
                ...
                @Override
                public ListHDWalletXPubYPubZPubTransactionsE422 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubTransactionsE422 ret = new ListHDWalletXPubYPubZPubTransactionsE422();
    ...
    public ListHDWalletXPubYPubZPubTransactionsE422() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubTransactionsE422(InvalidRequestBodyStructure o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubTransactionsE422(XpubSyncInProgress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubTransactionsE422.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE422
  */
 ...
 /**
  * Create an instance of ListHDWalletXPubYPubZPubTransactionsE422 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubTransactionsE422
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE422
  */
  public static ListHDWalletXPubYPubZPubTransactionsE422 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubTransactionsE422.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubTransactionsE422 to an JSON string
  *
  * @return JSON string
  */
