...
public class ListDepositAddressesE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListDepositAddressesE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListDepositAddressesE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListDepositAddressesE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListDepositAddressesE400>() {
                @Override
                public void write(JsonWriter out, ListDepositAddressesE400 value) throws IOException {
                ...
                @Override
                public ListDepositAddressesE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListDepositAddressesE400 ret = new ListDepositAddressesE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListDepositAddressesE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListDepositAddressesE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListDepositAddressesE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListDepositAddressesE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListDepositAddressesE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListDepositAddressesE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListDepositAddressesE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListDepositAddressesE400
  * @throws IOException if the JSON string is invalid with respect to ListDepositAddressesE400
  */
  public static ListDepositAddressesE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDepositAddressesE400.class);
  }

 /**
  * Convert an instance of ListDepositAddressesE400 to an JSON string
  *
  * @return JSON string
  */
