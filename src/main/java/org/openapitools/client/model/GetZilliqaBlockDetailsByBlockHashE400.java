...
public class GetZilliqaBlockDetailsByBlockHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaBlockDetailsByBlockHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaBlockDetailsByBlockHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaBlockDetailsByBlockHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaBlockDetailsByBlockHashE400>() {
                @Override
                public void write(JsonWriter out, GetZilliqaBlockDetailsByBlockHashE400 value) throws IOException {
                ...
                @Override
                public GetZilliqaBlockDetailsByBlockHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaBlockDetailsByBlockHashE400 ret = new GetZilliqaBlockDetailsByBlockHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaBlockDetailsByBlockHashE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaBlockDetailsByBlockHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaBlockDetailsByBlockHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaBlockDetailsByBlockHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaBlockDetailsByBlockHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaBlockDetailsByBlockHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaBlockDetailsByBlockHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaBlockDetailsByBlockHashE400
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaBlockDetailsByBlockHashE400
  */
  public static GetZilliqaBlockDetailsByBlockHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaBlockDetailsByBlockHashE400.class);
  }

 /**
  * Convert an instance of GetZilliqaBlockDetailsByBlockHashE400 to an JSON string
  *
  * @return JSON string
  */
