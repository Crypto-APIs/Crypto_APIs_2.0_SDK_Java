...
public class SyncHDWalletXPubYPubZPubE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncHDWalletXPubYPubZPubE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncHDWalletXPubYPubZPubE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncHDWalletXPubYPubZPubE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncHDWalletXPubYPubZPubE403>() {
                @Override
                public void write(JsonWriter out, SyncHDWalletXPubYPubZPubE403 value) throws IOException {
                ...
                @Override
                public SyncHDWalletXPubYPubZPubE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncHDWalletXPubYPubZPubE403 ret = new SyncHDWalletXPubYPubZPubE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncHDWalletXPubYPubZPubE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncHDWalletXPubYPubZPubE403() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncHDWalletXPubYPubZPubE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncHDWalletXPubYPubZPubE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncHDWalletXPubYPubZPubE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncHDWalletXPubYPubZPubE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncHDWalletXPubYPubZPubE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncHDWalletXPubYPubZPubE403
  * @throws IOException if the JSON string is invalid with respect to SyncHDWalletXPubYPubZPubE403
  */
  public static SyncHDWalletXPubYPubZPubE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncHDWalletXPubYPubZPubE403.class);
  }

 /**
  * Convert an instance of SyncHDWalletXPubYPubZPubE403 to an JSON string
  *
  * @return JSON string
  */
