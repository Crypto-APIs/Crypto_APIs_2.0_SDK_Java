...
public class ListTokensTransfersByTransactionHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensTransfersByTransactionHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensTransfersByTransactionHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensTransfersByTransactionHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensTransfersByTransactionHashE401>() {
                @Override
                public void write(JsonWriter out, ListTokensTransfersByTransactionHashE401 value) throws IOException {
                ...
                @Override
                public ListTokensTransfersByTransactionHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensTransfersByTransactionHashE401 ret = new ListTokensTransfersByTransactionHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensTransfersByTransactionHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensTransfersByTransactionHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensTransfersByTransactionHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensTransfersByTransactionHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensTransfersByTransactionHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensTransfersByTransactionHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensTransfersByTransactionHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensTransfersByTransactionHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensTransfersByTransactionHashE401
  * @throws IOException if the JSON string is invalid with respect to ListTokensTransfersByTransactionHashE401
  */
  public static ListTokensTransfersByTransactionHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensTransfersByTransactionHashE401.class);
  }

 /**
  * Convert an instance of ListTokensTransfersByTransactionHashE401 to an JSON string
  *
  * @return JSON string
  */
