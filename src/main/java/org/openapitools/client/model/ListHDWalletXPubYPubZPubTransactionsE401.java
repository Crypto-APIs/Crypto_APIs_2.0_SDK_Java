...
public class ListHDWalletXPubYPubZPubTransactionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHDWalletXPubYPubZPubTransactionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubTransactionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubTransactionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubTransactionsE401>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubTransactionsE401 value) throws IOException {
                ...
                @Override
                public ListHDWalletXPubYPubZPubTransactionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubTransactionsE401 ret = new ListHDWalletXPubYPubZPubTransactionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubTransactionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHDWalletXPubYPubZPubTransactionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubTransactionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubTransactionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubTransactionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListHDWalletXPubYPubZPubTransactionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListHDWalletXPubYPubZPubTransactionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubTransactionsE401
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubTransactionsE401
  */
  public static ListHDWalletXPubYPubZPubTransactionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubTransactionsE401.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubTransactionsE401 to an JSON string
  *
  * @return JSON string
  */
