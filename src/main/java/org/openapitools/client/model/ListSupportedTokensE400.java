...
public class ListSupportedTokensE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSupportedTokensE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSupportedTokensE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSupportedTokensE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSupportedTokensE400>() {
                @Override
                public void write(JsonWriter out, ListSupportedTokensE400 value) throws IOException {
                ...
                @Override
                public ListSupportedTokensE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSupportedTokensE400 ret = new ListSupportedTokensE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSupportedTokensE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSupportedTokensE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSupportedTokensE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedTokensE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedTokensE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSupportedTokensE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSupportedTokensE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSupportedTokensE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSupportedTokensE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSupportedTokensE400
  * @throws IOException if the JSON string is invalid with respect to ListSupportedTokensE400
  */
  public static ListSupportedTokensE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedTokensE400.class);
  }

 /**
  * Convert an instance of ListSupportedTokensE400 to an JSON string
  *
  * @return JSON string
  */
