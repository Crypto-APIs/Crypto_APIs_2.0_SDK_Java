...
public class GetZilliqaBlockDetailsByBlockHeightE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaBlockDetailsByBlockHeightE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaBlockDetailsByBlockHeightE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaBlockDetailsByBlockHeightE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaBlockDetailsByBlockHeightE403>() {
                @Override
                public void write(JsonWriter out, GetZilliqaBlockDetailsByBlockHeightE403 value) throws IOException {
                ...
                @Override
                public GetZilliqaBlockDetailsByBlockHeightE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaBlockDetailsByBlockHeightE403 ret = new GetZilliqaBlockDetailsByBlockHeightE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaBlockDetailsByBlockHeightE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaBlockDetailsByBlockHeightE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaBlockDetailsByBlockHeightE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHeightE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHeightE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHeightE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaBlockDetailsByBlockHeightE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaBlockDetailsByBlockHeightE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaBlockDetailsByBlockHeightE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaBlockDetailsByBlockHeightE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaBlockDetailsByBlockHeightE403
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaBlockDetailsByBlockHeightE403
  */
  public static GetZilliqaBlockDetailsByBlockHeightE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaBlockDetailsByBlockHeightE403.class);
  }

 /**
  * Convert an instance of GetZilliqaBlockDetailsByBlockHeightE403 to an JSON string
  *
  * @return JSON string
  */
