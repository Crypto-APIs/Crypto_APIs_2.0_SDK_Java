...
public class ListBlockchainEventsSubscriptionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListBlockchainEventsSubscriptionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListBlockchainEventsSubscriptionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListBlockchainEventsSubscriptionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListBlockchainEventsSubscriptionsE400>() {
                @Override
                public void write(JsonWriter out, ListBlockchainEventsSubscriptionsE400 value) throws IOException {
                ...
                @Override
                public ListBlockchainEventsSubscriptionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListBlockchainEventsSubscriptionsE400 ret = new ListBlockchainEventsSubscriptionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListBlockchainEventsSubscriptionsE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListBlockchainEventsSubscriptionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListBlockchainEventsSubscriptionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListBlockchainEventsSubscriptionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListBlockchainEventsSubscriptionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListBlockchainEventsSubscriptionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListBlockchainEventsSubscriptionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListBlockchainEventsSubscriptionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListBlockchainEventsSubscriptionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListBlockchainEventsSubscriptionsE400
  * @throws IOException if the JSON string is invalid with respect to ListBlockchainEventsSubscriptionsE400
  */
  public static ListBlockchainEventsSubscriptionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListBlockchainEventsSubscriptionsE400.class);
  }

 /**
  * Convert an instance of ListBlockchainEventsSubscriptionsE400 to an JSON string
  *
  * @return JSON string
  */
