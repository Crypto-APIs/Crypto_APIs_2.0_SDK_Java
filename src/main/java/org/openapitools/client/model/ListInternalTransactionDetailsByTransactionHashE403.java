...
public class ListInternalTransactionDetailsByTransactionHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionDetailsByTransactionHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionDetailsByTransactionHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionDetailsByTransactionHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionDetailsByTransactionHashE403>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionDetailsByTransactionHashE403 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionDetailsByTransactionHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionDetailsByTransactionHashE403 ret = new ListInternalTransactionDetailsByTransactionHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionDetailsByTransactionHashE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionDetailsByTransactionHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionDetailsByTransactionHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionDetailsByTransactionHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionDetailsByTransactionHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionDetailsByTransactionHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionDetailsByTransactionHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionDetailsByTransactionHashE403
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionDetailsByTransactionHashE403
  */
  public static ListInternalTransactionDetailsByTransactionHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionDetailsByTransactionHashE403.class);
  }

 /**
  * Convert an instance of ListInternalTransactionDetailsByTransactionHashE403 to an JSON string
  *
  * @return JSON string
  */
