...
public class GetZilliqaTransactionDetailsByTransactionIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaTransactionDetailsByTransactionIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaTransactionDetailsByTransactionIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaTransactionDetailsByTransactionIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaTransactionDetailsByTransactionIDE403>() {
                @Override
                public void write(JsonWriter out, GetZilliqaTransactionDetailsByTransactionIDE403 value) throws IOException {
                ...
                @Override
                public GetZilliqaTransactionDetailsByTransactionIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaTransactionDetailsByTransactionIDE403 ret = new GetZilliqaTransactionDetailsByTransactionIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaTransactionDetailsByTransactionIDE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaTransactionDetailsByTransactionIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaTransactionDetailsByTransactionIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaTransactionDetailsByTransactionIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaTransactionDetailsByTransactionIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaTransactionDetailsByTransactionIDE403
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE403
  */
  public static GetZilliqaTransactionDetailsByTransactionIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaTransactionDetailsByTransactionIDE403.class);
  }

 /**
  * Convert an instance of GetZilliqaTransactionDetailsByTransactionIDE403 to an JSON string
  *
  * @return JSON string
  */
