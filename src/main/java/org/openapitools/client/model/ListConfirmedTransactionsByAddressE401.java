...
public class ListConfirmedTransactionsByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTransactionsByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTransactionsByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTransactionsByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTransactionsByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTransactionsByAddressE401 value) throws IOException {
                ...
                @Override
                public ListConfirmedTransactionsByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTransactionsByAddressE401 ret = new ListConfirmedTransactionsByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTransactionsByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTransactionsByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTransactionsByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTransactionsByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTransactionsByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTransactionsByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTransactionsByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTransactionsByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTransactionsByAddressE401
  */
  public static ListConfirmedTransactionsByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTransactionsByAddressE401.class);
  }

 /**
  * Convert an instance of ListConfirmedTransactionsByAddressE401 to an JSON string
  *
  * @return JSON string
  */
