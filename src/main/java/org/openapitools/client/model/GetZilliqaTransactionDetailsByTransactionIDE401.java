...
public class GetZilliqaTransactionDetailsByTransactionIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaTransactionDetailsByTransactionIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaTransactionDetailsByTransactionIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaTransactionDetailsByTransactionIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaTransactionDetailsByTransactionIDE401>() {
                @Override
                public void write(JsonWriter out, GetZilliqaTransactionDetailsByTransactionIDE401 value) throws IOException {
                ...
                @Override
                public GetZilliqaTransactionDetailsByTransactionIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaTransactionDetailsByTransactionIDE401 ret = new GetZilliqaTransactionDetailsByTransactionIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaTransactionDetailsByTransactionIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaTransactionDetailsByTransactionIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaTransactionDetailsByTransactionIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaTransactionDetailsByTransactionIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaTransactionDetailsByTransactionIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaTransactionDetailsByTransactionIDE401
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE401
  */
  public static GetZilliqaTransactionDetailsByTransactionIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaTransactionDetailsByTransactionIDE401.class);
  }

 /**
  * Convert an instance of GetZilliqaTransactionDetailsByTransactionIDE401 to an JSON string
  *
  * @return JSON string
  */
