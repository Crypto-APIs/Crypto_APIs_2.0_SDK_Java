...
public class ListConfirmedTransactionsByAddressRIBSD {
  ...
  private List<ListConfirmedTransactionsByAddressRIBSDVin> vin = new ArrayList<ListConfirmedTransactionsByAddressRIBSDVin>();
  ...
  public ListConfirmedTransactionsByAddressRIBSD locktime(Integer locktime) {
