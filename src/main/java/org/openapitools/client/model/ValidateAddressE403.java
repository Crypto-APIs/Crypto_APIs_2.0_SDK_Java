...
public class ValidateAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ValidateAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ValidateAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ValidateAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ValidateAddressE403>() {
                @Override
                public void write(JsonWriter out, ValidateAddressE403 value) throws IOException {
                ...
                @Override
                public ValidateAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ValidateAddressE403 ret = new ValidateAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ValidateAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ValidateAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ValidateAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ValidateAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ValidateAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ValidateAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ValidateAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ValidateAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ValidateAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ValidateAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidateAddressE403
  * @throws IOException if the JSON string is invalid with respect to ValidateAddressE403
  */
  public static ValidateAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidateAddressE403.class);
  }

 /**
  * Convert an instance of ValidateAddressE403 to an JSON string
  *
  * @return JSON string
  */
