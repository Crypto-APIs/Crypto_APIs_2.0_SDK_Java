...
import org.openapitools.client.model.GetBlockDetailsByBlockHeightRIBSZ2;
...
public class GetBlockDetailsByBlockHeightRIBS extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<GetBlockDetailsByBlockHeightRIBSZ2> adapterGetBlockDetailsByBlockHeightRIBSZ2 = gson.getDelegateAdapter(this, TypeToken.get(GetBlockDetailsByBlockHeightRIBSZ2.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHeightRIBS>() {
                ...
                public void write(JsonWriter out, GetBlockDetailsByBlockHeightRIBS value) throws IOException {
                    ...
                    // check if the actual instance is of the type `GetBlockDetailsByBlockHeightRIBSZ2`
                    if (value.getActualInstance() instanceof GetBlockDetailsByBlockHeightRIBSZ2) {
                        JsonObject obj = adapterGetBlockDetailsByBlockHeightRIBSZ2.toJsonTree((GetBlockDetailsByBlockHeightRIBSZ2)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }
                ...
                public GetBlockDetailsByBlockHeightRIBS read(JsonReader in) throws IOException {
                    ...
                    // deserialize GetBlockDetailsByBlockHeightRIBSZ2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GetBlockDetailsByBlockHeightRIBSZ2.validateJsonObject(jsonObject);
                        actualAdapter = adapterGetBlockDetailsByBlockHeightRIBSZ2;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GetBlockDetailsByBlockHeightRIBSZ2'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GetBlockDetailsByBlockHeightRIBSZ2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GetBlockDetailsByBlockHeightRIBSZ2'", e);
                    }
    ...
    public GetBlockDetailsByBlockHeightRIBS(GetBlockDetailsByBlockHeightRIBSZ2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("GetBlockDetailsByBlockHeightRIBSZ2", new GenericType<GetBlockDetailsByBlockHeightRIBSZ2>() {
        });
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof GetBlockDetailsByBlockHeightRIBSZ2) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GetBlockDetailsByBlockHeightRIBSZ2`
     * @throws ClassCastException if the instance is not `GetBlockDetailsByBlockHeightRIBSZ2`
     */
    public GetBlockDetailsByBlockHeightRIBSZ2 getGetBlockDetailsByBlockHeightRIBSZ2() throws ClassCastException {
        return (GetBlockDetailsByBlockHeightRIBSZ2)super.getActualInstance();
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    // validate the json string with GetBlockDetailsByBlockHeightRIBSZ2
    try {
      GetBlockDetailsByBlockHeightRIBSZ2.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for GetBlockDetailsByBlockHeightRIBSZ2 failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHeightRIBS with oneOf schemas: GetBlockDetailsByBlockHeightRIBSB, GetBlockDetailsByBlockHeightRIBSBC, GetBlockDetailsByBlockHeightRIBSBSC, GetBlockDetailsByBlockHeightRIBSD, GetBlockDetailsByBlockHeightRIBSD2, GetBlockDetailsByBlockHeightRIBSE, GetBlockDetailsByBlockHeightRIBSEC, GetBlockDetailsByBlockHeightRIBSL, GetBlockDetailsByBlockHeightRIBSZ, GetBlockDetailsByBlockHeightRIBSZ2. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
