...
public class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400>() {
                @Override
                public void write(JsonWriter out, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 value) throws IOException {
                ...
                @Override
                public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 ret = new PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400
  * @throws IOException if the JSON string is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400
  */
  public static PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.class);
  }

 /**
  * Convert an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 to an JSON string
  *
  * @return JSON string
  */
