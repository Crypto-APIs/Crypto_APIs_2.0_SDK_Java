...
public class DeriveAndSyncNewChangeAddressesE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewChangeAddressesE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewChangeAddressesE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewChangeAddressesE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewChangeAddressesE403>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewChangeAddressesE403 value) throws IOException {
                ...
                @Override
                public DeriveAndSyncNewChangeAddressesE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewChangeAddressesE403 ret = new DeriveAndSyncNewChangeAddressesE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewChangeAddressesE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewChangeAddressesE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewChangeAddressesE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewChangeAddressesE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewChangeAddressesE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewChangeAddressesE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewChangeAddressesE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewChangeAddressesE403
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewChangeAddressesE403
  */
  public static DeriveAndSyncNewChangeAddressesE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewChangeAddressesE403.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewChangeAddressesE403 to an JSON string
  *
  * @return JSON string
  */
