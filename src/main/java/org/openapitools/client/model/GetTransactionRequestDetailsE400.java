...
public class GetTransactionRequestDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTransactionRequestDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionRequestDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionRequestDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionRequestDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetTransactionRequestDetailsE400 value) throws IOException {
                ...
                @Override
                public GetTransactionRequestDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionRequestDetailsE400 ret = new GetTransactionRequestDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTransactionRequestDetailsE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTransactionRequestDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionRequestDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionRequestDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionRequestDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTransactionRequestDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTransactionRequestDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionRequestDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetTransactionRequestDetailsE400
  */
  public static GetTransactionRequestDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionRequestDetailsE400.class);
  }

 /**
  * Convert an instance of GetTransactionRequestDetailsE400 to an JSON string
  *
  * @return JSON string
  */
