...
public class ValidateAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ValidateAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ValidateAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ValidateAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ValidateAddressE400>() {
                @Override
                public void write(JsonWriter out, ValidateAddressE400 value) throws IOException {
                ...
                @Override
                public ValidateAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ValidateAddressE400 ret = new ValidateAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ValidateAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ValidateAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ValidateAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ValidateAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ValidateAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ValidateAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ValidateAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ValidateAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ValidateAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidateAddressE400
  * @throws IOException if the JSON string is invalid with respect to ValidateAddressE400
  */
  public static ValidateAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidateAddressE400.class);
  }

 /**
  * Convert an instance of ValidateAddressE400 to an JSON string
  *
  * @return JSON string
  */
