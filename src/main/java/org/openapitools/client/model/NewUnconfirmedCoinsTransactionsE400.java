...
public class NewUnconfirmedCoinsTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedCoinsTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedCoinsTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedCoinsTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedCoinsTransactionsE400>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedCoinsTransactionsE400 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedCoinsTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedCoinsTransactionsE400 ret = new NewUnconfirmedCoinsTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedCoinsTransactionsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedCoinsTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewUnconfirmedCoinsTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedCoinsTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedCoinsTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedCoinsTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedCoinsTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedCoinsTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedCoinsTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedCoinsTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedCoinsTransactionsE400
  */
  public static NewUnconfirmedCoinsTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedCoinsTransactionsE400.class);
  }

 /**
  * Convert an instance of NewUnconfirmedCoinsTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
