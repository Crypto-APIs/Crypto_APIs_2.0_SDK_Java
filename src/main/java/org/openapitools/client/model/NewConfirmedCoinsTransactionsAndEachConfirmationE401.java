...
public class NewConfirmedCoinsTransactionsAndEachConfirmationE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsAndEachConfirmationE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsAndEachConfirmationE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsAndEachConfirmationE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsAndEachConfirmationE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsAndEachConfirmationE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsAndEachConfirmationE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsAndEachConfirmationE401 ret = new NewConfirmedCoinsTransactionsAndEachConfirmationE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsAndEachConfirmationE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsAndEachConfirmationE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsAndEachConfirmationE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsAndEachConfirmationE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsAndEachConfirmationE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsAndEachConfirmationE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsAndEachConfirmationE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsAndEachConfirmationE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsAndEachConfirmationE401
  */
  public static NewConfirmedCoinsTransactionsAndEachConfirmationE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsAndEachConfirmationE401.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsAndEachConfirmationE401 to an JSON string
  *
  * @return JSON string
  */
