...
public class ListSupportedAssetsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSupportedAssetsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSupportedAssetsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSupportedAssetsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSupportedAssetsE403>() {
                @Override
                public void write(JsonWriter out, ListSupportedAssetsE403 value) throws IOException {
                ...
                @Override
                public ListSupportedAssetsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSupportedAssetsE403 ret = new ListSupportedAssetsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSupportedAssetsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSupportedAssetsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSupportedAssetsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSupportedAssetsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSupportedAssetsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSupportedAssetsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSupportedAssetsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSupportedAssetsE403
  * @throws IOException if the JSON string is invalid with respect to ListSupportedAssetsE403
  */
  public static ListSupportedAssetsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedAssetsE403.class);
  }

 /**
  * Convert an instance of ListSupportedAssetsE403 to an JSON string
  *
  * @return JSON string
  */
