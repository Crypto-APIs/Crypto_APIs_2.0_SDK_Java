        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsE403>() {
                ...
                public NewConfirmedInternalTransactionsE403 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
