...
public class NewUnconfirmedTokensTransactionsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedTokensTransactionsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedTokensTransactionsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedTokensTransactionsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedTokensTransactionsE400>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedTokensTransactionsE400 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedTokensTransactionsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedTokensTransactionsE400 ret = new NewUnconfirmedTokensTransactionsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedTokensTransactionsE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedTokensTransactionsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewUnconfirmedTokensTransactionsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedTokensTransactionsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedTokensTransactionsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedTokensTransactionsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedTokensTransactionsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedTokensTransactionsE400
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedTokensTransactionsE400
  */
  public static NewUnconfirmedTokensTransactionsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedTokensTransactionsE400.class);
  }

 /**
  * Convert an instance of NewUnconfirmedTokensTransactionsE400 to an JSON string
  *
  * @return JSON string
  */
