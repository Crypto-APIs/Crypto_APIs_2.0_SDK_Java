...
public class DeleteAutomaticCoinsForwardingE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticCoinsForwardingE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticCoinsForwardingE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticCoinsForwardingE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticCoinsForwardingE403>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticCoinsForwardingE403 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticCoinsForwardingE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticCoinsForwardingE403 ret = new DeleteAutomaticCoinsForwardingE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticCoinsForwardingE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticCoinsForwardingE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticCoinsForwardingE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticCoinsForwardingE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticCoinsForwardingE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticCoinsForwardingE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticCoinsForwardingE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticCoinsForwardingE403
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticCoinsForwardingE403
  */
  public static DeleteAutomaticCoinsForwardingE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticCoinsForwardingE403.class);
  }

 /**
  * Convert an instance of DeleteAutomaticCoinsForwardingE403 to an JSON string
  *
  * @return JSON string
  */
