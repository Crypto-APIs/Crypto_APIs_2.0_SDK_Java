...
public class EstimateTransactionSmartFeeE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateTransactionSmartFeeE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateTransactionSmartFeeE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateTransactionSmartFeeE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateTransactionSmartFeeE401>() {
                @Override
                public void write(JsonWriter out, EstimateTransactionSmartFeeE401 value) throws IOException {
                ...
                @Override
                public EstimateTransactionSmartFeeE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateTransactionSmartFeeE401 ret = new EstimateTransactionSmartFeeE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateTransactionSmartFeeE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateTransactionSmartFeeE401() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateTransactionSmartFeeE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateTransactionSmartFeeE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateTransactionSmartFeeE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateTransactionSmartFeeE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateTransactionSmartFeeE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateTransactionSmartFeeE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateTransactionSmartFeeE401
  * @throws IOException if the JSON string is invalid with respect to EstimateTransactionSmartFeeE401
  */
  public static EstimateTransactionSmartFeeE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateTransactionSmartFeeE401.class);
  }

 /**
  * Convert an instance of EstimateTransactionSmartFeeE401 to an JSON string
  *
  * @return JSON string
  */
