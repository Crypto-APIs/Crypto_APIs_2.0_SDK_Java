...
public class GetExchangeRateByAssetSymbolsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetSymbolsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetSymbolsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetSymbolsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetSymbolsE401>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetSymbolsE401 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetSymbolsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetSymbolsE401 ret = new GetExchangeRateByAssetSymbolsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetSymbolsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetSymbolsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetSymbolsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetSymbolsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetSymbolsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetSymbolsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetSymbolsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetSymbolsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetSymbolsE401
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetSymbolsE401
  */
  public static GetExchangeRateByAssetSymbolsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetSymbolsE401.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetSymbolsE401 to an JSON string
  *
  * @return JSON string
  */
