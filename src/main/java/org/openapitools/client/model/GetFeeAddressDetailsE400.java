...
public class GetFeeAddressDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeAddressDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeAddressDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeAddressDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeAddressDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetFeeAddressDetailsE400 value) throws IOException {
                ...
                @Override
                public GetFeeAddressDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeAddressDetailsE400 ret = new GetFeeAddressDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeAddressDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeAddressDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeAddressDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeAddressDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeAddressDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeAddressDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeAddressDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeAddressDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetFeeAddressDetailsE400
  */
  public static GetFeeAddressDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeAddressDetailsE400.class);
  }

 /**
  * Convert an instance of GetFeeAddressDetailsE400 to an JSON string
  *
  * @return JSON string
  */
