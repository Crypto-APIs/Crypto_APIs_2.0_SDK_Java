...
public class ConvertBitcoinCashAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ConvertBitcoinCashAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ConvertBitcoinCashAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ConvertBitcoinCashAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ConvertBitcoinCashAddressE403>() {
                @Override
                public void write(JsonWriter out, ConvertBitcoinCashAddressE403 value) throws IOException {
                ...
                @Override
                public ConvertBitcoinCashAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ConvertBitcoinCashAddressE403 ret = new ConvertBitcoinCashAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ConvertBitcoinCashAddressE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ConvertBitcoinCashAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ConvertBitcoinCashAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ConvertBitcoinCashAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConvertBitcoinCashAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ConvertBitcoinCashAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ConvertBitcoinCashAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConvertBitcoinCashAddressE403
  * @throws IOException if the JSON string is invalid with respect to ConvertBitcoinCashAddressE403
  */
  public static ConvertBitcoinCashAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertBitcoinCashAddressE403.class);
  }

 /**
  * Convert an instance of ConvertBitcoinCashAddressE403 to an JSON string
  *
  * @return JSON string
  */
