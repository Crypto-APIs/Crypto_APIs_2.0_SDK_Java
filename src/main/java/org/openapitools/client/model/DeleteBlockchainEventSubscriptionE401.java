...
public class DeleteBlockchainEventSubscriptionE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteBlockchainEventSubscriptionE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteBlockchainEventSubscriptionE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteBlockchainEventSubscriptionE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteBlockchainEventSubscriptionE401>() {
                @Override
                public void write(JsonWriter out, DeleteBlockchainEventSubscriptionE401 value) throws IOException {
                ...
                @Override
                public DeleteBlockchainEventSubscriptionE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteBlockchainEventSubscriptionE401 ret = new DeleteBlockchainEventSubscriptionE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteBlockchainEventSubscriptionE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteBlockchainEventSubscriptionE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteBlockchainEventSubscriptionE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteBlockchainEventSubscriptionE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteBlockchainEventSubscriptionE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteBlockchainEventSubscriptionE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteBlockchainEventSubscriptionE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteBlockchainEventSubscriptionE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteBlockchainEventSubscriptionE401
  * @throws IOException if the JSON string is invalid with respect to DeleteBlockchainEventSubscriptionE401
  */
  public static DeleteBlockchainEventSubscriptionE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBlockchainEventSubscriptionE401.class);
  }

 /**
  * Convert an instance of DeleteBlockchainEventSubscriptionE401 to an JSON string
  *
  * @return JSON string
  */
