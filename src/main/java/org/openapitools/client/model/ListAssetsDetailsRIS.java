...
public class ListAssetsDetailsRIS extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAssetsDetailsRIS>() {
                ...
                public ListAssetsDetailsRIS read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format("Deserialization for ListAssetsDetailsRISC failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format("Failed deserialization for ListAssetsDetailsRIS: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAssetsDetailsRIS with oneOf schemas: ListAssetsDetailsRISC. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
