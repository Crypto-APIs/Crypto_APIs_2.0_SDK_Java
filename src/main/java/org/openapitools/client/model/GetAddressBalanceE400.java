...
public class GetAddressBalanceE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressBalanceE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressBalanceE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressBalanceE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressBalanceE400>() {
                @Override
                public void write(JsonWriter out, GetAddressBalanceE400 value) throws IOException {
                ...
                @Override
                public GetAddressBalanceE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressBalanceE400 ret = new GetAddressBalanceE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressBalanceE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressBalanceE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressBalanceE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressBalanceE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressBalanceE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressBalanceE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressBalanceE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressBalanceE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressBalanceE400
  * @throws IOException if the JSON string is invalid with respect to GetAddressBalanceE400
  */
  public static GetAddressBalanceE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressBalanceE400.class);
  }

 /**
  * Convert an instance of GetAddressBalanceE400 to an JSON string
  *
  * @return JSON string
  */
