...
public class NewUnconfirmedTokensTransactionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedTokensTransactionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedTokensTransactionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedTokensTransactionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedTokensTransactionsE401>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedTokensTransactionsE401 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedTokensTransactionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedTokensTransactionsE401 ret = new NewUnconfirmedTokensTransactionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedTokensTransactionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedTokensTransactionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewUnconfirmedTokensTransactionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedTokensTransactionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedTokensTransactionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedTokensTransactionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedTokensTransactionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedTokensTransactionsE401
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedTokensTransactionsE401
  */
  public static NewUnconfirmedTokensTransactionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedTokensTransactionsE401.class);
  }

 /**
  * Convert an instance of NewUnconfirmedTokensTransactionsE401 to an JSON string
  *
  * @return JSON string
  */
