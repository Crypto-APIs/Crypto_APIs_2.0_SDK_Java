...
public class GetTransactionDetailsByTransactionIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTransactionDetailsByTransactionIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionDetailsByTransactionIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionDetailsByTransactionIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionDetailsByTransactionIDE403>() {
                @Override
                public void write(JsonWriter out, GetTransactionDetailsByTransactionIDE403 value) throws IOException {
                ...
                @Override
                public GetTransactionDetailsByTransactionIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionDetailsByTransactionIDE403 ret = new GetTransactionDetailsByTransactionIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTransactionDetailsByTransactionIDE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTransactionDetailsByTransactionIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionDetailsByTransactionIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionDetailsByTransactionIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionDetailsByTransactionIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTransactionDetailsByTransactionIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTransactionDetailsByTransactionIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionDetailsByTransactionIDE403
  * @throws IOException if the JSON string is invalid with respect to GetTransactionDetailsByTransactionIDE403
  */
  public static GetTransactionDetailsByTransactionIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionDetailsByTransactionIDE403.class);
  }

 /**
  * Convert an instance of GetTransactionDetailsByTransactionIDE403 to an JSON string
  *
  * @return JSON string
  */
