...
public class DeleteAutomaticCoinsForwardingE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticCoinsForwardingE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticCoinsForwardingE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticCoinsForwardingE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticCoinsForwardingE400>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticCoinsForwardingE400 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticCoinsForwardingE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticCoinsForwardingE400 ret = new DeleteAutomaticCoinsForwardingE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticCoinsForwardingE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticCoinsForwardingE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticCoinsForwardingE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticCoinsForwardingE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticCoinsForwardingE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticCoinsForwardingE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticCoinsForwardingE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticCoinsForwardingE400
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticCoinsForwardingE400
  */
  public static DeleteAutomaticCoinsForwardingE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticCoinsForwardingE400.class);
  }

 /**
  * Convert an instance of DeleteAutomaticCoinsForwardingE400 to an JSON string
  *
  * @return JSON string
  */
