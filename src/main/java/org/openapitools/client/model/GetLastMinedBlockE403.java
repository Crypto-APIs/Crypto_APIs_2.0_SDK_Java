...
public class GetLastMinedBlockE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLastMinedBlockE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLastMinedBlockE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLastMinedBlockE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLastMinedBlockE403>() {
                @Override
                public void write(JsonWriter out, GetLastMinedBlockE403 value) throws IOException {
                ...
                @Override
                public GetLastMinedBlockE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLastMinedBlockE403 ret = new GetLastMinedBlockE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLastMinedBlockE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLastMinedBlockE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLastMinedBlockE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLastMinedBlockE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLastMinedBlockE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLastMinedBlockE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLastMinedBlockE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLastMinedBlockE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLastMinedBlockE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLastMinedBlockE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLastMinedBlockE403
  * @throws IOException if the JSON string is invalid with respect to GetLastMinedBlockE403
  */
  public static GetLastMinedBlockE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLastMinedBlockE403.class);
  }

 /**
  * Convert an instance of GetLastMinedBlockE403 to an JSON string
  *
  * @return JSON string
  */
