...
public class GetBlockDetailsByBlockHashFromCallbackE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHashFromCallbackE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHashFromCallbackE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHashFromCallbackE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHashFromCallbackE401>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHashFromCallbackE401 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHashFromCallbackE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHashFromCallbackE401 ret = new GetBlockDetailsByBlockHashFromCallbackE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHashFromCallbackE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHashFromCallbackE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHashFromCallbackE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashFromCallbackE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHashFromCallbackE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHashFromCallbackE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHashFromCallbackE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHashFromCallbackE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHashFromCallbackE401
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHashFromCallbackE401
  */
  public static GetBlockDetailsByBlockHashFromCallbackE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHashFromCallbackE401.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHashFromCallbackE401 to an JSON string
  *
  * @return JSON string
  */
