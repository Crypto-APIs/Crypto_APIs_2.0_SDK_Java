...
public class GetWalletAssetDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetWalletAssetDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetWalletAssetDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetWalletAssetDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetWalletAssetDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetWalletAssetDetailsE401 value) throws IOException {
                ...
                @Override
                public GetWalletAssetDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetWalletAssetDetailsE401 ret = new GetWalletAssetDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetWalletAssetDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetWalletAssetDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetWalletAssetDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetWalletAssetDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWalletAssetDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetWalletAssetDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetWalletAssetDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetWalletAssetDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetWalletAssetDetailsE401
  */
  public static GetWalletAssetDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWalletAssetDetailsE401.class);
  }

 /**
  * Convert an instance of GetWalletAssetDetailsE401 to an JSON string
  *
  * @return JSON string
  */
