...
public class ListAssetsDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAssetsDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAssetsDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAssetsDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAssetsDetailsE400>() {
                @Override
                public void write(JsonWriter out, ListAssetsDetailsE400 value) throws IOException {
                ...
                @Override
                public ListAssetsDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAssetsDetailsE400 ret = new ListAssetsDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAssetsDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAssetsDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAssetsDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAssetsDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAssetsDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAssetsDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAssetsDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAssetsDetailsE400
  * @throws IOException if the JSON string is invalid with respect to ListAssetsDetailsE400
  */
  public static ListAssetsDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssetsDetailsE400.class);
  }

 /**
  * Convert an instance of ListAssetsDetailsE400 to an JSON string
  *
  * @return JSON string
  */
