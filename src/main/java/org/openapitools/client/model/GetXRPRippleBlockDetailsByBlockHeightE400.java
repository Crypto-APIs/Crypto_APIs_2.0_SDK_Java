...
public class GetXRPRippleBlockDetailsByBlockHeightE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleBlockDetailsByBlockHeightE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleBlockDetailsByBlockHeightE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleBlockDetailsByBlockHeightE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleBlockDetailsByBlockHeightE400>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleBlockDetailsByBlockHeightE400 value) throws IOException {
                ...
                @Override
                public GetXRPRippleBlockDetailsByBlockHeightE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleBlockDetailsByBlockHeightE400 ret = new GetXRPRippleBlockDetailsByBlockHeightE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleBlockDetailsByBlockHeightE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleBlockDetailsByBlockHeightE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleBlockDetailsByBlockHeightE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleBlockDetailsByBlockHeightE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleBlockDetailsByBlockHeightE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleBlockDetailsByBlockHeightE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleBlockDetailsByBlockHeightE400
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleBlockDetailsByBlockHeightE400
  */
  public static GetXRPRippleBlockDetailsByBlockHeightE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleBlockDetailsByBlockHeightE400.class);
  }

 /**
  * Convert an instance of GetXRPRippleBlockDetailsByBlockHeightE400 to an JSON string
  *
  * @return JSON string
  */
