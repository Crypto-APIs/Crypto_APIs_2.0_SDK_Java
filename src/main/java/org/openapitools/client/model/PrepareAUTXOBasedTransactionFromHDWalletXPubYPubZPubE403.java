...
public class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403>() {
                @Override
                public void write(JsonWriter out, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 value) throws IOException {
                ...
                @Override
                public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 ret = new PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403
  * @throws IOException if the JSON string is invalid with respect to PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403
  */
  public static PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.class);
  }

 /**
  * Convert an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 to an JSON string
  *
  * @return JSON string
  */
