...
public class NewConfirmedTokenTransactionsForSpecificAmountE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokenTransactionsForSpecificAmountE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokenTransactionsForSpecificAmountE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokenTransactionsForSpecificAmountE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokenTransactionsForSpecificAmountE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokenTransactionsForSpecificAmountE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokenTransactionsForSpecificAmountE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokenTransactionsForSpecificAmountE401 ret = new NewConfirmedTokenTransactionsForSpecificAmountE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokenTransactionsForSpecificAmountE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokenTransactionsForSpecificAmountE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokenTransactionsForSpecificAmountE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokenTransactionsForSpecificAmountE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokenTransactionsForSpecificAmountE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokenTransactionsForSpecificAmountE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE401
  */
  public static NewConfirmedTokenTransactionsForSpecificAmountE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokenTransactionsForSpecificAmountE401.class);
  }

 /**
  * Convert an instance of NewConfirmedTokenTransactionsForSpecificAmountE401 to an JSON string
  *
  * @return JSON string
  */
