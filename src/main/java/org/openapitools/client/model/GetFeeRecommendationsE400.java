...
public class GetFeeRecommendationsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeRecommendationsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeRecommendationsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeRecommendationsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeRecommendationsE400>() {
                @Override
                public void write(JsonWriter out, GetFeeRecommendationsE400 value) throws IOException {
                ...
                @Override
                public GetFeeRecommendationsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeRecommendationsE400 ret = new GetFeeRecommendationsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeRecommendationsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeRecommendationsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeRecommendationsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeRecommendationsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeRecommendationsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeRecommendationsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeRecommendationsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeRecommendationsE400
  * @throws IOException if the JSON string is invalid with respect to GetFeeRecommendationsE400
  */
  public static GetFeeRecommendationsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeRecommendationsE400.class);
  }

 /**
  * Convert an instance of GetFeeRecommendationsE400 to an JSON string
  *
  * @return JSON string
  */
