...
public class ListTokensTransfersByTransactionHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensTransfersByTransactionHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensTransfersByTransactionHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensTransfersByTransactionHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensTransfersByTransactionHashE400>() {
                @Override
                public void write(JsonWriter out, ListTokensTransfersByTransactionHashE400 value) throws IOException {
                ...
                @Override
                public ListTokensTransfersByTransactionHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensTransfersByTransactionHashE400 ret = new ListTokensTransfersByTransactionHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensTransfersByTransactionHashE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensTransfersByTransactionHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensTransfersByTransactionHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensTransfersByTransactionHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensTransfersByTransactionHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensTransfersByTransactionHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensTransfersByTransactionHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensTransfersByTransactionHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensTransfersByTransactionHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensTransfersByTransactionHashE400
  * @throws IOException if the JSON string is invalid with respect to ListTokensTransfersByTransactionHashE400
  */
  public static ListTokensTransfersByTransactionHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensTransfersByTransactionHashE400.class);
  }

 /**
  * Convert an instance of ListTokensTransfersByTransactionHashE400 to an JSON string
  *
  * @return JSON string
  */
