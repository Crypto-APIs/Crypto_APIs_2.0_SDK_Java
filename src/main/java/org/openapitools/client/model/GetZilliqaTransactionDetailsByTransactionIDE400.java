...
public class GetZilliqaTransactionDetailsByTransactionIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaTransactionDetailsByTransactionIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaTransactionDetailsByTransactionIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaTransactionDetailsByTransactionIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaTransactionDetailsByTransactionIDE400>() {
                @Override
                public void write(JsonWriter out, GetZilliqaTransactionDetailsByTransactionIDE400 value) throws IOException {
                ...
                @Override
                public GetZilliqaTransactionDetailsByTransactionIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaTransactionDetailsByTransactionIDE400 ret = new GetZilliqaTransactionDetailsByTransactionIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaTransactionDetailsByTransactionIDE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaTransactionDetailsByTransactionIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaTransactionDetailsByTransactionIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaTransactionDetailsByTransactionIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaTransactionDetailsByTransactionIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaTransactionDetailsByTransactionIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaTransactionDetailsByTransactionIDE400
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaTransactionDetailsByTransactionIDE400
  */
  public static GetZilliqaTransactionDetailsByTransactionIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaTransactionDetailsByTransactionIDE400.class);
  }

 /**
  * Convert an instance of GetZilliqaTransactionDetailsByTransactionIDE400 to an JSON string
  *
  * @return JSON string
  */
