...
public class SyncNewHDWalletXPubYPubZPubE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncNewHDWalletXPubYPubZPubE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncNewHDWalletXPubYPubZPubE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncNewHDWalletXPubYPubZPubE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncNewHDWalletXPubYPubZPubE403>() {
                @Override
                public void write(JsonWriter out, SyncNewHDWalletXPubYPubZPubE403 value) throws IOException {
                ...
                @Override
                public SyncNewHDWalletXPubYPubZPubE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncNewHDWalletXPubYPubZPubE403 ret = new SyncNewHDWalletXPubYPubZPubE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncNewHDWalletXPubYPubZPubE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncNewHDWalletXPubYPubZPubE403() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncNewHDWalletXPubYPubZPubE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncNewHDWalletXPubYPubZPubE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncNewHDWalletXPubYPubZPubE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncNewHDWalletXPubYPubZPubE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncNewHDWalletXPubYPubZPubE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncNewHDWalletXPubYPubZPubE403
  * @throws IOException if the JSON string is invalid with respect to SyncNewHDWalletXPubYPubZPubE403
  */
  public static SyncNewHDWalletXPubYPubZPubE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncNewHDWalletXPubYPubZPubE403.class);
  }

 /**
  * Convert an instance of SyncNewHDWalletXPubYPubZPubE403 to an JSON string
  *
  * @return JSON string
  */
