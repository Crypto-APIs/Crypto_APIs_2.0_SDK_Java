...
public class GetLatestMinedZilliqaBlockE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedZilliqaBlockE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedZilliqaBlockE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedZilliqaBlockE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedZilliqaBlockE403>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedZilliqaBlockE403 value) throws IOException {
                ...
                @Override
                public GetLatestMinedZilliqaBlockE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedZilliqaBlockE403 ret = new GetLatestMinedZilliqaBlockE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedZilliqaBlockE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedZilliqaBlockE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedZilliqaBlockE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedZilliqaBlockE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedZilliqaBlockE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedZilliqaBlockE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedZilliqaBlockE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedZilliqaBlockE403
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedZilliqaBlockE403
  */
  public static GetLatestMinedZilliqaBlockE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedZilliqaBlockE403.class);
  }

 /**
  * Convert an instance of GetLatestMinedZilliqaBlockE403 to an JSON string
  *
  * @return JSON string
  */
