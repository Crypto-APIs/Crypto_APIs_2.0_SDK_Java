...
public class ListInternalTransactionDetailsByTransactionHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionDetailsByTransactionHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionDetailsByTransactionHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionDetailsByTransactionHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionDetailsByTransactionHashE401>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionDetailsByTransactionHashE401 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionDetailsByTransactionHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionDetailsByTransactionHashE401 ret = new ListInternalTransactionDetailsByTransactionHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionDetailsByTransactionHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionDetailsByTransactionHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionDetailsByTransactionHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionDetailsByTransactionHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionDetailsByTransactionHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionDetailsByTransactionHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionDetailsByTransactionHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionDetailsByTransactionHashE401
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionDetailsByTransactionHashE401
  */
  public static ListInternalTransactionDetailsByTransactionHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionDetailsByTransactionHashE401.class);
  }

 /**
  * Convert an instance of ListInternalTransactionDetailsByTransactionHashE401 to an JSON string
  *
  * @return JSON string
  */
