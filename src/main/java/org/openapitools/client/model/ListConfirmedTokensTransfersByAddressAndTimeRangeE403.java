...
public class ListConfirmedTokensTransfersByAddressAndTimeRangeE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTokensTransfersByAddressAndTimeRangeE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTokensTransfersByAddressAndTimeRangeE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTokensTransfersByAddressAndTimeRangeE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTokensTransfersByAddressAndTimeRangeE403>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTokensTransfersByAddressAndTimeRangeE403 value) throws IOException {
                ...
                @Override
                public ListConfirmedTokensTransfersByAddressAndTimeRangeE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTokensTransfersByAddressAndTimeRangeE403 ret = new ListConfirmedTokensTransfersByAddressAndTimeRangeE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTokensTransfersByAddressAndTimeRangeE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTokensTransfersByAddressAndTimeRangeE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTokensTransfersByAddressAndTimeRangeE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTokensTransfersByAddressAndTimeRangeE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTokensTransfersByAddressAndTimeRangeE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTokensTransfersByAddressAndTimeRangeE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE403
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTokensTransfersByAddressAndTimeRangeE403
  */
  public static ListConfirmedTokensTransfersByAddressAndTimeRangeE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTokensTransfersByAddressAndTimeRangeE403.class);
  }

 /**
  * Convert an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE403 to an JSON string
  *
  * @return JSON string
  */
