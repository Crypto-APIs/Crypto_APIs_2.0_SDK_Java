...
public class GetWalletAssetDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetWalletAssetDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetWalletAssetDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetWalletAssetDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetWalletAssetDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetWalletAssetDetailsE400 value) throws IOException {
                ...
                @Override
                public GetWalletAssetDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetWalletAssetDetailsE400 ret = new GetWalletAssetDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetWalletAssetDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetWalletAssetDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetWalletAssetDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletAssetDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetWalletAssetDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWalletAssetDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetWalletAssetDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetWalletAssetDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetWalletAssetDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetWalletAssetDetailsE400
  */
  public static GetWalletAssetDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWalletAssetDetailsE400.class);
  }

 /**
  * Convert an instance of GetWalletAssetDetailsE400 to an JSON string
  *
  * @return JSON string
  */
