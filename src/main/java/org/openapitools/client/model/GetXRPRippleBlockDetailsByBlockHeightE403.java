...
public class GetXRPRippleBlockDetailsByBlockHeightE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleBlockDetailsByBlockHeightE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleBlockDetailsByBlockHeightE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleBlockDetailsByBlockHeightE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleBlockDetailsByBlockHeightE403>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleBlockDetailsByBlockHeightE403 value) throws IOException {
                ...
                @Override
                public GetXRPRippleBlockDetailsByBlockHeightE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleBlockDetailsByBlockHeightE403 ret = new GetXRPRippleBlockDetailsByBlockHeightE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleBlockDetailsByBlockHeightE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleBlockDetailsByBlockHeightE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHeightE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleBlockDetailsByBlockHeightE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleBlockDetailsByBlockHeightE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleBlockDetailsByBlockHeightE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleBlockDetailsByBlockHeightE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleBlockDetailsByBlockHeightE403
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleBlockDetailsByBlockHeightE403
  */
  public static GetXRPRippleBlockDetailsByBlockHeightE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleBlockDetailsByBlockHeightE403.class);
  }

 /**
  * Convert an instance of GetXRPRippleBlockDetailsByBlockHeightE403 to an JSON string
  *
  * @return JSON string
  */
