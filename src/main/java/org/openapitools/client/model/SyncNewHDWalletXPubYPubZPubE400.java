...
public class SyncNewHDWalletXPubYPubZPubE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncNewHDWalletXPubYPubZPubE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncNewHDWalletXPubYPubZPubE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncNewHDWalletXPubYPubZPubE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncNewHDWalletXPubYPubZPubE400>() {
                @Override
                public void write(JsonWriter out, SyncNewHDWalletXPubYPubZPubE400 value) throws IOException {
                ...
                @Override
                public SyncNewHDWalletXPubYPubZPubE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncNewHDWalletXPubYPubZPubE400 ret = new SyncNewHDWalletXPubYPubZPubE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncNewHDWalletXPubYPubZPubE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncNewHDWalletXPubYPubZPubE400() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncNewHDWalletXPubYPubZPubE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE400(XpubNotSynced o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncNewHDWalletXPubYPubZPubE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncNewHDWalletXPubYPubZPubE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncNewHDWalletXPubYPubZPubE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncNewHDWalletXPubYPubZPubE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncNewHDWalletXPubYPubZPubE400
  * @throws IOException if the JSON string is invalid with respect to SyncNewHDWalletXPubYPubZPubE400
  */
  public static SyncNewHDWalletXPubYPubZPubE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncNewHDWalletXPubYPubZPubE400.class);
  }

 /**
  * Convert an instance of SyncNewHDWalletXPubYPubZPubE400 to an JSON string
  *
  * @return JSON string
  */
