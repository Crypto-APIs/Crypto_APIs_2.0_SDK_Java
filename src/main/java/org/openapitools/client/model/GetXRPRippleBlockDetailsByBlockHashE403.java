...
public class GetXRPRippleBlockDetailsByBlockHashE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleBlockDetailsByBlockHashE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleBlockDetailsByBlockHashE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleBlockDetailsByBlockHashE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleBlockDetailsByBlockHashE403>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleBlockDetailsByBlockHashE403 value) throws IOException {
                ...
                @Override
                public GetXRPRippleBlockDetailsByBlockHashE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleBlockDetailsByBlockHashE403 ret = new GetXRPRippleBlockDetailsByBlockHashE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleBlockDetailsByBlockHashE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleBlockDetailsByBlockHashE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleBlockDetailsByBlockHashE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleBlockDetailsByBlockHashE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleBlockDetailsByBlockHashE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleBlockDetailsByBlockHashE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleBlockDetailsByBlockHashE403
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE403
  */
  public static GetXRPRippleBlockDetailsByBlockHashE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleBlockDetailsByBlockHashE403.class);
  }

 /**
  * Convert an instance of GetXRPRippleBlockDetailsByBlockHashE403 to an JSON string
  *
  * @return JSON string
  */
