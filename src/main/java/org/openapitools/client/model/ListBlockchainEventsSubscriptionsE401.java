...
public class ListBlockchainEventsSubscriptionsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListBlockchainEventsSubscriptionsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListBlockchainEventsSubscriptionsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListBlockchainEventsSubscriptionsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListBlockchainEventsSubscriptionsE401>() {
                @Override
                public void write(JsonWriter out, ListBlockchainEventsSubscriptionsE401 value) throws IOException {
                ...
                @Override
                public ListBlockchainEventsSubscriptionsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListBlockchainEventsSubscriptionsE401 ret = new ListBlockchainEventsSubscriptionsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListBlockchainEventsSubscriptionsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListBlockchainEventsSubscriptionsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListBlockchainEventsSubscriptionsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListBlockchainEventsSubscriptionsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListBlockchainEventsSubscriptionsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListBlockchainEventsSubscriptionsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListBlockchainEventsSubscriptionsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListBlockchainEventsSubscriptionsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListBlockchainEventsSubscriptionsE401
  * @throws IOException if the JSON string is invalid with respect to ListBlockchainEventsSubscriptionsE401
  */
  public static ListBlockchainEventsSubscriptionsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListBlockchainEventsSubscriptionsE401.class);
  }

 /**
  * Convert an instance of ListBlockchainEventsSubscriptionsE401 to an JSON string
  *
  * @return JSON string
  */
