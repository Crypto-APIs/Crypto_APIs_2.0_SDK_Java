...
public class NewConfirmedCoinsTransactionsAndEachConfirmationE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsAndEachConfirmationE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsAndEachConfirmationE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsAndEachConfirmationE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsAndEachConfirmationE409>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsAndEachConfirmationE409 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsAndEachConfirmationE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsAndEachConfirmationE409 ret = new NewConfirmedCoinsTransactionsAndEachConfirmationE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsAndEachConfirmationE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsAndEachConfirmationE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsAndEachConfirmationE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsAndEachConfirmationE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsAndEachConfirmationE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsAndEachConfirmationE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsAndEachConfirmationE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsAndEachConfirmationE409
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsAndEachConfirmationE409
  */
  public static NewConfirmedCoinsTransactionsAndEachConfirmationE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsAndEachConfirmationE409.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsAndEachConfirmationE409 to an JSON string
  *
  * @return JSON string
  */
