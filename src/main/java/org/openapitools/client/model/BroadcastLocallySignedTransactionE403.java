...
public class BroadcastLocallySignedTransactionE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BroadcastLocallySignedTransactionE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BroadcastLocallySignedTransactionE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BroadcastLocallySignedTransactionE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BroadcastLocallySignedTransactionE403>() {
                @Override
                public void write(JsonWriter out, BroadcastLocallySignedTransactionE403 value) throws IOException {
                ...
                @Override
                public BroadcastLocallySignedTransactionE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BroadcastLocallySignedTransactionE403 ret = new BroadcastLocallySignedTransactionE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BroadcastLocallySignedTransactionE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BroadcastLocallySignedTransactionE403() {
        super("oneOf", Boolean.FALSE);
    }

    public BroadcastLocallySignedTransactionE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BroadcastLocallySignedTransactionE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BroadcastLocallySignedTransactionE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BroadcastLocallySignedTransactionE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BroadcastLocallySignedTransactionE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BroadcastLocallySignedTransactionE403
  * @throws IOException if the JSON string is invalid with respect to BroadcastLocallySignedTransactionE403
  */
  public static BroadcastLocallySignedTransactionE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BroadcastLocallySignedTransactionE403.class);
  }

 /**
  * Convert an instance of BroadcastLocallySignedTransactionE403 to an JSON string
  *
  * @return JSON string
  */
