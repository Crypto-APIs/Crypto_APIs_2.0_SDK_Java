...
public class CreateAutomaticTokensForwardingE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateAutomaticTokensForwardingE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAutomaticTokensForwardingE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAutomaticTokensForwardingE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateAutomaticTokensForwardingE401>() {
                @Override
                public void write(JsonWriter out, CreateAutomaticTokensForwardingE401 value) throws IOException {
                ...
                @Override
                public CreateAutomaticTokensForwardingE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateAutomaticTokensForwardingE401 ret = new CreateAutomaticTokensForwardingE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateAutomaticTokensForwardingE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateAutomaticTokensForwardingE401() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAutomaticTokensForwardingE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateAutomaticTokensForwardingE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAutomaticTokensForwardingE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateAutomaticTokensForwardingE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateAutomaticTokensForwardingE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAutomaticTokensForwardingE401
  * @throws IOException if the JSON string is invalid with respect to CreateAutomaticTokensForwardingE401
  */
  public static CreateAutomaticTokensForwardingE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAutomaticTokensForwardingE401.class);
  }

 /**
  * Convert an instance of CreateAutomaticTokensForwardingE401 to an JSON string
  *
  * @return JSON string
  */
