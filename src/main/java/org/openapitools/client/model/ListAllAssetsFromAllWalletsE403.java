...
public class ListAllAssetsFromAllWalletsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllAssetsFromAllWalletsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsFromAllWalletsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsFromAllWalletsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsFromAllWalletsE403>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsFromAllWalletsE403 value) throws IOException {
                ...
                @Override
                public ListAllAssetsFromAllWalletsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsFromAllWalletsE403 ret = new ListAllAssetsFromAllWalletsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsFromAllWalletsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsFromAllWalletsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllAssetsFromAllWalletsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsFromAllWalletsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsFromAllWalletsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsFromAllWalletsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsFromAllWalletsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsFromAllWalletsE403
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsFromAllWalletsE403
  */
  public static ListAllAssetsFromAllWalletsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsFromAllWalletsE403.class);
  }

 /**
  * Convert an instance of ListAllAssetsFromAllWalletsE403 to an JSON string
  *
  * @return JSON string
  */
