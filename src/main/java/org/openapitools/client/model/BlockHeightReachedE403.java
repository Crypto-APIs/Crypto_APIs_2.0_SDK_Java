...
public class BlockHeightReachedE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BlockHeightReachedE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BlockHeightReachedE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BlockHeightReachedE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BlockHeightReachedE403>() {
                @Override
                public void write(JsonWriter out, BlockHeightReachedE403 value) throws IOException {
                ...
                @Override
                public BlockHeightReachedE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BlockHeightReachedE403 ret = new BlockHeightReachedE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BlockHeightReachedE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BlockHeightReachedE403() {
        super("oneOf", Boolean.FALSE);
    }

    public BlockHeightReachedE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BlockHeightReachedE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BlockHeightReachedE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BlockHeightReachedE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BlockHeightReachedE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BlockHeightReachedE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BlockHeightReachedE403
  * @throws IOException if the JSON string is invalid with respect to BlockHeightReachedE403
  */
  public static BlockHeightReachedE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockHeightReachedE403.class);
  }

 /**
  * Convert an instance of BlockHeightReachedE403 to an JSON string
  *
  * @return JSON string
  */
