...
public class GetXRPRippleAddressDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleAddressDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleAddressDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleAddressDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleAddressDetailsE401>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleAddressDetailsE401 value) throws IOException {
                ...
                @Override
                public GetXRPRippleAddressDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleAddressDetailsE401 ret = new GetXRPRippleAddressDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleAddressDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleAddressDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleAddressDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleAddressDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleAddressDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleAddressDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleAddressDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleAddressDetailsE401
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleAddressDetailsE401
  */
  public static GetXRPRippleAddressDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleAddressDetailsE401.class);
  }

 /**
  * Convert an instance of GetXRPRippleAddressDetailsE401 to an JSON string
  *
  * @return JSON string
  */
