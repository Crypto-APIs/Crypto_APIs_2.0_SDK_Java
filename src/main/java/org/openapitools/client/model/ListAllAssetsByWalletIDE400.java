...
public class ListAllAssetsByWalletIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllAssetsByWalletIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsByWalletIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsByWalletIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsByWalletIDE400>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsByWalletIDE400 value) throws IOException {
                ...
                @Override
                public ListAllAssetsByWalletIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsByWalletIDE400 ret = new ListAllAssetsByWalletIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsByWalletIDE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsByWalletIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllAssetsByWalletIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsByWalletIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsByWalletIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsByWalletIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsByWalletIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsByWalletIDE400
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsByWalletIDE400
  */
  public static ListAllAssetsByWalletIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsByWalletIDE400.class);
  }

 /**
  * Convert an instance of ListAllAssetsByWalletIDE400 to an JSON string
  *
  * @return JSON string
  */
