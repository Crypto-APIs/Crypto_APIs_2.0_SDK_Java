...
public class NewConfirmedTokenTransactionsForSpecificAmountE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokenTransactionsForSpecificAmountE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokenTransactionsForSpecificAmountE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokenTransactionsForSpecificAmountE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokenTransactionsForSpecificAmountE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokenTransactionsForSpecificAmountE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokenTransactionsForSpecificAmountE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokenTransactionsForSpecificAmountE400 ret = new NewConfirmedTokenTransactionsForSpecificAmountE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokenTransactionsForSpecificAmountE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokenTransactionsForSpecificAmountE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokenTransactionsForSpecificAmountE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokenTransactionsForSpecificAmountE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokenTransactionsForSpecificAmountE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokenTransactionsForSpecificAmountE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokenTransactionsForSpecificAmountE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokenTransactionsForSpecificAmountE400
  */
  public static NewConfirmedTokenTransactionsForSpecificAmountE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokenTransactionsForSpecificAmountE400.class);
  }

 /**
  * Convert an instance of NewConfirmedTokenTransactionsForSpecificAmountE400 to an JSON string
  *
  * @return JSON string
  */
