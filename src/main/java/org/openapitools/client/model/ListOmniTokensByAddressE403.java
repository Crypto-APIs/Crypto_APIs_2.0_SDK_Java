...
public class ListOmniTokensByAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTokensByAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTokensByAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTokensByAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTokensByAddressE403>() {
                @Override
                public void write(JsonWriter out, ListOmniTokensByAddressE403 value) throws IOException {
                ...
                @Override
                public ListOmniTokensByAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTokensByAddressE403 ret = new ListOmniTokensByAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTokensByAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTokensByAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTokensByAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTokensByAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTokensByAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTokensByAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTokensByAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTokensByAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTokensByAddressE403
  * @throws IOException if the JSON string is invalid with respect to ListOmniTokensByAddressE403
  */
  public static ListOmniTokensByAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTokensByAddressE403.class);
  }

 /**
  * Convert an instance of ListOmniTokensByAddressE403 to an JSON string
  *
  * @return JSON string
  */
