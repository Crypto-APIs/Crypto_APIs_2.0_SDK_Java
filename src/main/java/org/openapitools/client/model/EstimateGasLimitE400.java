...
public class EstimateGasLimitE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateGasLimitE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateGasLimitE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateGasLimitE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateGasLimitE400>() {
                @Override
                public void write(JsonWriter out, EstimateGasLimitE400 value) throws IOException {
                ...
                @Override
                public EstimateGasLimitE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateGasLimitE400 ret = new EstimateGasLimitE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateGasLimitE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateGasLimitE400() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateGasLimitE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateGasLimitE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateGasLimitE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateGasLimitE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateGasLimitE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateGasLimitE400
  * @throws IOException if the JSON string is invalid with respect to EstimateGasLimitE400
  */
  public static EstimateGasLimitE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateGasLimitE400.class);
  }

 /**
  * Convert an instance of EstimateGasLimitE400 to an JSON string
  *
  * @return JSON string
  */
