...
public class NewConfirmedInternalTransactionsAndEachConfirmationE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsAndEachConfirmationE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsAndEachConfirmationE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsAndEachConfirmationE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsAndEachConfirmationE409>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsAndEachConfirmationE409 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsAndEachConfirmationE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsAndEachConfirmationE409 ret = new NewConfirmedInternalTransactionsAndEachConfirmationE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsAndEachConfirmationE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsAndEachConfirmationE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsAndEachConfirmationE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsAndEachConfirmationE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsAndEachConfirmationE409
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE409
  */
  public static NewConfirmedInternalTransactionsAndEachConfirmationE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsAndEachConfirmationE409.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsAndEachConfirmationE409 to an JSON string
  *
  * @return JSON string
  */
