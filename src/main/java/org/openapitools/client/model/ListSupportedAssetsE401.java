...
public class ListSupportedAssetsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSupportedAssetsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSupportedAssetsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSupportedAssetsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSupportedAssetsE401>() {
                @Override
                public void write(JsonWriter out, ListSupportedAssetsE401 value) throws IOException {
                ...
                @Override
                public ListSupportedAssetsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSupportedAssetsE401 ret = new ListSupportedAssetsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSupportedAssetsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSupportedAssetsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSupportedAssetsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedAssetsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSupportedAssetsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSupportedAssetsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSupportedAssetsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSupportedAssetsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSupportedAssetsE401
  * @throws IOException if the JSON string is invalid with respect to ListSupportedAssetsE401
  */
  public static ListSupportedAssetsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedAssetsE401.class);
  }

 /**
  * Convert an instance of ListSupportedAssetsE401 to an JSON string
  *
  * @return JSON string
  */
