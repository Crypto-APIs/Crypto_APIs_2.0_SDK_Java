...
public class GetTokenDetailsByContractAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTokenDetailsByContractAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTokenDetailsByContractAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTokenDetailsByContractAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTokenDetailsByContractAddressE401>() {
                @Override
                public void write(JsonWriter out, GetTokenDetailsByContractAddressE401 value) throws IOException {
                ...
                @Override
                public GetTokenDetailsByContractAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTokenDetailsByContractAddressE401 ret = new GetTokenDetailsByContractAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTokenDetailsByContractAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTokenDetailsByContractAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTokenDetailsByContractAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTokenDetailsByContractAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTokenDetailsByContractAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTokenDetailsByContractAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTokenDetailsByContractAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTokenDetailsByContractAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTokenDetailsByContractAddressE401
  * @throws IOException if the JSON string is invalid with respect to GetTokenDetailsByContractAddressE401
  */
  public static GetTokenDetailsByContractAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTokenDetailsByContractAddressE401.class);
  }

 /**
  * Convert an instance of GetTokenDetailsByContractAddressE401 to an JSON string
  *
  * @return JSON string
  */
