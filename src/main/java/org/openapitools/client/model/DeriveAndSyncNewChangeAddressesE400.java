...
public class DeriveAndSyncNewChangeAddressesE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewChangeAddressesE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewChangeAddressesE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewChangeAddressesE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewChangeAddressesE400>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewChangeAddressesE400 value) throws IOException {
                ...
                @Override
                public DeriveAndSyncNewChangeAddressesE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewChangeAddressesE400 ret = new DeriveAndSyncNewChangeAddressesE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewChangeAddressesE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewChangeAddressesE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewChangeAddressesE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewChangeAddressesE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewChangeAddressesE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewChangeAddressesE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewChangeAddressesE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewChangeAddressesE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewChangeAddressesE400
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewChangeAddressesE400
  */
  public static DeriveAndSyncNewChangeAddressesE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewChangeAddressesE400.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewChangeAddressesE400 to an JSON string
  *
  * @return JSON string
  */
