...
public class ListTokensForwardingAutomationsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensForwardingAutomationsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensForwardingAutomationsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensForwardingAutomationsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensForwardingAutomationsE401>() {
                @Override
                public void write(JsonWriter out, ListTokensForwardingAutomationsE401 value) throws IOException {
                ...
                @Override
                public ListTokensForwardingAutomationsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensForwardingAutomationsE401 ret = new ListTokensForwardingAutomationsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensForwardingAutomationsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensForwardingAutomationsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensForwardingAutomationsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensForwardingAutomationsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensForwardingAutomationsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensForwardingAutomationsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensForwardingAutomationsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensForwardingAutomationsE401
  * @throws IOException if the JSON string is invalid with respect to ListTokensForwardingAutomationsE401
  */
  public static ListTokensForwardingAutomationsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensForwardingAutomationsE401.class);
  }

 /**
  * Convert an instance of ListTokensForwardingAutomationsE401 to an JSON string
  *
  * @return JSON string
  */
