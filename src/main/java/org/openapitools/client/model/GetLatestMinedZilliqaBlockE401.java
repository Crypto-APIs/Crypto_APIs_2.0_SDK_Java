...
public class GetLatestMinedZilliqaBlockE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedZilliqaBlockE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedZilliqaBlockE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedZilliqaBlockE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedZilliqaBlockE401>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedZilliqaBlockE401 value) throws IOException {
                ...
                @Override
                public GetLatestMinedZilliqaBlockE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedZilliqaBlockE401 ret = new GetLatestMinedZilliqaBlockE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedZilliqaBlockE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedZilliqaBlockE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedZilliqaBlockE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedZilliqaBlockE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedZilliqaBlockE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedZilliqaBlockE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedZilliqaBlockE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedZilliqaBlockE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedZilliqaBlockE401
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedZilliqaBlockE401
  */
  public static GetLatestMinedZilliqaBlockE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedZilliqaBlockE401.class);
  }

 /**
  * Convert an instance of GetLatestMinedZilliqaBlockE401 to an JSON string
  *
  * @return JSON string
  */
