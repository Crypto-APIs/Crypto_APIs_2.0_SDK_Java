...
public class CreateCoinsTransactionRequestFromWalletE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCoinsTransactionRequestFromWalletE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCoinsTransactionRequestFromWalletE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCoinsTransactionRequestFromWalletE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCoinsTransactionRequestFromWalletE400>() {
                @Override
                public void write(JsonWriter out, CreateCoinsTransactionRequestFromWalletE400 value) throws IOException {
                ...
                @Override
                public CreateCoinsTransactionRequestFromWalletE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCoinsTransactionRequestFromWalletE400 ret = new CreateCoinsTransactionRequestFromWalletE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCoinsTransactionRequestFromWalletE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCoinsTransactionRequestFromWalletE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCoinsTransactionRequestFromWalletE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCoinsTransactionRequestFromWalletE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCoinsTransactionRequestFromWalletE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCoinsTransactionRequestFromWalletE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCoinsTransactionRequestFromWalletE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCoinsTransactionRequestFromWalletE400
  * @throws IOException if the JSON string is invalid with respect to CreateCoinsTransactionRequestFromWalletE400
  */
  public static CreateCoinsTransactionRequestFromWalletE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCoinsTransactionRequestFromWalletE400.class);
  }

 /**
  * Convert an instance of CreateCoinsTransactionRequestFromWalletE400 to an JSON string
  *
  * @return JSON string
  */
