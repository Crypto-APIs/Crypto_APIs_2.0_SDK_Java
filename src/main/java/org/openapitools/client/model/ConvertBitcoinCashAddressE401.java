...
public class ConvertBitcoinCashAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ConvertBitcoinCashAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ConvertBitcoinCashAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ConvertBitcoinCashAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ConvertBitcoinCashAddressE401>() {
                @Override
                public void write(JsonWriter out, ConvertBitcoinCashAddressE401 value) throws IOException {
                ...
                @Override
                public ConvertBitcoinCashAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ConvertBitcoinCashAddressE401 ret = new ConvertBitcoinCashAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ConvertBitcoinCashAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ConvertBitcoinCashAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ConvertBitcoinCashAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ConvertBitcoinCashAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConvertBitcoinCashAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ConvertBitcoinCashAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ConvertBitcoinCashAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConvertBitcoinCashAddressE401
  * @throws IOException if the JSON string is invalid with respect to ConvertBitcoinCashAddressE401
  */
  public static ConvertBitcoinCashAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertBitcoinCashAddressE401.class);
  }

 /**
  * Convert an instance of ConvertBitcoinCashAddressE401 to an JSON string
  *
  * @return JSON string
  */
