...
public class GetNextAvailableNonceE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetNextAvailableNonceE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetNextAvailableNonceE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetNextAvailableNonceE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetNextAvailableNonceE403>() {
                @Override
                public void write(JsonWriter out, GetNextAvailableNonceE403 value) throws IOException {
                ...
                @Override
                public GetNextAvailableNonceE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetNextAvailableNonceE403 ret = new GetNextAvailableNonceE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetNextAvailableNonceE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetNextAvailableNonceE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetNextAvailableNonceE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetNextAvailableNonceE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetNextAvailableNonceE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetNextAvailableNonceE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetNextAvailableNonceE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetNextAvailableNonceE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetNextAvailableNonceE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetNextAvailableNonceE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetNextAvailableNonceE403
  * @throws IOException if the JSON string is invalid with respect to GetNextAvailableNonceE403
  */
  public static GetNextAvailableNonceE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNextAvailableNonceE403.class);
  }

 /**
  * Convert an instance of GetNextAvailableNonceE403 to an JSON string
  *
  * @return JSON string
  */
