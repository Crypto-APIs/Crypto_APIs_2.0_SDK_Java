...
public class CreateCoinsTransactionRequestFromWalletE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCoinsTransactionRequestFromWalletE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCoinsTransactionRequestFromWalletE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCoinsTransactionRequestFromWalletE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCoinsTransactionRequestFromWalletE401>() {
                @Override
                public void write(JsonWriter out, CreateCoinsTransactionRequestFromWalletE401 value) throws IOException {
                ...
                @Override
                public CreateCoinsTransactionRequestFromWalletE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCoinsTransactionRequestFromWalletE401 ret = new CreateCoinsTransactionRequestFromWalletE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCoinsTransactionRequestFromWalletE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCoinsTransactionRequestFromWalletE401() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCoinsTransactionRequestFromWalletE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionRequestFromWalletE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCoinsTransactionRequestFromWalletE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCoinsTransactionRequestFromWalletE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCoinsTransactionRequestFromWalletE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCoinsTransactionRequestFromWalletE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCoinsTransactionRequestFromWalletE401
  * @throws IOException if the JSON string is invalid with respect to CreateCoinsTransactionRequestFromWalletE401
  */
  public static CreateCoinsTransactionRequestFromWalletE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCoinsTransactionRequestFromWalletE401.class);
  }

 /**
  * Convert an instance of CreateCoinsTransactionRequestFromWalletE401 to an JSON string
  *
  * @return JSON string
  */
