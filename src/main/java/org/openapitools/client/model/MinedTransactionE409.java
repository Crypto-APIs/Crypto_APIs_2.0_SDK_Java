...
public class MinedTransactionE409 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MinedTransactionE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MinedTransactionE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MinedTransactionE409>() {
                @Override
                public void write(JsonWriter out, MinedTransactionE409 value) throws IOException {
                ...
                @Override
                public MinedTransactionE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        MinedTransactionE409 ret = new MinedTransactionE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for MinedTransactionE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MinedTransactionE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return MinedTransactionE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MinedTransactionE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for MinedTransactionE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of MinedTransactionE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MinedTransactionE409
  * @throws IOException if the JSON string is invalid with respect to MinedTransactionE409
  */
  public static MinedTransactionE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MinedTransactionE409.class);
  }

 /**
  * Convert an instance of MinedTransactionE409 to an JSON string
  *
  * @return JSON string
  */
