...
public class SyncNewHDWalletXPubYPubZPubE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncNewHDWalletXPubYPubZPubE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncNewHDWalletXPubYPubZPubE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncNewHDWalletXPubYPubZPubE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncNewHDWalletXPubYPubZPubE409>() {
                @Override
                public void write(JsonWriter out, SyncNewHDWalletXPubYPubZPubE409 value) throws IOException {
                ...
                @Override
                public SyncNewHDWalletXPubYPubZPubE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncNewHDWalletXPubYPubZPubE409 ret = new SyncNewHDWalletXPubYPubZPubE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncNewHDWalletXPubYPubZPubE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncNewHDWalletXPubYPubZPubE409() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncNewHDWalletXPubYPubZPubE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncNewHDWalletXPubYPubZPubE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncNewHDWalletXPubYPubZPubE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncNewHDWalletXPubYPubZPubE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncNewHDWalletXPubYPubZPubE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncNewHDWalletXPubYPubZPubE409
  * @throws IOException if the JSON string is invalid with respect to SyncNewHDWalletXPubYPubZPubE409
  */
  public static SyncNewHDWalletXPubYPubZPubE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncNewHDWalletXPubYPubZPubE409.class);
  }

 /**
  * Convert an instance of SyncNewHDWalletXPubYPubZPubE409 to an JSON string
  *
  * @return JSON string
  */
