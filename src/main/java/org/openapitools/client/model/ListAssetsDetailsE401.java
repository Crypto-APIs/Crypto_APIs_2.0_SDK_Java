...
public class ListAssetsDetailsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAssetsDetailsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAssetsDetailsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAssetsDetailsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAssetsDetailsE401>() {
                @Override
                public void write(JsonWriter out, ListAssetsDetailsE401 value) throws IOException {
                ...
                @Override
                public ListAssetsDetailsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAssetsDetailsE401 ret = new ListAssetsDetailsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAssetsDetailsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAssetsDetailsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAssetsDetailsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAssetsDetailsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAssetsDetailsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAssetsDetailsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAssetsDetailsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAssetsDetailsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAssetsDetailsE401
  * @throws IOException if the JSON string is invalid with respect to ListAssetsDetailsE401
  */
  public static ListAssetsDetailsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssetsDetailsE401.class);
  }

 /**
  * Convert an instance of ListAssetsDetailsE401 to an JSON string
  *
  * @return JSON string
  */
