...
public class GetAddressDetailsFromCallbackE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressDetailsFromCallbackE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressDetailsFromCallbackE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressDetailsFromCallbackE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressDetailsFromCallbackE401>() {
                @Override
                public void write(JsonWriter out, GetAddressDetailsFromCallbackE401 value) throws IOException {
                ...
                @Override
                public GetAddressDetailsFromCallbackE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressDetailsFromCallbackE401 ret = new GetAddressDetailsFromCallbackE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressDetailsFromCallbackE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressDetailsFromCallbackE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressDetailsFromCallbackE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressDetailsFromCallbackE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressDetailsFromCallbackE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressDetailsFromCallbackE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressDetailsFromCallbackE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressDetailsFromCallbackE401
  * @throws IOException if the JSON string is invalid with respect to GetAddressDetailsFromCallbackE401
  */
  public static GetAddressDetailsFromCallbackE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressDetailsFromCallbackE401.class);
  }

 /**
  * Convert an instance of GetAddressDetailsFromCallbackE401 to an JSON string
  *
  * @return JSON string
  */
