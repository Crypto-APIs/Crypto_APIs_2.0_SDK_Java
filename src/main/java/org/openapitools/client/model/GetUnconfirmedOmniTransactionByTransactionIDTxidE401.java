...
public class GetUnconfirmedOmniTransactionByTransactionIDTxidE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetUnconfirmedOmniTransactionByTransactionIDTxidE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUnconfirmedOmniTransactionByTransactionIDTxidE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUnconfirmedOmniTransactionByTransactionIDTxidE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetUnconfirmedOmniTransactionByTransactionIDTxidE401>() {
                @Override
                public void write(JsonWriter out, GetUnconfirmedOmniTransactionByTransactionIDTxidE401 value) throws IOException {
                ...
                @Override
                public GetUnconfirmedOmniTransactionByTransactionIDTxidE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetUnconfirmedOmniTransactionByTransactionIDTxidE401 ret = new GetUnconfirmedOmniTransactionByTransactionIDTxidE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetUnconfirmedOmniTransactionByTransactionIDTxidE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetUnconfirmedOmniTransactionByTransactionIDTxidE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetUnconfirmedOmniTransactionByTransactionIDTxidE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetUnconfirmedOmniTransactionByTransactionIDTxidE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetUnconfirmedOmniTransactionByTransactionIDTxidE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE401
  * @throws IOException if the JSON string is invalid with respect to GetUnconfirmedOmniTransactionByTransactionIDTxidE401
  */
  public static GetUnconfirmedOmniTransactionByTransactionIDTxidE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUnconfirmedOmniTransactionByTransactionIDTxidE401.class);
  }

 /**
  * Convert an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidE401 to an JSON string
  *
  * @return JSON string
  */
