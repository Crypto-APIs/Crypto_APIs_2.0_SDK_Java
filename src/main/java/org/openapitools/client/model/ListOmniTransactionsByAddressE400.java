...
public class ListOmniTransactionsByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListOmniTransactionsByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListOmniTransactionsByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListOmniTransactionsByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListOmniTransactionsByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListOmniTransactionsByAddressE400 value) throws IOException {
                ...
                @Override
                public ListOmniTransactionsByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListOmniTransactionsByAddressE400 ret = new ListOmniTransactionsByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListOmniTransactionsByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListOmniTransactionsByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListOmniTransactionsByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListOmniTransactionsByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListOmniTransactionsByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListOmniTransactionsByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListOmniTransactionsByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListOmniTransactionsByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListOmniTransactionsByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListOmniTransactionsByAddressE400
  */
  public static ListOmniTransactionsByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOmniTransactionsByAddressE400.class);
  }

 /**
  * Convert an instance of ListOmniTransactionsByAddressE400 to an JSON string
  *
  * @return JSON string
  */
