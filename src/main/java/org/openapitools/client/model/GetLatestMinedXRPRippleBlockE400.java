...
public class GetLatestMinedXRPRippleBlockE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetLatestMinedXRPRippleBlockE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLatestMinedXRPRippleBlockE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetLatestMinedXRPRippleBlockE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLatestMinedXRPRippleBlockE400>() {
                @Override
                public void write(JsonWriter out, GetLatestMinedXRPRippleBlockE400 value) throws IOException {
                ...
                @Override
                public GetLatestMinedXRPRippleBlockE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetLatestMinedXRPRippleBlockE400 ret = new GetLatestMinedXRPRippleBlockE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetLatestMinedXRPRippleBlockE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetLatestMinedXRPRippleBlockE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetLatestMinedXRPRippleBlockE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetLatestMinedXRPRippleBlockE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetLatestMinedXRPRippleBlockE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetLatestMinedXRPRippleBlockE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetLatestMinedXRPRippleBlockE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetLatestMinedXRPRippleBlockE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLatestMinedXRPRippleBlockE400
  * @throws IOException if the JSON string is invalid with respect to GetLatestMinedXRPRippleBlockE400
  */
  public static GetLatestMinedXRPRippleBlockE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLatestMinedXRPRippleBlockE400.class);
  }

 /**
  * Convert an instance of GetLatestMinedXRPRippleBlockE400 to an JSON string
  *
  * @return JSON string
  */
