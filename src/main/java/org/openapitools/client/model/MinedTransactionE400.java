...
public class MinedTransactionE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MinedTransactionE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MinedTransactionE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MinedTransactionE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MinedTransactionE400>() {
                @Override
                public void write(JsonWriter out, MinedTransactionE400 value) throws IOException {
                ...
                @Override
                public MinedTransactionE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        MinedTransactionE400 ret = new MinedTransactionE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for MinedTransactionE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MinedTransactionE400() {
        super("oneOf", Boolean.FALSE);
    }

    public MinedTransactionE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return MinedTransactionE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MinedTransactionE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for MinedTransactionE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of MinedTransactionE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MinedTransactionE400
  * @throws IOException if the JSON string is invalid with respect to MinedTransactionE400
  */
  public static MinedTransactionE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MinedTransactionE400.class);
  }

 /**
  * Convert an instance of MinedTransactionE400 to an JSON string
  *
  * @return JSON string
  */
