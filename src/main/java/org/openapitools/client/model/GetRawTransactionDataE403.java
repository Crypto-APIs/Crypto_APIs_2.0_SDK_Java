...
public class GetRawTransactionDataE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetRawTransactionDataE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRawTransactionDataE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRawTransactionDataE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetRawTransactionDataE403>() {
                @Override
                public void write(JsonWriter out, GetRawTransactionDataE403 value) throws IOException {
                ...
                @Override
                public GetRawTransactionDataE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetRawTransactionDataE403 ret = new GetRawTransactionDataE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetRawTransactionDataE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetRawTransactionDataE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetRawTransactionDataE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetRawTransactionDataE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetRawTransactionDataE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetRawTransactionDataE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetRawTransactionDataE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetRawTransactionDataE403
  * @throws IOException if the JSON string is invalid with respect to GetRawTransactionDataE403
  */
  public static GetRawTransactionDataE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRawTransactionDataE403.class);
  }

 /**
  * Convert an instance of GetRawTransactionDataE403 to an JSON string
  *
  * @return JSON string
  */
