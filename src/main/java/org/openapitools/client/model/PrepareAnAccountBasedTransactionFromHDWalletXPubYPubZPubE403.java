...
public class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403>() {
                @Override
                public void write(JsonWriter out, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 value) throws IOException {
                ...
                @Override
                public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 ret = new PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403
  * @throws IOException if the JSON string is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403
  */
  public static PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.class);
  }

 /**
  * Convert an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 to an JSON string
  *
  * @return JSON string
  */
