...
public class GetXRPRippleTransactionDetailsByTransactionIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleTransactionDetailsByTransactionIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleTransactionDetailsByTransactionIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleTransactionDetailsByTransactionIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleTransactionDetailsByTransactionIDE403>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleTransactionDetailsByTransactionIDE403 value) throws IOException {
                ...
                @Override
                public GetXRPRippleTransactionDetailsByTransactionIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleTransactionDetailsByTransactionIDE403 ret = new GetXRPRippleTransactionDetailsByTransactionIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleTransactionDetailsByTransactionIDE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleTransactionDetailsByTransactionIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleTransactionDetailsByTransactionIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleTransactionDetailsByTransactionIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleTransactionDetailsByTransactionIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleTransactionDetailsByTransactionIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleTransactionDetailsByTransactionIDE403
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleTransactionDetailsByTransactionIDE403
  */
  public static GetXRPRippleTransactionDetailsByTransactionIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleTransactionDetailsByTransactionIDE403.class);
  }

 /**
  * Convert an instance of GetXRPRippleTransactionDetailsByTransactionIDE403 to an JSON string
  *
  * @return JSON string
  */
