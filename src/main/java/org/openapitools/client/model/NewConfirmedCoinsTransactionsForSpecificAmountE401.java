...
public class NewConfirmedCoinsTransactionsForSpecificAmountE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedCoinsTransactionsForSpecificAmountE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedCoinsTransactionsForSpecificAmountE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedCoinsTransactionsForSpecificAmountE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedCoinsTransactionsForSpecificAmountE401>() {
                @Override
                public void write(JsonWriter out, NewConfirmedCoinsTransactionsForSpecificAmountE401 value) throws IOException {
                ...
                @Override
                public NewConfirmedCoinsTransactionsForSpecificAmountE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedCoinsTransactionsForSpecificAmountE401 ret = new NewConfirmedCoinsTransactionsForSpecificAmountE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedCoinsTransactionsForSpecificAmountE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedCoinsTransactionsForSpecificAmountE401() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedCoinsTransactionsForSpecificAmountE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedCoinsTransactionsForSpecificAmountE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedCoinsTransactionsForSpecificAmountE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedCoinsTransactionsForSpecificAmountE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedCoinsTransactionsForSpecificAmountE401
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedCoinsTransactionsForSpecificAmountE401
  */
  public static NewConfirmedCoinsTransactionsForSpecificAmountE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedCoinsTransactionsForSpecificAmountE401.class);
  }

 /**
  * Convert an instance of NewConfirmedCoinsTransactionsForSpecificAmountE401 to an JSON string
  *
  * @return JSON string
  */
