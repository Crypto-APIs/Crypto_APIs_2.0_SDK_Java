...
public class GetBlockDetailsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHashE401 ret = new GetBlockDetailsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHashE401
  */
  public static GetBlockDetailsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHashE401.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
