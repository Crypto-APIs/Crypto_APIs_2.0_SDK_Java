...
public class ListInternalTransactionsByAddressAndTimeRangeE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionsByAddressAndTimeRangeE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionsByAddressAndTimeRangeE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionsByAddressAndTimeRangeE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionsByAddressAndTimeRangeE400>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionsByAddressAndTimeRangeE400 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionsByAddressAndTimeRangeE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionsByAddressAndTimeRangeE400 ret = new ListInternalTransactionsByAddressAndTimeRangeE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionsByAddressAndTimeRangeE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionsByAddressAndTimeRangeE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionsByAddressAndTimeRangeE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionsByAddressAndTimeRangeE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionsByAddressAndTimeRangeE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionsByAddressAndTimeRangeE400
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE400
  */
  public static ListInternalTransactionsByAddressAndTimeRangeE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionsByAddressAndTimeRangeE400.class);
  }

 /**
  * Convert an instance of ListInternalTransactionsByAddressAndTimeRangeE400 to an JSON string
  *
  * @return JSON string
  */
