...
public class ListUnconfirmedTransactionsByAddressE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedTransactionsByAddressE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedTransactionsByAddressE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedTransactionsByAddressE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedTransactionsByAddressE401>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedTransactionsByAddressE401 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedTransactionsByAddressE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedTransactionsByAddressE401 ret = new ListUnconfirmedTransactionsByAddressE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedTransactionsByAddressE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedTransactionsByAddressE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedTransactionsByAddressE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedTransactionsByAddressE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedTransactionsByAddressE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedTransactionsByAddressE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedTransactionsByAddressE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedTransactionsByAddressE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedTransactionsByAddressE401
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedTransactionsByAddressE401
  */
  public static ListUnconfirmedTransactionsByAddressE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedTransactionsByAddressE401.class);
  }

 /**
  * Convert an instance of ListUnconfirmedTransactionsByAddressE401 to an JSON string
  *
  * @return JSON string
  */
