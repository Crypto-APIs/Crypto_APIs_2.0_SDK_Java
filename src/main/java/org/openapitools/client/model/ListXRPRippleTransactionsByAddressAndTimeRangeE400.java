...
public class ListXRPRippleTransactionsByAddressAndTimeRangeE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByAddressAndTimeRangeE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByAddressAndTimeRangeE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByAddressAndTimeRangeE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByAddressAndTimeRangeE400>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByAddressAndTimeRangeE400 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByAddressAndTimeRangeE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByAddressAndTimeRangeE400 ret = new ListXRPRippleTransactionsByAddressAndTimeRangeE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByAddressAndTimeRangeE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByAddressAndTimeRangeE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByAddressAndTimeRangeE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByAddressAndTimeRangeE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByAddressAndTimeRangeE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByAddressAndTimeRangeE400
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByAddressAndTimeRangeE400
  */
  public static ListXRPRippleTransactionsByAddressAndTimeRangeE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByAddressAndTimeRangeE400.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByAddressAndTimeRangeE400 to an JSON string
  *
  * @return JSON string
  */
