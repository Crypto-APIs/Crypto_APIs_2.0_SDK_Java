...
public class GetXRPRippleBlockDetailsByBlockHashE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleBlockDetailsByBlockHashE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleBlockDetailsByBlockHashE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleBlockDetailsByBlockHashE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleBlockDetailsByBlockHashE401>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleBlockDetailsByBlockHashE401 value) throws IOException {
                ...
                @Override
                public GetXRPRippleBlockDetailsByBlockHashE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleBlockDetailsByBlockHashE401 ret = new GetXRPRippleBlockDetailsByBlockHashE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleBlockDetailsByBlockHashE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleBlockDetailsByBlockHashE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleBlockDetailsByBlockHashE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleBlockDetailsByBlockHashE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleBlockDetailsByBlockHashE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleBlockDetailsByBlockHashE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleBlockDetailsByBlockHashE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleBlockDetailsByBlockHashE401
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleBlockDetailsByBlockHashE401
  */
  public static GetXRPRippleBlockDetailsByBlockHashE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleBlockDetailsByBlockHashE401.class);
  }

 /**
  * Convert an instance of GetXRPRippleBlockDetailsByBlockHashE401 to an JSON string
  *
  * @return JSON string
  */
