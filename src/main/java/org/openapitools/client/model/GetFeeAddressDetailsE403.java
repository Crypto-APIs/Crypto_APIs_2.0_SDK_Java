...
public class GetFeeAddressDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeAddressDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeAddressDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeAddressDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeAddressDetailsE403>() {
                @Override
                public void write(JsonWriter out, GetFeeAddressDetailsE403 value) throws IOException {
                ...
                @Override
                public GetFeeAddressDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeAddressDetailsE403 ret = new GetFeeAddressDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeAddressDetailsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeAddressDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeAddressDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeAddressDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeAddressDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeAddressDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeAddressDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeAddressDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeAddressDetailsE403
  * @throws IOException if the JSON string is invalid with respect to GetFeeAddressDetailsE403
  */
  public static GetFeeAddressDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeAddressDetailsE403.class);
  }

 /**
  * Convert an instance of GetFeeAddressDetailsE403 to an JSON string
  *
  * @return JSON string
  */
