...
public class GetInternalTransactionByTransactionHashAndOperationIdE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetInternalTransactionByTransactionHashAndOperationIdE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetInternalTransactionByTransactionHashAndOperationIdE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetInternalTransactionByTransactionHashAndOperationIdE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetInternalTransactionByTransactionHashAndOperationIdE401>() {
                @Override
                public void write(JsonWriter out, GetInternalTransactionByTransactionHashAndOperationIdE401 value) throws IOException {
                ...
                @Override
                public GetInternalTransactionByTransactionHashAndOperationIdE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetInternalTransactionByTransactionHashAndOperationIdE401 ret = new GetInternalTransactionByTransactionHashAndOperationIdE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetInternalTransactionByTransactionHashAndOperationIdE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetInternalTransactionByTransactionHashAndOperationIdE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetInternalTransactionByTransactionHashAndOperationIdE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetInternalTransactionByTransactionHashAndOperationIdE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetInternalTransactionByTransactionHashAndOperationIdE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetInternalTransactionByTransactionHashAndOperationIdE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetInternalTransactionByTransactionHashAndOperationIdE401
  * @throws IOException if the JSON string is invalid with respect to GetInternalTransactionByTransactionHashAndOperationIdE401
  */
  public static GetInternalTransactionByTransactionHashAndOperationIdE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInternalTransactionByTransactionHashAndOperationIdE401.class);
  }

 /**
  * Convert an instance of GetInternalTransactionByTransactionHashAndOperationIdE401 to an JSON string
  *
  * @return JSON string
  */
