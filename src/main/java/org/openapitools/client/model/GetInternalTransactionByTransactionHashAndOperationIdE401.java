...
public class GetInternalTransactionByTransactionHashAndOperationIdE401 extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetInternalTransactionByTransactionHashAndOperationIdE401>() {
                ...
                public GetInternalTransactionByTransactionHashAndOperationIdE401 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for GetInternalTransactionByTransactionHashAndOperationIdE401: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetInternalTransactionByTransactionHashAndOperationIdE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }
