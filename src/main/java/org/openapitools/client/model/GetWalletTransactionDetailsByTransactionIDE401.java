...
public class GetWalletTransactionDetailsByTransactionIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetWalletTransactionDetailsByTransactionIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetWalletTransactionDetailsByTransactionIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetWalletTransactionDetailsByTransactionIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetWalletTransactionDetailsByTransactionIDE401>() {
                @Override
                public void write(JsonWriter out, GetWalletTransactionDetailsByTransactionIDE401 value) throws IOException {
                ...
                @Override
                public GetWalletTransactionDetailsByTransactionIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetWalletTransactionDetailsByTransactionIDE401 ret = new GetWalletTransactionDetailsByTransactionIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetWalletTransactionDetailsByTransactionIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetWalletTransactionDetailsByTransactionIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetWalletTransactionDetailsByTransactionIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletTransactionDetailsByTransactionIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetWalletTransactionDetailsByTransactionIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWalletTransactionDetailsByTransactionIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetWalletTransactionDetailsByTransactionIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetWalletTransactionDetailsByTransactionIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetWalletTransactionDetailsByTransactionIDE401
  * @throws IOException if the JSON string is invalid with respect to GetWalletTransactionDetailsByTransactionIDE401
  */
  public static GetWalletTransactionDetailsByTransactionIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWalletTransactionDetailsByTransactionIDE401.class);
  }

 /**
  * Convert an instance of GetWalletTransactionDetailsByTransactionIDE401 to an JSON string
  *
  * @return JSON string
  */
