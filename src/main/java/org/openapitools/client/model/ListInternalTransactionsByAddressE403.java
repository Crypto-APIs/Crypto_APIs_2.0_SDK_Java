...
public class ListInternalTransactionsByAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionsByAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionsByAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionsByAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionsByAddressE403>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionsByAddressE403 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionsByAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionsByAddressE403 ret = new ListInternalTransactionsByAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionsByAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionsByAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionsByAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionsByAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionsByAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionsByAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionsByAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionsByAddressE403
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionsByAddressE403
  */
  public static ListInternalTransactionsByAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionsByAddressE403.class);
  }

 /**
  * Convert an instance of ListInternalTransactionsByAddressE403 to an JSON string
  *
  * @return JSON string
  */
