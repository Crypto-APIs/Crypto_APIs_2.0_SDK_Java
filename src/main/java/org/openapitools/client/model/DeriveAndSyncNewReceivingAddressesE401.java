...
public class DeriveAndSyncNewReceivingAddressesE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewReceivingAddressesE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewReceivingAddressesE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewReceivingAddressesE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewReceivingAddressesE401>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewReceivingAddressesE401 value) throws IOException {
                ...
                @Override
                public DeriveAndSyncNewReceivingAddressesE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewReceivingAddressesE401 ret = new DeriveAndSyncNewReceivingAddressesE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewReceivingAddressesE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewReceivingAddressesE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewReceivingAddressesE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewReceivingAddressesE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewReceivingAddressesE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewReceivingAddressesE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewReceivingAddressesE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewReceivingAddressesE401
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewReceivingAddressesE401
  */
  public static DeriveAndSyncNewReceivingAddressesE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewReceivingAddressesE401.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewReceivingAddressesE401 to an JSON string
  *
  * @return JSON string
  */
