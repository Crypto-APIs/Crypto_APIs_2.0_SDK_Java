...
public class ListUnconfirmedOmniTransactionsByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedOmniTransactionsByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedOmniTransactionsByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedOmniTransactionsByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedOmniTransactionsByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedOmniTransactionsByAddressE400 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedOmniTransactionsByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedOmniTransactionsByAddressE400 ret = new ListUnconfirmedOmniTransactionsByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedOmniTransactionsByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedOmniTransactionsByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedOmniTransactionsByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedOmniTransactionsByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedOmniTransactionsByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedOmniTransactionsByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedOmniTransactionsByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedOmniTransactionsByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedOmniTransactionsByAddressE400
  */
  public static ListUnconfirmedOmniTransactionsByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedOmniTransactionsByAddressE400.class);
  }

 /**
  * Convert an instance of ListUnconfirmedOmniTransactionsByAddressE400 to an JSON string
  *
  * @return JSON string
  */
