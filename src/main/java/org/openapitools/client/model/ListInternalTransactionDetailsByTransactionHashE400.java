...
public class ListInternalTransactionDetailsByTransactionHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionDetailsByTransactionHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionDetailsByTransactionHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionDetailsByTransactionHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionDetailsByTransactionHashE400>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionDetailsByTransactionHashE400 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionDetailsByTransactionHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionDetailsByTransactionHashE400 ret = new ListInternalTransactionDetailsByTransactionHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionDetailsByTransactionHashE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionDetailsByTransactionHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionDetailsByTransactionHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionDetailsByTransactionHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionDetailsByTransactionHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionDetailsByTransactionHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionDetailsByTransactionHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionDetailsByTransactionHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionDetailsByTransactionHashE400
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionDetailsByTransactionHashE400
  */
  public static ListInternalTransactionDetailsByTransactionHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionDetailsByTransactionHashE400.class);
  }

 /**
  * Convert an instance of ListInternalTransactionDetailsByTransactionHashE400 to an JSON string
  *
  * @return JSON string
  */
