...
public class EncodeXAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EncodeXAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EncodeXAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EncodeXAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EncodeXAddressE400>() {
                @Override
                public void write(JsonWriter out, EncodeXAddressE400 value) throws IOException {
                ...
                @Override
                public EncodeXAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EncodeXAddressE400 ret = new EncodeXAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EncodeXAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EncodeXAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public EncodeXAddressE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EncodeXAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EncodeXAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EncodeXAddressE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EncodeXAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncodeXAddressE400
  * @throws IOException if the JSON string is invalid with respect to EncodeXAddressE400
  */
  public static EncodeXAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncodeXAddressE400.class);
  }

 /**
  * Convert an instance of EncodeXAddressE400 to an JSON string
  *
  * @return JSON string
  */
