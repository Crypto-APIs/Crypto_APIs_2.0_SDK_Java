...
public class NewConfirmedTokensTransactionsAndEachConfirmationE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedTokensTransactionsAndEachConfirmationE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedTokensTransactionsAndEachConfirmationE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedTokensTransactionsAndEachConfirmationE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedTokensTransactionsAndEachConfirmationE403>() {
                @Override
                public void write(JsonWriter out, NewConfirmedTokensTransactionsAndEachConfirmationE403 value) throws IOException {
                ...
                @Override
                public NewConfirmedTokensTransactionsAndEachConfirmationE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedTokensTransactionsAndEachConfirmationE403 ret = new NewConfirmedTokensTransactionsAndEachConfirmationE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedTokensTransactionsAndEachConfirmationE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedTokensTransactionsAndEachConfirmationE403() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedTokensTransactionsAndEachConfirmationE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedTokensTransactionsAndEachConfirmationE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedTokensTransactionsAndEachConfirmationE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedTokensTransactionsAndEachConfirmationE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedTokensTransactionsAndEachConfirmationE403
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedTokensTransactionsAndEachConfirmationE403
  */
  public static NewConfirmedTokensTransactionsAndEachConfirmationE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedTokensTransactionsAndEachConfirmationE403.class);
  }

 /**
  * Convert an instance of NewConfirmedTokensTransactionsAndEachConfirmationE403 to an JSON string
  *
  * @return JSON string
  */
