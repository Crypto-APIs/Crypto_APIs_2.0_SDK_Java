...
public class ListAllAssetsFromAllWalletsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllAssetsFromAllWalletsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsFromAllWalletsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsFromAllWalletsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsFromAllWalletsE401>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsFromAllWalletsE401 value) throws IOException {
                ...
                @Override
                public ListAllAssetsFromAllWalletsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsFromAllWalletsE401 ret = new ListAllAssetsFromAllWalletsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsFromAllWalletsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsFromAllWalletsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllAssetsFromAllWalletsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsFromAllWalletsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsFromAllWalletsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsFromAllWalletsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsFromAllWalletsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsFromAllWalletsE401
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsFromAllWalletsE401
  */
  public static ListAllAssetsFromAllWalletsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsFromAllWalletsE401.class);
  }

 /**
  * Convert an instance of ListAllAssetsFromAllWalletsE401 to an JSON string
  *
  * @return JSON string
  */
