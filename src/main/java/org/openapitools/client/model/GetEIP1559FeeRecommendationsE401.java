...
public class GetEIP1559FeeRecommendationsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetEIP1559FeeRecommendationsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetEIP1559FeeRecommendationsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetEIP1559FeeRecommendationsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetEIP1559FeeRecommendationsE401>() {
                @Override
                public void write(JsonWriter out, GetEIP1559FeeRecommendationsE401 value) throws IOException {
                ...
                @Override
                public GetEIP1559FeeRecommendationsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetEIP1559FeeRecommendationsE401 ret = new GetEIP1559FeeRecommendationsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetEIP1559FeeRecommendationsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetEIP1559FeeRecommendationsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetEIP1559FeeRecommendationsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetEIP1559FeeRecommendationsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetEIP1559FeeRecommendationsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetEIP1559FeeRecommendationsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetEIP1559FeeRecommendationsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetEIP1559FeeRecommendationsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetEIP1559FeeRecommendationsE401
  * @throws IOException if the JSON string is invalid with respect to GetEIP1559FeeRecommendationsE401
  */
  public static GetEIP1559FeeRecommendationsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEIP1559FeeRecommendationsE401.class);
  }

 /**
  * Convert an instance of GetEIP1559FeeRecommendationsE401 to an JSON string
  *
  * @return JSON string
  */
