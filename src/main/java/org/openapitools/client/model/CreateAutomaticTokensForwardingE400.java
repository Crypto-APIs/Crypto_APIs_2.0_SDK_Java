...
public class CreateAutomaticTokensForwardingE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateAutomaticTokensForwardingE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAutomaticTokensForwardingE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAutomaticTokensForwardingE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateAutomaticTokensForwardingE400>() {
                @Override
                public void write(JsonWriter out, CreateAutomaticTokensForwardingE400 value) throws IOException {
                ...
                @Override
                public CreateAutomaticTokensForwardingE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateAutomaticTokensForwardingE400 ret = new CreateAutomaticTokensForwardingE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateAutomaticTokensForwardingE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateAutomaticTokensForwardingE400() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAutomaticTokensForwardingE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAutomaticTokensForwardingE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateAutomaticTokensForwardingE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAutomaticTokensForwardingE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateAutomaticTokensForwardingE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateAutomaticTokensForwardingE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAutomaticTokensForwardingE400
  * @throws IOException if the JSON string is invalid with respect to CreateAutomaticTokensForwardingE400
  */
  public static CreateAutomaticTokensForwardingE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAutomaticTokensForwardingE400.class);
  }

 /**
  * Convert an instance of CreateAutomaticTokensForwardingE400 to an JSON string
  *
  * @return JSON string
  */
