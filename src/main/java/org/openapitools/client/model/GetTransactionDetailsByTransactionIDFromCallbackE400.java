...
public class GetTransactionDetailsByTransactionIDFromCallbackE400 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionDetailsByTransactionIDFromCallbackE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionDetailsByTransactionIDFromCallbackE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionDetailsByTransactionIDFromCallbackE400>() {
                @Override
                public void write(JsonWriter out, GetTransactionDetailsByTransactionIDFromCallbackE400 value) throws IOException {
                ...
                @Override
                public GetTransactionDetailsByTransactionIDFromCallbackE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionDetailsByTransactionIDFromCallbackE400 ret = new GetTransactionDetailsByTransactionIDFromCallbackE400();
    ...
    public GetTransactionDetailsByTransactionIDFromCallbackE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionDetailsByTransactionIDFromCallbackE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionDetailsByTransactionIDFromCallbackE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionDetailsByTransactionIDFromCallbackE400
  */
 ...
 /**
  * Create an instance of GetTransactionDetailsByTransactionIDFromCallbackE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionDetailsByTransactionIDFromCallbackE400
  * @throws IOException if the JSON string is invalid with respect to GetTransactionDetailsByTransactionIDFromCallbackE400
  */
  public static GetTransactionDetailsByTransactionIDFromCallbackE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionDetailsByTransactionIDFromCallbackE400.class);
  }

 /**
  * Convert an instance of GetTransactionDetailsByTransactionIDFromCallbackE400 to an JSON string
  *
  * @return JSON string
  */
