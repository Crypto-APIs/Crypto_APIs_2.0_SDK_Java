...
public class DeriveAndSyncNewReceivingAddressesE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveAndSyncNewReceivingAddressesE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveAndSyncNewReceivingAddressesE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveAndSyncNewReceivingAddressesE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveAndSyncNewReceivingAddressesE400>() {
                @Override
                public void write(JsonWriter out, DeriveAndSyncNewReceivingAddressesE400 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound");
                }

                @Override
                public DeriveAndSyncNewReceivingAddressesE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveAndSyncNewReceivingAddressesE400 ret = new DeriveAndSyncNewReceivingAddressesE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveAndSyncNewReceivingAddressesE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveAndSyncNewReceivingAddressesE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveAndSyncNewReceivingAddressesE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE400(InvalidNetwork o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveAndSyncNewReceivingAddressesE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveAndSyncNewReceivingAddressesE400.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound");
    }
     ...
     * InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound
     *
     * @return The actual instance (InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveAndSyncNewReceivingAddressesE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveAndSyncNewReceivingAddressesE400 with oneOf schemas: InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveAndSyncNewReceivingAddressesE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveAndSyncNewReceivingAddressesE400
  * @throws IOException if the JSON string is invalid with respect to DeriveAndSyncNewReceivingAddressesE400
  */
  public static DeriveAndSyncNewReceivingAddressesE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveAndSyncNewReceivingAddressesE400.class);
  }

 /**
  * Convert an instance of DeriveAndSyncNewReceivingAddressesE400 to an JSON string
  *
  * @return JSON string
  */
