...
public class EstimateGasLimitE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EstimateGasLimitE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EstimateGasLimitE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EstimateGasLimitE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EstimateGasLimitE403>() {
                @Override
                public void write(JsonWriter out, EstimateGasLimitE403 value) throws IOException {
                ...
                @Override
                public EstimateGasLimitE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EstimateGasLimitE403 ret = new EstimateGasLimitE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EstimateGasLimitE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EstimateGasLimitE403() {
        super("oneOf", Boolean.FALSE);
    }

    public EstimateGasLimitE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EstimateGasLimitE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EstimateGasLimitE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimateGasLimitE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EstimateGasLimitE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EstimateGasLimitE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateGasLimitE403
  * @throws IOException if the JSON string is invalid with respect to EstimateGasLimitE403
  */
  public static EstimateGasLimitE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateGasLimitE403.class);
  }

 /**
  * Convert an instance of EstimateGasLimitE403 to an JSON string
  *
  * @return JSON string
  */
