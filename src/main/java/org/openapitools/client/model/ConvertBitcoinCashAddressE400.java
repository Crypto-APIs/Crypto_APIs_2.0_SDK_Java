...
public class ConvertBitcoinCashAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ConvertBitcoinCashAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ConvertBitcoinCashAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ConvertBitcoinCashAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ConvertBitcoinCashAddressE400>() {
                @Override
                public void write(JsonWriter out, ConvertBitcoinCashAddressE400 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound");
                }

                @Override
                public ConvertBitcoinCashAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ConvertBitcoinCashAddressE400 ret = new ConvertBitcoinCashAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ConvertBitcoinCashAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ConvertBitcoinCashAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ConvertBitcoinCashAddressE400(InvalidBlockchain o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ConvertBitcoinCashAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ConvertBitcoinCashAddressE400.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound");
    }
     ...
     * InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound
     *
     * @return The actual instance (InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConvertBitcoinCashAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ConvertBitcoinCashAddressE400 with oneOf schemas: InvalidBlockchain, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ConvertBitcoinCashAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConvertBitcoinCashAddressE400
  * @throws IOException if the JSON string is invalid with respect to ConvertBitcoinCashAddressE400
  */
  public static ConvertBitcoinCashAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertBitcoinCashAddressE400.class);
  }

 /**
  * Convert an instance of ConvertBitcoinCashAddressE400 to an JSON string
  *
  * @return JSON string
  */
