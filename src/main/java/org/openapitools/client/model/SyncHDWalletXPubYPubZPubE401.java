...
public class SyncHDWalletXPubYPubZPubE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncHDWalletXPubYPubZPubE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncHDWalletXPubYPubZPubE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncHDWalletXPubYPubZPubE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncHDWalletXPubYPubZPubE401>() {
                @Override
                public void write(JsonWriter out, SyncHDWalletXPubYPubZPubE401 value) throws IOException {
                ...
                @Override
                public SyncHDWalletXPubYPubZPubE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncHDWalletXPubYPubZPubE401 ret = new SyncHDWalletXPubYPubZPubE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncHDWalletXPubYPubZPubE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncHDWalletXPubYPubZPubE401() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncHDWalletXPubYPubZPubE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncHDWalletXPubYPubZPubE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncHDWalletXPubYPubZPubE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncHDWalletXPubYPubZPubE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncHDWalletXPubYPubZPubE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncHDWalletXPubYPubZPubE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncHDWalletXPubYPubZPubE401
  * @throws IOException if the JSON string is invalid with respect to SyncHDWalletXPubYPubZPubE401
  */
  public static SyncHDWalletXPubYPubZPubE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncHDWalletXPubYPubZPubE401.class);
  }

 /**
  * Convert an instance of SyncHDWalletXPubYPubZPubE401 to an JSON string
  *
  * @return JSON string
  */
