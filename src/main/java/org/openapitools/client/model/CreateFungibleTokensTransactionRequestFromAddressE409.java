...
public class CreateFungibleTokensTransactionRequestFromAddressE409 extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFungibleTokensTransactionRequestFromAddressE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFungibleTokensTransactionRequestFromAddressE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFungibleTokensTransactionRequestFromAddressE409>() {
                @Override
                public void write(JsonWriter out, CreateFungibleTokensTransactionRequestFromAddressE409 value) throws IOException {
                ...
                @Override
                public CreateFungibleTokensTransactionRequestFromAddressE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateFungibleTokensTransactionRequestFromAddressE409 ret = new CreateFungibleTokensTransactionRequestFromAddressE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateFungibleTokensTransactionRequestFromAddressE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFungibleTokensTransactionRequestFromAddressE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE409(WalletAsAServiceAddressBalanceNotEnough o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE409(WalletAsAServiceTokenNotSupported o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE409(WalletAsAServiceWalletBalanceNotEnough o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateFungibleTokensTransactionRequestFromAddressE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateFungibleTokensTransactionRequestFromAddressE409 with oneOf schemas: InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateFungibleTokensTransactionRequestFromAddressE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateFungibleTokensTransactionRequestFromAddressE409
  * @throws IOException if the JSON string is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE409
  */
  public static CreateFungibleTokensTransactionRequestFromAddressE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFungibleTokensTransactionRequestFromAddressE409.class);
  }

 /**
  * Convert an instance of CreateFungibleTokensTransactionRequestFromAddressE409 to an JSON string
  *
  * @return JSON string
  */
