...
public class ActivateBlockchainEventSubscriptionE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActivateBlockchainEventSubscriptionE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ActivateBlockchainEventSubscriptionE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ActivateBlockchainEventSubscriptionE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ActivateBlockchainEventSubscriptionE400>() {
                @Override
                public void write(JsonWriter out, ActivateBlockchainEventSubscriptionE400 value) throws IOException {
                ...
                @Override
                public ActivateBlockchainEventSubscriptionE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ActivateBlockchainEventSubscriptionE400 ret = new ActivateBlockchainEventSubscriptionE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ActivateBlockchainEventSubscriptionE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ActivateBlockchainEventSubscriptionE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ActivateBlockchainEventSubscriptionE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ActivateBlockchainEventSubscriptionE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ActivateBlockchainEventSubscriptionE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActivateBlockchainEventSubscriptionE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ActivateBlockchainEventSubscriptionE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ActivateBlockchainEventSubscriptionE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActivateBlockchainEventSubscriptionE400
  * @throws IOException if the JSON string is invalid with respect to ActivateBlockchainEventSubscriptionE400
  */
  public static ActivateBlockchainEventSubscriptionE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivateBlockchainEventSubscriptionE400.class);
  }

 /**
  * Convert an instance of ActivateBlockchainEventSubscriptionE400 to an JSON string
  *
  * @return JSON string
  */
