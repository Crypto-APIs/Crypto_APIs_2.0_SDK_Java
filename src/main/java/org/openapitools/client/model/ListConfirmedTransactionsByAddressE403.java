...
public class ListConfirmedTransactionsByAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListConfirmedTransactionsByAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListConfirmedTransactionsByAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListConfirmedTransactionsByAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListConfirmedTransactionsByAddressE403>() {
                @Override
                public void write(JsonWriter out, ListConfirmedTransactionsByAddressE403 value) throws IOException {
                ...
                @Override
                public ListConfirmedTransactionsByAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListConfirmedTransactionsByAddressE403 ret = new ListConfirmedTransactionsByAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListConfirmedTransactionsByAddressE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListConfirmedTransactionsByAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListConfirmedTransactionsByAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListConfirmedTransactionsByAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListConfirmedTransactionsByAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListConfirmedTransactionsByAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListConfirmedTransactionsByAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListConfirmedTransactionsByAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListConfirmedTransactionsByAddressE403
  * @throws IOException if the JSON string is invalid with respect to ListConfirmedTransactionsByAddressE403
  */
  public static ListConfirmedTransactionsByAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfirmedTransactionsByAddressE403.class);
  }

 /**
  * Convert an instance of ListConfirmedTransactionsByAddressE403 to an JSON string
  *
  * @return JSON string
  */
