...
public class ListSyncedAddressesE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSyncedAddressesE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSyncedAddressesE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSyncedAddressesE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSyncedAddressesE403>() {
                @Override
                public void write(JsonWriter out, ListSyncedAddressesE403 value) throws IOException {
                ...
                @Override
                public ListSyncedAddressesE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSyncedAddressesE403 ret = new ListSyncedAddressesE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSyncedAddressesE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSyncedAddressesE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSyncedAddressesE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSyncedAddressesE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSyncedAddressesE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSyncedAddressesE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSyncedAddressesE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSyncedAddressesE403
  * @throws IOException if the JSON string is invalid with respect to ListSyncedAddressesE403
  */
  public static ListSyncedAddressesE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSyncedAddressesE403.class);
  }

 /**
  * Convert an instance of ListSyncedAddressesE403 to an JSON string
  *
  * @return JSON string
  */
