...
public class ListSyncedAddressesE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSyncedAddressesE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSyncedAddressesE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSyncedAddressesE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSyncedAddressesE401>() {
                @Override
                public void write(JsonWriter out, ListSyncedAddressesE401 value) throws IOException {
                ...
                @Override
                public ListSyncedAddressesE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSyncedAddressesE401 ret = new ListSyncedAddressesE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSyncedAddressesE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSyncedAddressesE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSyncedAddressesE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSyncedAddressesE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSyncedAddressesE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSyncedAddressesE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSyncedAddressesE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSyncedAddressesE401
  * @throws IOException if the JSON string is invalid with respect to ListSyncedAddressesE401
  */
  public static ListSyncedAddressesE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSyncedAddressesE401.class);
  }

 /**
  * Convert an instance of ListSyncedAddressesE401 to an JSON string
  *
  * @return JSON string
  */
