...
public class BroadcastLocallySignedTransactionE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BroadcastLocallySignedTransactionE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BroadcastLocallySignedTransactionE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BroadcastLocallySignedTransactionE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BroadcastLocallySignedTransactionE400>() {
                @Override
                public void write(JsonWriter out, BroadcastLocallySignedTransactionE400 value) throws IOException {
                ...
                @Override
                public BroadcastLocallySignedTransactionE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BroadcastLocallySignedTransactionE400 ret = new BroadcastLocallySignedTransactionE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BroadcastLocallySignedTransactionE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BroadcastLocallySignedTransactionE400() {
        super("oneOf", Boolean.FALSE);
    }

    public BroadcastLocallySignedTransactionE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BroadcastLocallySignedTransactionE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BroadcastLocallySignedTransactionE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BroadcastLocallySignedTransactionE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BroadcastLocallySignedTransactionE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BroadcastLocallySignedTransactionE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BroadcastLocallySignedTransactionE400
  * @throws IOException if the JSON string is invalid with respect to BroadcastLocallySignedTransactionE400
  */
  public static BroadcastLocallySignedTransactionE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BroadcastLocallySignedTransactionE400.class);
  }

 /**
  * Convert an instance of BroadcastLocallySignedTransactionE400 to an JSON string
  *
  * @return JSON string
  */
