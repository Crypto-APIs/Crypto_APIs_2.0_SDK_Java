...
public class ListSyncedAddressesE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSyncedAddressesE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSyncedAddressesE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSyncedAddressesE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSyncedAddressesE400>() {
                @Override
                public void write(JsonWriter out, ListSyncedAddressesE400 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound");
                }

                @Override
                public ListSyncedAddressesE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSyncedAddressesE400 ret = new ListSyncedAddressesE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSyncedAddressesE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSyncedAddressesE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSyncedAddressesE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE400(InvalidXpub o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSyncedAddressesE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSyncedAddressesE400.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound");
    }
     ...
     * InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound
     *
     * @return The actual instance (InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSyncedAddressesE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSyncedAddressesE400 with oneOf schemas: InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSyncedAddressesE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSyncedAddressesE400
  * @throws IOException if the JSON string is invalid with respect to ListSyncedAddressesE400
  */
  public static ListSyncedAddressesE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSyncedAddressesE400.class);
  }

 /**
  * Convert an instance of ListSyncedAddressesE400 to an JSON string
  *
  * @return JSON string
  */
