...
public class GetBlockchainEventSubscriptionDetailsByReferenceIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockchainEventSubscriptionDetailsByReferenceIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockchainEventSubscriptionDetailsByReferenceIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockchainEventSubscriptionDetailsByReferenceIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockchainEventSubscriptionDetailsByReferenceIDE400>() {
                @Override
                public void write(JsonWriter out, GetBlockchainEventSubscriptionDetailsByReferenceIDE400 value) throws IOException {
                ...
                @Override
                public GetBlockchainEventSubscriptionDetailsByReferenceIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockchainEventSubscriptionDetailsByReferenceIDE400 ret = new GetBlockchainEventSubscriptionDetailsByReferenceIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockchainEventSubscriptionDetailsByReferenceIDE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockchainEventSubscriptionDetailsByReferenceIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockchainEventSubscriptionDetailsByReferenceIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockchainEventSubscriptionDetailsByReferenceIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE400
  * @throws IOException if the JSON string is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE400
  */
  public static GetBlockchainEventSubscriptionDetailsByReferenceIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockchainEventSubscriptionDetailsByReferenceIDE400.class);
  }

 /**
  * Convert an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE400 to an JSON string
  *
  * @return JSON string
  */
