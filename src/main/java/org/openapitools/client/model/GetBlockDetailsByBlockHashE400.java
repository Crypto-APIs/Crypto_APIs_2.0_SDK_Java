...
public class GetBlockDetailsByBlockHashE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockDetailsByBlockHashE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockDetailsByBlockHashE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockDetailsByBlockHashE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockDetailsByBlockHashE400>() {
                @Override
                public void write(JsonWriter out, GetBlockDetailsByBlockHashE400 value) throws IOException {
                ...
                @Override
                public GetBlockDetailsByBlockHashE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockDetailsByBlockHashE400 ret = new GetBlockDetailsByBlockHashE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockDetailsByBlockHashE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockDetailsByBlockHashE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockDetailsByBlockHashE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockDetailsByBlockHashE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockDetailsByBlockHashE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockDetailsByBlockHashE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockDetailsByBlockHashE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockDetailsByBlockHashE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockDetailsByBlockHashE400
  * @throws IOException if the JSON string is invalid with respect to GetBlockDetailsByBlockHashE400
  */
  public static GetBlockDetailsByBlockHashE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockDetailsByBlockHashE400.class);
  }

 /**
  * Convert an instance of GetBlockDetailsByBlockHashE400 to an JSON string
  *
  * @return JSON string
  */
