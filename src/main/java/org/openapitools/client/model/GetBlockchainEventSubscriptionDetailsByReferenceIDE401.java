...
public class GetBlockchainEventSubscriptionDetailsByReferenceIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetBlockchainEventSubscriptionDetailsByReferenceIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetBlockchainEventSubscriptionDetailsByReferenceIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetBlockchainEventSubscriptionDetailsByReferenceIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetBlockchainEventSubscriptionDetailsByReferenceIDE401>() {
                @Override
                public void write(JsonWriter out, GetBlockchainEventSubscriptionDetailsByReferenceIDE401 value) throws IOException {
                ...
                @Override
                public GetBlockchainEventSubscriptionDetailsByReferenceIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetBlockchainEventSubscriptionDetailsByReferenceIDE401 ret = new GetBlockchainEventSubscriptionDetailsByReferenceIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetBlockchainEventSubscriptionDetailsByReferenceIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetBlockchainEventSubscriptionDetailsByReferenceIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetBlockchainEventSubscriptionDetailsByReferenceIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetBlockchainEventSubscriptionDetailsByReferenceIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetBlockchainEventSubscriptionDetailsByReferenceIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE401
  * @throws IOException if the JSON string is invalid with respect to GetBlockchainEventSubscriptionDetailsByReferenceIDE401
  */
  public static GetBlockchainEventSubscriptionDetailsByReferenceIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlockchainEventSubscriptionDetailsByReferenceIDE401.class);
  }

 /**
  * Convert an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE401 to an JSON string
  *
  * @return JSON string
  */
