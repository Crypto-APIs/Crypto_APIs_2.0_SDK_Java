...
public class CreateCoinsTransactionFromAddressForWholeAmountE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCoinsTransactionFromAddressForWholeAmountE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCoinsTransactionFromAddressForWholeAmountE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCoinsTransactionFromAddressForWholeAmountE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCoinsTransactionFromAddressForWholeAmountE401>() {
                @Override
                public void write(JsonWriter out, CreateCoinsTransactionFromAddressForWholeAmountE401 value) throws IOException {
                ...
                @Override
                public CreateCoinsTransactionFromAddressForWholeAmountE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCoinsTransactionFromAddressForWholeAmountE401 ret = new CreateCoinsTransactionFromAddressForWholeAmountE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCoinsTransactionFromAddressForWholeAmountE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCoinsTransactionFromAddressForWholeAmountE401() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCoinsTransactionFromAddressForWholeAmountE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCoinsTransactionFromAddressForWholeAmountE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCoinsTransactionFromAddressForWholeAmountE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCoinsTransactionFromAddressForWholeAmountE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCoinsTransactionFromAddressForWholeAmountE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCoinsTransactionFromAddressForWholeAmountE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCoinsTransactionFromAddressForWholeAmountE401
  * @throws IOException if the JSON string is invalid with respect to CreateCoinsTransactionFromAddressForWholeAmountE401
  */
  public static CreateCoinsTransactionFromAddressForWholeAmountE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCoinsTransactionFromAddressForWholeAmountE401.class);
  }

 /**
  * Convert an instance of CreateCoinsTransactionFromAddressForWholeAmountE401 to an JSON string
  *
  * @return JSON string
  */
