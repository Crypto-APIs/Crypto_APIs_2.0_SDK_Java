...
public class GetAssetDetailsByAssetIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAssetDetailsByAssetIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAssetDetailsByAssetIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAssetDetailsByAssetIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAssetDetailsByAssetIDE403>() {
                @Override
                public void write(JsonWriter out, GetAssetDetailsByAssetIDE403 value) throws IOException {
                ...
                @Override
                public GetAssetDetailsByAssetIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAssetDetailsByAssetIDE403 ret = new GetAssetDetailsByAssetIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAssetDetailsByAssetIDE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAssetDetailsByAssetIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAssetDetailsByAssetIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAssetDetailsByAssetIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAssetDetailsByAssetIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAssetDetailsByAssetIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAssetDetailsByAssetIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAssetDetailsByAssetIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAssetDetailsByAssetIDE403
  * @throws IOException if the JSON string is invalid with respect to GetAssetDetailsByAssetIDE403
  */
  public static GetAssetDetailsByAssetIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetDetailsByAssetIDE403.class);
  }

 /**
  * Convert an instance of GetAssetDetailsByAssetIDE403 to an JSON string
  *
  * @return JSON string
  */
