...
public class GetAddressDetailsFromCallbackE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAddressDetailsFromCallbackE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAddressDetailsFromCallbackE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAddressDetailsFromCallbackE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAddressDetailsFromCallbackE400>() {
                @Override
                public void write(JsonWriter out, GetAddressDetailsFromCallbackE400 value) throws IOException {
                ...
                @Override
                public GetAddressDetailsFromCallbackE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAddressDetailsFromCallbackE400 ret = new GetAddressDetailsFromCallbackE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAddressDetailsFromCallbackE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAddressDetailsFromCallbackE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAddressDetailsFromCallbackE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetAddressDetailsFromCallbackE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetAddressDetailsFromCallbackE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetAddressDetailsFromCallbackE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetAddressDetailsFromCallbackE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetAddressDetailsFromCallbackE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAddressDetailsFromCallbackE400
  * @throws IOException if the JSON string is invalid with respect to GetAddressDetailsFromCallbackE400
  */
  public static GetAddressDetailsFromCallbackE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAddressDetailsFromCallbackE400.class);
  }

 /**
  * Convert an instance of GetAddressDetailsFromCallbackE400 to an JSON string
  *
  * @return JSON string
  */
