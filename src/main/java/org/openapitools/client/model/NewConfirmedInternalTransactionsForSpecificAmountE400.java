...
public class NewConfirmedInternalTransactionsForSpecificAmountE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsForSpecificAmountE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsForSpecificAmountE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsForSpecificAmountE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsForSpecificAmountE400>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsForSpecificAmountE400 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsForSpecificAmountE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsForSpecificAmountE400 ret = new NewConfirmedInternalTransactionsForSpecificAmountE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsForSpecificAmountE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsForSpecificAmountE400() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsForSpecificAmountE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsForSpecificAmountE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsForSpecificAmountE400
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE400
  */
  public static NewConfirmedInternalTransactionsForSpecificAmountE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsForSpecificAmountE400.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsForSpecificAmountE400 to an JSON string
  *
  * @return JSON string
  */
