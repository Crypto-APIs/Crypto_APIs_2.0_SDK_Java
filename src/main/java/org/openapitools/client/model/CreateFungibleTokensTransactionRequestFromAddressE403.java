...
public class CreateFungibleTokensTransactionRequestFromAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateFungibleTokensTransactionRequestFromAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFungibleTokensTransactionRequestFromAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFungibleTokensTransactionRequestFromAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFungibleTokensTransactionRequestFromAddressE403>() {
                @Override
                public void write(JsonWriter out, CreateFungibleTokensTransactionRequestFromAddressE403 value) throws IOException {
                ...
                @Override
                public CreateFungibleTokensTransactionRequestFromAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateFungibleTokensTransactionRequestFromAddressE403 ret = new CreateFungibleTokensTransactionRequestFromAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateFungibleTokensTransactionRequestFromAddressE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFungibleTokensTransactionRequestFromAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateFungibleTokensTransactionRequestFromAddressE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateFungibleTokensTransactionRequestFromAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateFungibleTokensTransactionRequestFromAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateFungibleTokensTransactionRequestFromAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateFungibleTokensTransactionRequestFromAddressE403
  * @throws IOException if the JSON string is invalid with respect to CreateFungibleTokensTransactionRequestFromAddressE403
  */
  public static CreateFungibleTokensTransactionRequestFromAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFungibleTokensTransactionRequestFromAddressE403.class);
  }

 /**
  * Convert an instance of CreateFungibleTokensTransactionRequestFromAddressE403 to an JSON string
  *
  * @return JSON string
  */
