...
public class SyncNewHDWalletXPubYPubZPubE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyncNewHDWalletXPubYPubZPubE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SyncNewHDWalletXPubYPubZPubE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SyncNewHDWalletXPubYPubZPubE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SyncNewHDWalletXPubYPubZPubE401>() {
                @Override
                public void write(JsonWriter out, SyncNewHDWalletXPubYPubZPubE401 value) throws IOException {
                ...
                @Override
                public SyncNewHDWalletXPubYPubZPubE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SyncNewHDWalletXPubYPubZPubE401 ret = new SyncNewHDWalletXPubYPubZPubE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SyncNewHDWalletXPubYPubZPubE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SyncNewHDWalletXPubYPubZPubE401() {
        super("oneOf", Boolean.FALSE);
    }

    public SyncNewHDWalletXPubYPubZPubE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SyncNewHDWalletXPubYPubZPubE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SyncNewHDWalletXPubYPubZPubE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncNewHDWalletXPubYPubZPubE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SyncNewHDWalletXPubYPubZPubE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SyncNewHDWalletXPubYPubZPubE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncNewHDWalletXPubYPubZPubE401
  * @throws IOException if the JSON string is invalid with respect to SyncNewHDWalletXPubYPubZPubE401
  */
  public static SyncNewHDWalletXPubYPubZPubE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncNewHDWalletXPubYPubZPubE401.class);
  }

 /**
  * Convert an instance of SyncNewHDWalletXPubYPubZPubE401 to an JSON string
  *
  * @return JSON string
  */
