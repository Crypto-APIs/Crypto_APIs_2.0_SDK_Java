...
public class NewConfirmedInternalTransactionsAndEachConfirmationE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsAndEachConfirmationE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsAndEachConfirmationE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsAndEachConfirmationE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsAndEachConfirmationE403>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsAndEachConfirmationE403 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsAndEachConfirmationE403 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for BlockchainEventsCallbacksLimitReached failed with `%s`.", e.getMessage()));
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsAndEachConfirmationE403 ret = new NewConfirmedInternalTransactionsAndEachConfirmationE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsAndEachConfirmationE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsAndEachConfirmationE403() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsAndEachConfirmationE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsAndEachConfirmationE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsAndEachConfirmationE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsAndEachConfirmationE403
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsAndEachConfirmationE403
  */
  public static NewConfirmedInternalTransactionsAndEachConfirmationE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsAndEachConfirmationE403.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsAndEachConfirmationE403 to an JSON string
  *
  * @return JSON string
  */
