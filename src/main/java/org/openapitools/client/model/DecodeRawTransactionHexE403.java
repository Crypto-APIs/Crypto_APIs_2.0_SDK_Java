...
public class DecodeRawTransactionHexE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DecodeRawTransactionHexE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DecodeRawTransactionHexE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DecodeRawTransactionHexE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DecodeRawTransactionHexE403>() {
                @Override
                public void write(JsonWriter out, DecodeRawTransactionHexE403 value) throws IOException {
                ...
                @Override
                public DecodeRawTransactionHexE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DecodeRawTransactionHexE403 ret = new DecodeRawTransactionHexE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DecodeRawTransactionHexE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DecodeRawTransactionHexE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DecodeRawTransactionHexE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeRawTransactionHexE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeRawTransactionHexE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DecodeRawTransactionHexE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DecodeRawTransactionHexE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecodeRawTransactionHexE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DecodeRawTransactionHexE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DecodeRawTransactionHexE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecodeRawTransactionHexE403
  * @throws IOException if the JSON string is invalid with respect to DecodeRawTransactionHexE403
  */
  public static DecodeRawTransactionHexE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecodeRawTransactionHexE403.class);
  }

 /**
  * Convert an instance of DecodeRawTransactionHexE403 to an JSON string
  *
  * @return JSON string
  */
