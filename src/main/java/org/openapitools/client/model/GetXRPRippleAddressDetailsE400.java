...
public class GetXRPRippleAddressDetailsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetXRPRippleAddressDetailsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetXRPRippleAddressDetailsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetXRPRippleAddressDetailsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetXRPRippleAddressDetailsE400>() {
                @Override
                public void write(JsonWriter out, GetXRPRippleAddressDetailsE400 value) throws IOException {
                ...
                @Override
                public GetXRPRippleAddressDetailsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetXRPRippleAddressDetailsE400 ret = new GetXRPRippleAddressDetailsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetXRPRippleAddressDetailsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetXRPRippleAddressDetailsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetXRPRippleAddressDetailsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetXRPRippleAddressDetailsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetXRPRippleAddressDetailsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetXRPRippleAddressDetailsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetXRPRippleAddressDetailsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetXRPRippleAddressDetailsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetXRPRippleAddressDetailsE400
  * @throws IOException if the JSON string is invalid with respect to GetXRPRippleAddressDetailsE400
  */
  public static GetXRPRippleAddressDetailsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetXRPRippleAddressDetailsE400.class);
  }

 /**
  * Convert an instance of GetXRPRippleAddressDetailsE400 to an JSON string
  *
  * @return JSON string
  */
