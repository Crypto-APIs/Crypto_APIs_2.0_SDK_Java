...
public class GetFeeRecommendationsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeeRecommendationsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeeRecommendationsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeeRecommendationsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeeRecommendationsE403>() {
                @Override
                public void write(JsonWriter out, GetFeeRecommendationsE403 value) throws IOException {
                ...
                @Override
                public GetFeeRecommendationsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetFeeRecommendationsE403 ret = new GetFeeRecommendationsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetFeeRecommendationsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeeRecommendationsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetFeeRecommendationsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetFeeRecommendationsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetFeeRecommendationsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFeeRecommendationsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetFeeRecommendationsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetFeeRecommendationsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFeeRecommendationsE403
  * @throws IOException if the JSON string is invalid with respect to GetFeeRecommendationsE403
  */
  public static GetFeeRecommendationsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeeRecommendationsE403.class);
  }

 /**
  * Convert an instance of GetFeeRecommendationsE403 to an JSON string
  *
  * @return JSON string
  */
