...
public class ListSupportedTokensE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListSupportedTokensE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSupportedTokensE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSupportedTokensE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListSupportedTokensE403>() {
                @Override
                public void write(JsonWriter out, ListSupportedTokensE403 value) throws IOException {
                ...
                @Override
                public ListSupportedTokensE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListSupportedTokensE403 ret = new ListSupportedTokensE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListSupportedTokensE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListSupportedTokensE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListSupportedTokensE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedTokensE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedTokensE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListSupportedTokensE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListSupportedTokensE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSupportedTokensE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListSupportedTokensE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListSupportedTokensE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSupportedTokensE403
  * @throws IOException if the JSON string is invalid with respect to ListSupportedTokensE403
  */
  public static ListSupportedTokensE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedTokensE403.class);
  }

 /**
  * Convert an instance of ListSupportedTokensE403 to an JSON string
  *
  * @return JSON string
  */
