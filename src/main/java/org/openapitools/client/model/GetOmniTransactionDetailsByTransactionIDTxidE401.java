...
public class GetOmniTransactionDetailsByTransactionIDTxidE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetOmniTransactionDetailsByTransactionIDTxidE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetOmniTransactionDetailsByTransactionIDTxidE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetOmniTransactionDetailsByTransactionIDTxidE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetOmniTransactionDetailsByTransactionIDTxidE401>() {
                @Override
                public void write(JsonWriter out, GetOmniTransactionDetailsByTransactionIDTxidE401 value) throws IOException {
                ...
                @Override
                public GetOmniTransactionDetailsByTransactionIDTxidE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetOmniTransactionDetailsByTransactionIDTxidE401 ret = new GetOmniTransactionDetailsByTransactionIDTxidE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetOmniTransactionDetailsByTransactionIDTxidE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetOmniTransactionDetailsByTransactionIDTxidE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetOmniTransactionDetailsByTransactionIDTxidE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetOmniTransactionDetailsByTransactionIDTxidE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetOmniTransactionDetailsByTransactionIDTxidE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetOmniTransactionDetailsByTransactionIDTxidE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOmniTransactionDetailsByTransactionIDTxidE401
  * @throws IOException if the JSON string is invalid with respect to GetOmniTransactionDetailsByTransactionIDTxidE401
  */
  public static GetOmniTransactionDetailsByTransactionIDTxidE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOmniTransactionDetailsByTransactionIDTxidE401.class);
  }

 /**
  * Convert an instance of GetOmniTransactionDetailsByTransactionIDTxidE401 to an JSON string
  *
  * @return JSON string
  */
