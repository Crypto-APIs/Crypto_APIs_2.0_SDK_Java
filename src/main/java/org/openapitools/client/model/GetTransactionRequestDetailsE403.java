...
public class GetTransactionRequestDetailsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTransactionRequestDetailsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTransactionRequestDetailsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTransactionRequestDetailsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTransactionRequestDetailsE403>() {
                @Override
                public void write(JsonWriter out, GetTransactionRequestDetailsE403 value) throws IOException {
                ...
                @Override
                public GetTransactionRequestDetailsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetTransactionRequestDetailsE403 ret = new GetTransactionRequestDetailsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTransactionRequestDetailsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTransactionRequestDetailsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTransactionRequestDetailsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetTransactionRequestDetailsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetTransactionRequestDetailsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionRequestDetailsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetTransactionRequestDetailsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetTransactionRequestDetailsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionRequestDetailsE403
  * @throws IOException if the JSON string is invalid with respect to GetTransactionRequestDetailsE403
  */
  public static GetTransactionRequestDetailsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionRequestDetailsE403.class);
  }

 /**
  * Convert an instance of GetTransactionRequestDetailsE403 to an JSON string
  *
  * @return JSON string
  */
