...
public class GetZilliqaBlockDetailsByBlockHeightE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetZilliqaBlockDetailsByBlockHeightE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetZilliqaBlockDetailsByBlockHeightE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetZilliqaBlockDetailsByBlockHeightE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetZilliqaBlockDetailsByBlockHeightE400>() {
                @Override
                public void write(JsonWriter out, GetZilliqaBlockDetailsByBlockHeightE400 value) throws IOException {
                ...
                @Override
                public GetZilliqaBlockDetailsByBlockHeightE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetZilliqaBlockDetailsByBlockHeightE400 ret = new GetZilliqaBlockDetailsByBlockHeightE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetZilliqaBlockDetailsByBlockHeightE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetZilliqaBlockDetailsByBlockHeightE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetZilliqaBlockDetailsByBlockHeightE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHeightE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetZilliqaBlockDetailsByBlockHeightE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetZilliqaBlockDetailsByBlockHeightE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetZilliqaBlockDetailsByBlockHeightE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetZilliqaBlockDetailsByBlockHeightE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetZilliqaBlockDetailsByBlockHeightE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetZilliqaBlockDetailsByBlockHeightE400
  * @throws IOException if the JSON string is invalid with respect to GetZilliqaBlockDetailsByBlockHeightE400
  */
  public static GetZilliqaBlockDetailsByBlockHeightE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetZilliqaBlockDetailsByBlockHeightE400.class);
  }

 /**
  * Convert an instance of GetZilliqaBlockDetailsByBlockHeightE400 to an JSON string
  *
  * @return JSON string
  */
