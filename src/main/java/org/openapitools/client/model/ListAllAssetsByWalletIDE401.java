...
public class ListAllAssetsByWalletIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllAssetsByWalletIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsByWalletIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsByWalletIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsByWalletIDE401>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsByWalletIDE401 value) throws IOException {
                ...
                @Override
                public ListAllAssetsByWalletIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsByWalletIDE401 ret = new ListAllAssetsByWalletIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsByWalletIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsByWalletIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllAssetsByWalletIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsByWalletIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsByWalletIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsByWalletIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsByWalletIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsByWalletIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsByWalletIDE401
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsByWalletIDE401
  */
  public static ListAllAssetsByWalletIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsByWalletIDE401.class);
  }

 /**
  * Convert an instance of ListAllAssetsByWalletIDE401 to an JSON string
  *
  * @return JSON string
  */
