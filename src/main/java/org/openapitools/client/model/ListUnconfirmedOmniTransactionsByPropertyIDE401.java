...
public class ListUnconfirmedOmniTransactionsByPropertyIDE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedOmniTransactionsByPropertyIDE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedOmniTransactionsByPropertyIDE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedOmniTransactionsByPropertyIDE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedOmniTransactionsByPropertyIDE401>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedOmniTransactionsByPropertyIDE401 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedOmniTransactionsByPropertyIDE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedOmniTransactionsByPropertyIDE401 ret = new ListUnconfirmedOmniTransactionsByPropertyIDE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedOmniTransactionsByPropertyIDE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedOmniTransactionsByPropertyIDE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedOmniTransactionsByPropertyIDE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedOmniTransactionsByPropertyIDE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedOmniTransactionsByPropertyIDE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedOmniTransactionsByPropertyIDE401
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE401
  */
  public static ListUnconfirmedOmniTransactionsByPropertyIDE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedOmniTransactionsByPropertyIDE401.class);
  }

 /**
  * Convert an instance of ListUnconfirmedOmniTransactionsByPropertyIDE401 to an JSON string
  *
  * @return JSON string
  */
