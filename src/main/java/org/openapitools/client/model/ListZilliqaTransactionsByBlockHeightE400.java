...
public class ListZilliqaTransactionsByBlockHeightE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListZilliqaTransactionsByBlockHeightE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListZilliqaTransactionsByBlockHeightE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListZilliqaTransactionsByBlockHeightE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListZilliqaTransactionsByBlockHeightE400>() {
                @Override
                public void write(JsonWriter out, ListZilliqaTransactionsByBlockHeightE400 value) throws IOException {
                ...
                @Override
                public ListZilliqaTransactionsByBlockHeightE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListZilliqaTransactionsByBlockHeightE400 ret = new ListZilliqaTransactionsByBlockHeightE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListZilliqaTransactionsByBlockHeightE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListZilliqaTransactionsByBlockHeightE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListZilliqaTransactionsByBlockHeightE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHeightE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListZilliqaTransactionsByBlockHeightE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListZilliqaTransactionsByBlockHeightE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListZilliqaTransactionsByBlockHeightE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListZilliqaTransactionsByBlockHeightE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListZilliqaTransactionsByBlockHeightE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListZilliqaTransactionsByBlockHeightE400
  * @throws IOException if the JSON string is invalid with respect to ListZilliqaTransactionsByBlockHeightE400
  */
  public static ListZilliqaTransactionsByBlockHeightE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListZilliqaTransactionsByBlockHeightE400.class);
  }

 /**
  * Convert an instance of ListZilliqaTransactionsByBlockHeightE400 to an JSON string
  *
  * @return JSON string
  */
