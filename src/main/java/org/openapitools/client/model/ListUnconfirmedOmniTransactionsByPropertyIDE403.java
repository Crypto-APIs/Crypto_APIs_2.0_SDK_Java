...
public class ListUnconfirmedOmniTransactionsByPropertyIDE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListUnconfirmedOmniTransactionsByPropertyIDE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListUnconfirmedOmniTransactionsByPropertyIDE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListUnconfirmedOmniTransactionsByPropertyIDE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListUnconfirmedOmniTransactionsByPropertyIDE403>() {
                @Override
                public void write(JsonWriter out, ListUnconfirmedOmniTransactionsByPropertyIDE403 value) throws IOException {
                ...
                @Override
                public ListUnconfirmedOmniTransactionsByPropertyIDE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListUnconfirmedOmniTransactionsByPropertyIDE403 ret = new ListUnconfirmedOmniTransactionsByPropertyIDE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListUnconfirmedOmniTransactionsByPropertyIDE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListUnconfirmedOmniTransactionsByPropertyIDE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListUnconfirmedOmniTransactionsByPropertyIDE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListUnconfirmedOmniTransactionsByPropertyIDE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListUnconfirmedOmniTransactionsByPropertyIDE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListUnconfirmedOmniTransactionsByPropertyIDE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListUnconfirmedOmniTransactionsByPropertyIDE403
  * @throws IOException if the JSON string is invalid with respect to ListUnconfirmedOmniTransactionsByPropertyIDE403
  */
  public static ListUnconfirmedOmniTransactionsByPropertyIDE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUnconfirmedOmniTransactionsByPropertyIDE403.class);
  }

 /**
  * Convert an instance of ListUnconfirmedOmniTransactionsByPropertyIDE403 to an JSON string
  *
  * @return JSON string
  */
