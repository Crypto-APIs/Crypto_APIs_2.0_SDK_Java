...
public class MinedTransactionE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MinedTransactionE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MinedTransactionE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MinedTransactionE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MinedTransactionE403>() {
                @Override
                public void write(JsonWriter out, MinedTransactionE403 value) throws IOException {
                ...
                @Override
                public MinedTransactionE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        MinedTransactionE403 ret = new MinedTransactionE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for MinedTransactionE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MinedTransactionE403() {
        super("oneOf", Boolean.FALSE);
    }

    public MinedTransactionE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE403(BlockchainEventsCallbacksLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MinedTransactionE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return MinedTransactionE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MinedTransactionE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for MinedTransactionE403 with oneOf schemas: BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of MinedTransactionE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MinedTransactionE403
  * @throws IOException if the JSON string is invalid with respect to MinedTransactionE403
  */
  public static MinedTransactionE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MinedTransactionE403.class);
  }

 /**
  * Convert an instance of MinedTransactionE403 to an JSON string
  *
  * @return JSON string
  */
