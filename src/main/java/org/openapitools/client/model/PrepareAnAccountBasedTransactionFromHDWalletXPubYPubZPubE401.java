...
public class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401>() {
                @Override
                public void write(JsonWriter out, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 value) throws IOException {
                ...
                @Override
                public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 ret = new PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401
  * @throws IOException if the JSON string is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401
  */
  public static PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401.class);
  }

 /**
  * Convert an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 to an JSON string
  *
  * @return JSON string
  */
