...
public class EncodeXAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(EncodeXAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EncodeXAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EncodeXAddressE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EncodeXAddressE403>() {
                @Override
                public void write(JsonWriter out, EncodeXAddressE403 value) throws IOException {
                ...
                @Override
                public EncodeXAddressE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EncodeXAddressE403 ret = new EncodeXAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for EncodeXAddressE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EncodeXAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public EncodeXAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public EncodeXAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return EncodeXAddressE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EncodeXAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for EncodeXAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of EncodeXAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncodeXAddressE403
  * @throws IOException if the JSON string is invalid with respect to EncodeXAddressE403
  */
  public static EncodeXAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncodeXAddressE403.class);
  }

 /**
  * Convert an instance of EncodeXAddressE403 to an JSON string
  *
  * @return JSON string
  */
