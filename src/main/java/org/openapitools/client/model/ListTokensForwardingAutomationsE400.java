...
public class ListTokensForwardingAutomationsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensForwardingAutomationsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensForwardingAutomationsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensForwardingAutomationsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensForwardingAutomationsE400>() {
                @Override
                public void write(JsonWriter out, ListTokensForwardingAutomationsE400 value) throws IOException {
                ...
                @Override
                public ListTokensForwardingAutomationsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensForwardingAutomationsE400 ret = new ListTokensForwardingAutomationsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensForwardingAutomationsE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensForwardingAutomationsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensForwardingAutomationsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensForwardingAutomationsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensForwardingAutomationsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensForwardingAutomationsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensForwardingAutomationsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensForwardingAutomationsE400
  * @throws IOException if the JSON string is invalid with respect to ListTokensForwardingAutomationsE400
  */
  public static ListTokensForwardingAutomationsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensForwardingAutomationsE400.class);
  }

 /**
  * Convert an instance of ListTokensForwardingAutomationsE400 to an JSON string
  *
  * @return JSON string
  */
