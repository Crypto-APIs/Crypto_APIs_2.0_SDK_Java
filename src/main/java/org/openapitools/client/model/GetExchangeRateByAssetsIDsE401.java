...
public class GetExchangeRateByAssetsIDsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetsIDsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetsIDsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetsIDsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetsIDsE401>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetsIDsE401 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetsIDsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetsIDsE401 ret = new GetExchangeRateByAssetsIDsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetsIDsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetsIDsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetsIDsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetsIDsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetsIDsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetsIDsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetsIDsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetsIDsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetsIDsE401
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetsIDsE401
  */
  public static GetExchangeRateByAssetsIDsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetsIDsE401.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetsIDsE401 to an JSON string
  *
  * @return JSON string
  */
