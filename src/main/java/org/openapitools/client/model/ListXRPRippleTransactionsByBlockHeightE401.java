...
public class ListXRPRippleTransactionsByBlockHeightE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListXRPRippleTransactionsByBlockHeightE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListXRPRippleTransactionsByBlockHeightE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListXRPRippleTransactionsByBlockHeightE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListXRPRippleTransactionsByBlockHeightE401>() {
                @Override
                public void write(JsonWriter out, ListXRPRippleTransactionsByBlockHeightE401 value) throws IOException {
                ...
                @Override
                public ListXRPRippleTransactionsByBlockHeightE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListXRPRippleTransactionsByBlockHeightE401 ret = new ListXRPRippleTransactionsByBlockHeightE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListXRPRippleTransactionsByBlockHeightE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListXRPRippleTransactionsByBlockHeightE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListXRPRippleTransactionsByBlockHeightE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListXRPRippleTransactionsByBlockHeightE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListXRPRippleTransactionsByBlockHeightE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListXRPRippleTransactionsByBlockHeightE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListXRPRippleTransactionsByBlockHeightE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListXRPRippleTransactionsByBlockHeightE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListXRPRippleTransactionsByBlockHeightE401
  * @throws IOException if the JSON string is invalid with respect to ListXRPRippleTransactionsByBlockHeightE401
  */
  public static ListXRPRippleTransactionsByBlockHeightE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListXRPRippleTransactionsByBlockHeightE401.class);
  }

 /**
  * Convert an instance of ListXRPRippleTransactionsByBlockHeightE401 to an JSON string
  *
  * @return JSON string
  */
