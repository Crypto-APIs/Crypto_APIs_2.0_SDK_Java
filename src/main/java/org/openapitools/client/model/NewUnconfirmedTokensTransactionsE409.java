...
public class NewUnconfirmedTokensTransactionsE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewUnconfirmedTokensTransactionsE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUnconfirmedTokensTransactionsE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUnconfirmedTokensTransactionsE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewUnconfirmedTokensTransactionsE409>() {
                @Override
                public void write(JsonWriter out, NewUnconfirmedTokensTransactionsE409 value) throws IOException {
                ...
                @Override
                public NewUnconfirmedTokensTransactionsE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewUnconfirmedTokensTransactionsE409 ret = new NewUnconfirmedTokensTransactionsE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewUnconfirmedTokensTransactionsE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewUnconfirmedTokensTransactionsE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewUnconfirmedTokensTransactionsE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewUnconfirmedTokensTransactionsE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewUnconfirmedTokensTransactionsE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewUnconfirmedTokensTransactionsE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewUnconfirmedTokensTransactionsE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewUnconfirmedTokensTransactionsE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewUnconfirmedTokensTransactionsE409
  * @throws IOException if the JSON string is invalid with respect to NewUnconfirmedTokensTransactionsE409
  */
  public static NewUnconfirmedTokensTransactionsE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewUnconfirmedTokensTransactionsE409.class);
  }

 /**
  * Convert an instance of NewUnconfirmedTokensTransactionsE409 to an JSON string
  *
  * @return JSON string
  */
