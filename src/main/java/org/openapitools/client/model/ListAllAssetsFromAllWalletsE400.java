...
public class ListAllAssetsFromAllWalletsE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllAssetsFromAllWalletsE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllAssetsFromAllWalletsE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllAssetsFromAllWalletsE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllAssetsFromAllWalletsE400>() {
                @Override
                public void write(JsonWriter out, ListAllAssetsFromAllWalletsE400 value) throws IOException {
                ...
                @Override
                public ListAllAssetsFromAllWalletsE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllAssetsFromAllWalletsE400 ret = new ListAllAssetsFromAllWalletsE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllAssetsFromAllWalletsE400: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllAssetsFromAllWalletsE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllAssetsFromAllWalletsE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllAssetsFromAllWalletsE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllAssetsFromAllWalletsE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllAssetsFromAllWalletsE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllAssetsFromAllWalletsE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllAssetsFromAllWalletsE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllAssetsFromAllWalletsE400
  * @throws IOException if the JSON string is invalid with respect to ListAllAssetsFromAllWalletsE400
  */
  public static ListAllAssetsFromAllWalletsE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAssetsFromAllWalletsE400.class);
  }

 /**
  * Convert an instance of ListAllAssetsFromAllWalletsE400 to an JSON string
  *
  * @return JSON string
  */
