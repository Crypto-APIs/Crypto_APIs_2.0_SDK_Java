...
public class ListDepositAddressesE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListDepositAddressesE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListDepositAddressesE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListDepositAddressesE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListDepositAddressesE403>() {
                @Override
                public void write(JsonWriter out, ListDepositAddressesE403 value) throws IOException {
                ...
                @Override
                public ListDepositAddressesE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListDepositAddressesE403 ret = new ListDepositAddressesE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListDepositAddressesE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListDepositAddressesE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListDepositAddressesE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListDepositAddressesE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListDepositAddressesE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListDepositAddressesE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListDepositAddressesE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListDepositAddressesE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListDepositAddressesE403
  * @throws IOException if the JSON string is invalid with respect to ListDepositAddressesE403
  */
  public static ListDepositAddressesE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDepositAddressesE403.class);
  }

 /**
  * Convert an instance of ListDepositAddressesE403 to an JSON string
  *
  * @return JSON string
  */
