...
public class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403>() {
                @Override
                public void write(JsonWriter out, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 value) throws IOException {
                ...
                @Override
                public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 ret = new DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403() {
        super("oneOf", Boolean.FALSE);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403
  * @throws IOException if the JSON string is invalid with respect to DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403
  */
  public static DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.class);
  }

 /**
  * Convert an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 to an JSON string
  *
  * @return JSON string
  */
