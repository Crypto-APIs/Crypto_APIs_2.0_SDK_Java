...
public class NewConfirmedInternalTransactionsForSpecificAmountE409 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NewConfirmedInternalTransactionsForSpecificAmountE409.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewConfirmedInternalTransactionsForSpecificAmountE409.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewConfirmedInternalTransactionsForSpecificAmountE409' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewConfirmedInternalTransactionsForSpecificAmountE409>() {
                @Override
                public void write(JsonWriter out, NewConfirmedInternalTransactionsForSpecificAmountE409 value) throws IOException {
                ...
                @Override
                public NewConfirmedInternalTransactionsForSpecificAmountE409 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewConfirmedInternalTransactionsForSpecificAmountE409 ret = new NewConfirmedInternalTransactionsForSpecificAmountE409();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewConfirmedInternalTransactionsForSpecificAmountE409: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewConfirmedInternalTransactionsForSpecificAmountE409() {
        super("oneOf", Boolean.FALSE);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE409(AlreadyExists o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NewConfirmedInternalTransactionsForSpecificAmountE409(InvalidData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return NewConfirmedInternalTransactionsForSpecificAmountE409.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE409
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for NewConfirmedInternalTransactionsForSpecificAmountE409 with oneOf schemas: AlreadyExists, InvalidData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE409 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewConfirmedInternalTransactionsForSpecificAmountE409
  * @throws IOException if the JSON string is invalid with respect to NewConfirmedInternalTransactionsForSpecificAmountE409
  */
  public static NewConfirmedInternalTransactionsForSpecificAmountE409 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewConfirmedInternalTransactionsForSpecificAmountE409.class);
  }

 /**
  * Convert an instance of NewConfirmedInternalTransactionsForSpecificAmountE409 to an JSON string
  *
  * @return JSON string
  */
