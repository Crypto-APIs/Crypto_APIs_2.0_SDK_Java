...
public class GetRawTransactionDataE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetRawTransactionDataE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRawTransactionDataE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRawTransactionDataE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetRawTransactionDataE401>() {
                @Override
                public void write(JsonWriter out, GetRawTransactionDataE401 value) throws IOException {
                ...
                @Override
                public GetRawTransactionDataE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetRawTransactionDataE401 ret = new GetRawTransactionDataE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetRawTransactionDataE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetRawTransactionDataE401() {
        super("oneOf", Boolean.FALSE);
    }

    public GetRawTransactionDataE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetRawTransactionDataE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetRawTransactionDataE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetRawTransactionDataE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetRawTransactionDataE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetRawTransactionDataE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetRawTransactionDataE401
  * @throws IOException if the JSON string is invalid with respect to GetRawTransactionDataE401
  */
  public static GetRawTransactionDataE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRawTransactionDataE401.class);
  }

 /**
  * Convert an instance of GetRawTransactionDataE401 to an JSON string
  *
  * @return JSON string
  */
