...
public class ListHDWalletXPubYPubZPubUTXOsE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListHDWalletXPubYPubZPubUTXOsE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListHDWalletXPubYPubZPubUTXOsE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListHDWalletXPubYPubZPubUTXOsE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListHDWalletXPubYPubZPubUTXOsE401>() {
                @Override
                public void write(JsonWriter out, ListHDWalletXPubYPubZPubUTXOsE401 value) throws IOException {
                ...
                @Override
                public ListHDWalletXPubYPubZPubUTXOsE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListHDWalletXPubYPubZPubUTXOsE401 ret = new ListHDWalletXPubYPubZPubUTXOsE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListHDWalletXPubYPubZPubUTXOsE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListHDWalletXPubYPubZPubUTXOsE401() {
        super("oneOf", Boolean.FALSE);
    }

    public ListHDWalletXPubYPubZPubUTXOsE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListHDWalletXPubYPubZPubUTXOsE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListHDWalletXPubYPubZPubUTXOsE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListHDWalletXPubYPubZPubUTXOsE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListHDWalletXPubYPubZPubUTXOsE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListHDWalletXPubYPubZPubUTXOsE401
  * @throws IOException if the JSON string is invalid with respect to ListHDWalletXPubYPubZPubUTXOsE401
  */
  public static ListHDWalletXPubYPubZPubUTXOsE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHDWalletXPubYPubZPubUTXOsE401.class);
  }

 /**
  * Convert an instance of ListHDWalletXPubYPubZPubUTXOsE401 to an JSON string
  *
  * @return JSON string
  */
