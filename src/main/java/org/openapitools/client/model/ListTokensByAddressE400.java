...
public class ListTokensByAddressE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListTokensByAddressE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListTokensByAddressE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListTokensByAddressE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListTokensByAddressE400>() {
                @Override
                public void write(JsonWriter out, ListTokensByAddressE400 value) throws IOException {
                ...
                @Override
                public ListTokensByAddressE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListTokensByAddressE400 ret = new ListTokensByAddressE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListTokensByAddressE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListTokensByAddressE400() {
        super("oneOf", Boolean.FALSE);
    }

    public ListTokensByAddressE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensByAddressE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListTokensByAddressE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListTokensByAddressE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListTokensByAddressE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListTokensByAddressE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListTokensByAddressE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListTokensByAddressE400
  * @throws IOException if the JSON string is invalid with respect to ListTokensByAddressE400
  */
  public static ListTokensByAddressE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTokensByAddressE400.class);
  }

 /**
  * Convert an instance of ListTokensByAddressE400 to an JSON string
  *
  * @return JSON string
  */
