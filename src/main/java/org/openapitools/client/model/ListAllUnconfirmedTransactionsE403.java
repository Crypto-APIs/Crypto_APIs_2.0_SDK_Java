...
public class ListAllUnconfirmedTransactionsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListAllUnconfirmedTransactionsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListAllUnconfirmedTransactionsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListAllUnconfirmedTransactionsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListAllUnconfirmedTransactionsE403>() {
                @Override
                public void write(JsonWriter out, ListAllUnconfirmedTransactionsE403 value) throws IOException {
                ...
                @Override
                public ListAllUnconfirmedTransactionsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListAllUnconfirmedTransactionsE403 ret = new ListAllUnconfirmedTransactionsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListAllUnconfirmedTransactionsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListAllUnconfirmedTransactionsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListAllUnconfirmedTransactionsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListAllUnconfirmedTransactionsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListAllUnconfirmedTransactionsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAllUnconfirmedTransactionsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListAllUnconfirmedTransactionsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListAllUnconfirmedTransactionsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAllUnconfirmedTransactionsE403
  * @throws IOException if the JSON string is invalid with respect to ListAllUnconfirmedTransactionsE403
  */
  public static ListAllUnconfirmedTransactionsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllUnconfirmedTransactionsE403.class);
  }

 /**
  * Convert an instance of ListAllUnconfirmedTransactionsE403 to an JSON string
  *
  * @return JSON string
  */
