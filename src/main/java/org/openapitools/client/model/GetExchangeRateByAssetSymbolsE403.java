...
public class GetExchangeRateByAssetSymbolsE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetExchangeRateByAssetSymbolsE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetExchangeRateByAssetSymbolsE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetExchangeRateByAssetSymbolsE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetExchangeRateByAssetSymbolsE403>() {
                @Override
                public void write(JsonWriter out, GetExchangeRateByAssetSymbolsE403 value) throws IOException {
                ...
                @Override
                public GetExchangeRateByAssetSymbolsE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetExchangeRateByAssetSymbolsE403 ret = new GetExchangeRateByAssetSymbolsE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetExchangeRateByAssetSymbolsE403: %d classes match result, expected 1. JSON: %s", match, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetExchangeRateByAssetSymbolsE403() {
        super("oneOf", Boolean.FALSE);
    }

    public GetExchangeRateByAssetSymbolsE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetSymbolsE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetSymbolsE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetExchangeRateByAssetSymbolsE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetExchangeRateByAssetSymbolsE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetExchangeRateByAssetSymbolsE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetExchangeRateByAssetSymbolsE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. JSON: %s", validCount, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetExchangeRateByAssetSymbolsE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetExchangeRateByAssetSymbolsE403
  * @throws IOException if the JSON string is invalid with respect to GetExchangeRateByAssetSymbolsE403
  */
  public static GetExchangeRateByAssetSymbolsE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExchangeRateByAssetSymbolsE403.class);
  }

 /**
  * Convert an instance of GetExchangeRateByAssetSymbolsE403 to an JSON string
  *
  * @return JSON string
  */
