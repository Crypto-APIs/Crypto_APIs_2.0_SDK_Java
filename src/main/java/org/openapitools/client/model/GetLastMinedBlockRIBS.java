...
import org.openapitools.client.model.GetLastMinedBlockRIBSZ2;
...
public class GetLastMinedBlockRIBS extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<GetLastMinedBlockRIBSZ2> adapterGetLastMinedBlockRIBSZ2 = gson.getDelegateAdapter(this, TypeToken.get(GetLastMinedBlockRIBSZ2.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetLastMinedBlockRIBS>() {
                ...
                public void write(JsonWriter out, GetLastMinedBlockRIBS value) throws IOException {
                    ...
                    // check if the actual instance is of the type `GetLastMinedBlockRIBSZ2`
                    if (value.getActualInstance() instanceof GetLastMinedBlockRIBSZ2) {
                        JsonObject obj = adapterGetLastMinedBlockRIBSZ2.toJsonTree((GetLastMinedBlockRIBSZ2)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }
                ...
                public GetLastMinedBlockRIBS read(JsonReader in) throws IOException {
                    ...
                    // deserialize GetLastMinedBlockRIBSZ2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GetLastMinedBlockRIBSZ2.validateJsonObject(jsonObject);
                        actualAdapter = adapterGetLastMinedBlockRIBSZ2;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GetLastMinedBlockRIBSZ2'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GetLastMinedBlockRIBSZ2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GetLastMinedBlockRIBSZ2'", e);
                    }
    ...
    public GetLastMinedBlockRIBS(GetLastMinedBlockRIBSZ2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("GetLastMinedBlockRIBSZ2", new GenericType<GetLastMinedBlockRIBSZ2>() {
        });
    }
     ...
     * GetLastMinedBlockRIBSB, GetLastMinedBlockRIBSBC, GetLastMinedBlockRIBSBSC, GetLastMinedBlockRIBSD, GetLastMinedBlockRIBSD2, GetLastMinedBlockRIBSE, GetLastMinedBlockRIBSEC, GetLastMinedBlockRIBSL, GetLastMinedBlockRIBSZ, GetLastMinedBlockRIBSZ2
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof GetLastMinedBlockRIBSZ2) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * GetLastMinedBlockRIBSB, GetLastMinedBlockRIBSBC, GetLastMinedBlockRIBSBSC, GetLastMinedBlockRIBSD, GetLastMinedBlockRIBSD2, GetLastMinedBlockRIBSE, GetLastMinedBlockRIBSEC, GetLastMinedBlockRIBSL, GetLastMinedBlockRIBSZ, GetLastMinedBlockRIBSZ2
     *
     * @return The actual instance (GetLastMinedBlockRIBSB, GetLastMinedBlockRIBSBC, GetLastMinedBlockRIBSBSC, GetLastMinedBlockRIBSD, GetLastMinedBlockRIBSD2, GetLastMinedBlockRIBSE, GetLastMinedBlockRIBSEC, GetLastMinedBlockRIBSL, GetLastMinedBlockRIBSZ, GetLastMinedBlockRIBSZ2)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GetLastMinedBlockRIBSZ2`
     * @throws ClassCastException if the instance is not `GetLastMinedBlockRIBSZ2`
     */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    // validate the json string with GetLastMinedBlockRIBSZ2
    try {
      GetLastMinedBlockRIBSZ2.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for GetLastMinedBlockRIBSZ2 failed with `%s`.", e.getMessage()));
      // continue to the next one
