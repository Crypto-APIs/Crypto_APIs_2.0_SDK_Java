...
public class DeleteAutomaticCoinsForwardingE401 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticCoinsForwardingE401.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticCoinsForwardingE401.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticCoinsForwardingE401' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticCoinsForwardingE401>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticCoinsForwardingE401 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticCoinsForwardingE401 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticCoinsForwardingE401 ret = new DeleteAutomaticCoinsForwardingE401();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticCoinsForwardingE401: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticCoinsForwardingE401() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticCoinsForwardingE401(InvalidApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticCoinsForwardingE401(MissingApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticCoinsForwardingE401.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticCoinsForwardingE401
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticCoinsForwardingE401 with oneOf schemas: InvalidApiKey, MissingApiKey. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticCoinsForwardingE401 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticCoinsForwardingE401
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticCoinsForwardingE401
  */
  public static DeleteAutomaticCoinsForwardingE401 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticCoinsForwardingE401.class);
  }

 /**
  * Convert an instance of DeleteAutomaticCoinsForwardingE401 to an JSON string
  *
  * @return JSON string
  */
