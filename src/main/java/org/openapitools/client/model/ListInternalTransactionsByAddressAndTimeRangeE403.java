...
public class ListInternalTransactionsByAddressAndTimeRangeE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListInternalTransactionsByAddressAndTimeRangeE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListInternalTransactionsByAddressAndTimeRangeE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListInternalTransactionsByAddressAndTimeRangeE403' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ListInternalTransactionsByAddressAndTimeRangeE403>() {
                @Override
                public void write(JsonWriter out, ListInternalTransactionsByAddressAndTimeRangeE403 value) throws IOException {
                ...
                @Override
                public ListInternalTransactionsByAddressAndTimeRangeE403 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ListInternalTransactionsByAddressAndTimeRangeE403 ret = new ListInternalTransactionsByAddressAndTimeRangeE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ListInternalTransactionsByAddressAndTimeRangeE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ListInternalTransactionsByAddressAndTimeRangeE403() {
        super("oneOf", Boolean.FALSE);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ListInternalTransactionsByAddressAndTimeRangeE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ListInternalTransactionsByAddressAndTimeRangeE403.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ListInternalTransactionsByAddressAndTimeRangeE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ListInternalTransactionsByAddressAndTimeRangeE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListInternalTransactionsByAddressAndTimeRangeE403
  * @throws IOException if the JSON string is invalid with respect to ListInternalTransactionsByAddressAndTimeRangeE403
  */
  public static ListInternalTransactionsByAddressAndTimeRangeE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInternalTransactionsByAddressAndTimeRangeE403.class);
  }

 /**
  * Convert an instance of ListInternalTransactionsByAddressAndTimeRangeE403 to an JSON string
  *
  * @return JSON string
  */
