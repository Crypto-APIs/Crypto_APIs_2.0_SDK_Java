...
public class DeleteAutomaticTokensForwardingE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteAutomaticTokensForwardingE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteAutomaticTokensForwardingE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteAutomaticTokensForwardingE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticTokensForwardingE400>() {
                @Override
                public void write(JsonWriter out, DeleteAutomaticTokensForwardingE400 value) throws IOException {
                ...
                @Override
                public DeleteAutomaticTokensForwardingE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeleteAutomaticTokensForwardingE400 ret = new DeleteAutomaticTokensForwardingE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DeleteAutomaticTokensForwardingE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteAutomaticTokensForwardingE400() {
        super("oneOf", Boolean.FALSE);
    }

    public DeleteAutomaticTokensForwardingE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DeleteAutomaticTokensForwardingE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return DeleteAutomaticTokensForwardingE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteAutomaticTokensForwardingE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DeleteAutomaticTokensForwardingE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of DeleteAutomaticTokensForwardingE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteAutomaticTokensForwardingE400
  * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticTokensForwardingE400
  */
  public static DeleteAutomaticTokensForwardingE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticTokensForwardingE400.class);
  }

 /**
  * Convert an instance of DeleteAutomaticTokensForwardingE400 to an JSON string
  *
  * @return JSON string
  */
