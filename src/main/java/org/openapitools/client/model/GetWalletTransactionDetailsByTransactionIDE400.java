...
public class GetWalletTransactionDetailsByTransactionIDE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetWalletTransactionDetailsByTransactionIDE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetWalletTransactionDetailsByTransactionIDE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetWalletTransactionDetailsByTransactionIDE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetWalletTransactionDetailsByTransactionIDE400>() {
                @Override
                public void write(JsonWriter out, GetWalletTransactionDetailsByTransactionIDE400 value) throws IOException {
                ...
                @Override
                public GetWalletTransactionDetailsByTransactionIDE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetWalletTransactionDetailsByTransactionIDE400 ret = new GetWalletTransactionDetailsByTransactionIDE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetWalletTransactionDetailsByTransactionIDE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetWalletTransactionDetailsByTransactionIDE400() {
        super("oneOf", Boolean.FALSE);
    }

    public GetWalletTransactionDetailsByTransactionIDE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletTransactionDetailsByTransactionIDE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetWalletTransactionDetailsByTransactionIDE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetWalletTransactionDetailsByTransactionIDE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetWalletTransactionDetailsByTransactionIDE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetWalletTransactionDetailsByTransactionIDE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetWalletTransactionDetailsByTransactionIDE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetWalletTransactionDetailsByTransactionIDE400
  * @throws IOException if the JSON string is invalid with respect to GetWalletTransactionDetailsByTransactionIDE400
  */
  public static GetWalletTransactionDetailsByTransactionIDE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWalletTransactionDetailsByTransactionIDE400.class);
  }

 /**
  * Convert an instance of GetWalletTransactionDetailsByTransactionIDE400 to an JSON string
  *
  * @return JSON string
  */
