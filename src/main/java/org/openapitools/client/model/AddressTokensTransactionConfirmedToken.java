...
public class AddressTokensTransactionConfirmedToken extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddressTokensTransactionConfirmedToken>() {
                ...
                public AddressTokensTransactionConfirmedToken read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format("Deserialization for AddressTokensTransactionConfirmedBep20 failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AddressTokensTransactionConfirmedErc20 failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AddressTokensTransactionConfirmedErc721 failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AddressTokensTransactionConfirmedOmni failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format("Failed deserialization for AddressTokensTransactionConfirmedToken: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AddressTokensTransactionConfirmedToken with oneOf schemas: AddressTokensTransactionConfirmedBep20, AddressTokensTransactionConfirmedErc20, AddressTokensTransactionConfirmedErc721, AddressTokensTransactionConfirmedOmni. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
