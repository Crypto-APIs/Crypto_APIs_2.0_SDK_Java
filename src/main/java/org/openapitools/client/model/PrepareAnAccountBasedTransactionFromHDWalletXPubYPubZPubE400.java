...
public class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400>() {
                @Override
                public void write(JsonWriter out, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 value) throws IOException {
                ...
                @Override
                public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 ret = new PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400() {
        super("oneOf", Boolean.FALSE);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400(InvalidPagination o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400(LimitGreaterThanAllowed o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400(UriNotFound o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 with oneOf schemas: InvalidPagination, LimitGreaterThanAllowed, UriNotFound. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400
  * @throws IOException if the JSON string is invalid with respect to PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400
  */
  public static PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400.class);
  }

 /**
  * Convert an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE400 to an JSON string
  *
  * @return JSON string
  */
