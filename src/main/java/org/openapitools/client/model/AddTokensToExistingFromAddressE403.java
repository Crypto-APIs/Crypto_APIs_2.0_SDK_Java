...
public class AddTokensToExistingFromAddressE403 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AddTokensToExistingFromAddressE403.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AddTokensToExistingFromAddressE403.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AddTokensToExistingFromAddressE403' and its subtypes
            }
            ...
            final TypeAdapter<TokensForwardingAutomationsLimitReached> adapterTokensForwardingAutomationsLimitReached = gson.getDelegateAdapter(this, TypeToken.get(TokensForwardingAutomationsLimitReached.class));

            return (TypeAdapter<T>) new TypeAdapter<AddTokensToExistingFromAddressE403>() {
                @Override
                public void write(JsonWriter out, AddTokensToExistingFromAddressE403 value) throws IOException {
                    ...
                    // check if the actual instance is of the type `TokensForwardingAutomationsLimitReached`
                    if (value.getActualInstance() instanceof TokensForwardingAutomationsLimitReached) {
                        JsonObject obj = adapterTokensForwardingAutomationsLimitReached.toJsonTree((TokensForwardingAutomationsLimitReached)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }

                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached");
                }

                @Override
                public AddTokensToExistingFromAddressE403 read(JsonReader in) throws IOException {
                    ...
                    // deserialize TokensForwardingAutomationsLimitReached
                    try {
                        // validate the JSON object to see if any exception is thrown
                        TokensForwardingAutomationsLimitReached.validateJsonObject(jsonObject);
                        actualAdapter = adapterTokensForwardingAutomationsLimitReached;
                        match++;
                    ...
                    if (match == 1) {
                        AddTokensToExistingFromAddressE403 ret = new AddTokensToExistingFromAddressE403();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AddTokensToExistingFromAddressE403: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddTokensToExistingFromAddressE403() {
        super("oneOf", Boolean.FALSE);
    }

    public AddTokensToExistingFromAddressE403(BannedIpAddress o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE403(EndpointNotAllowedForApiKey o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE403(EndpointNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE403(FeatureMainnetsNotAllowedForPlan o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AddTokensToExistingFromAddressE403(TokensForwardingAutomationsLimitReached o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("TokensForwardingAutomationsLimitReached", new GenericType<TokensForwardingAutomationsLimitReached>() {
        });
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return AddTokensToExistingFromAddressE403.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof TokensForwardingAutomationsLimitReached) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached");
    }
     ...
     * BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached
     *
     * @return The actual instance (BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TokensForwardingAutomationsLimitReached`
     * @throws ClassCastException if the instance is not `TokensForwardingAutomationsLimitReached`
     */
    public TokensForwardingAutomationsLimitReached getTokensForwardingAutomationsLimitReached() throws ClassCastException {
        return (TokensForwardingAutomationsLimitReached)super.getActualInstance();
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddTokensToExistingFromAddressE403
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AddTokensToExistingFromAddressE403 with oneOf schemas: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of AddTokensToExistingFromAddressE403 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddTokensToExistingFromAddressE403
  * @throws IOException if the JSON string is invalid with respect to AddTokensToExistingFromAddressE403
  */
  public static AddTokensToExistingFromAddressE403 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTokensToExistingFromAddressE403.class);
  }

 /**
  * Convert an instance of AddTokensToExistingFromAddressE403 to an JSON string
  *
  * @return JSON string
  */
