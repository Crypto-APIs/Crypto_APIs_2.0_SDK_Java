...
public class OmniLayerApiTest {
    ...
    public void getOmniTransactionDetailsByTransactionIDTxidTest() throws ApiException {
        ...
        String context = null;
        GetOmniTransactionDetailsByTransactionIDTxidResponse response = api.getOmniTransactionDetailsByTransactionIDTxid(network, blockchain, transactionId, context);
    ...
    public void getUnconfirmedOmniTransactionByTransactionIDTxidTest() throws ApiException {
        ...
        String transactionId = null;
        String context = null;
        GetUnconfirmedOmniTransactionByTransactionIDTxidResponse response = api.getUnconfirmedOmniTransactionByTransactionIDTxid(network, blockchain, transactionId, context);
    ...
    public void listOmniTokensByAddressTest() throws ApiException {
        ...
        String address = null;
        String context = null;
        ListOmniTokensByAddressResponse response = api.listOmniTokensByAddress(network, blockchain, address, context);
    ...
    public void listOmniTransactionsByAddressTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListOmniTransactionsByAddressResponse response = api.listOmniTransactionsByAddress(network, blockchain, address, context, limit, offset);
    ...
    public void listOmniTransactionsByBlockHashTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListOmniTransactionsByBlockHashResponse response = api.listOmniTransactionsByBlockHash(network, blockchain, blockHash, context, limit, offset);
    ...
    public void listOmniTransactionsByBlockHeightTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListOmniTransactionsByBlockHeightResponse response = api.listOmniTransactionsByBlockHeight(network, blockchain, blockHeight, context, limit, offset);
    ...
    public void listUnconfirmedOmniTransactionsByAddressTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListUnconfirmedOmniTransactionsByAddressResponse response = api.listUnconfirmedOmniTransactionsByAddress(network, blockchain, address, context, limit, offset);
    ...
    public void listUnconfirmedOmniTransactionsByPropertyIDTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListUnconfirmedOmniTransactionsByPropertyIDResponse response = api.listUnconfirmedOmniTransactionsByPropertyID(network, blockchain, propertyId, context, limit, offset);
