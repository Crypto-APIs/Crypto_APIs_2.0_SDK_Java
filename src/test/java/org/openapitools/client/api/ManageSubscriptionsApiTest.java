...
public class ManageSubscriptionsApiTest {
    ...
    public void deleteBlockchainEventSubscriptionTest() throws ApiException {
        ...
        String context = null;
        DeleteBlockchainEventSubscriptionResponse response = api.deleteBlockchainEventSubscription(blockchain, network, referenceId, context);
    ...
    public void listBlockchainEventsSubscriptionsTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        ListBlockchainEventsSubscriptionsResponse response = api.listBlockchainEventsSubscriptions(blockchain, network, context, limit, offset);
